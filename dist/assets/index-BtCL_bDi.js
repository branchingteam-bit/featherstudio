(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const m of n.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&s(m)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const z=(t,e=document)=>e.querySelector(t),K=(t,e=document)=>[...e.querySelectorAll(t)],H="atlanticbear_analytics_8d24";function T(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${H}/${t}`).catch(()=>{});try{const s=ie();fetch(`https://abacus.jasoncameron.dev/hit/${H}/${s}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}const J=window.RECAPTCHA_SITE_KEY||"6Ldfp-gqAAAAABpP_placeholder_key";function Q(){const t=window.RECAPTCHA_SITE_KEY||J;if(document.getElementById("recaptcha-v3-script"))return;const e=document.createElement("script");e.id="recaptcha-v3-script",e.src=`https://www.google.com/recaptcha/api.js?render=${encodeURIComponent(t)}`,e.async=!0,e.defer=!0,document.head.appendChild(e)}async function X(t){const e=window.RECAPTCHA_SITE_KEY||J;return Q(),new Promise(a=>{const s=setTimeout(()=>{console.warn(`reCAPTCHA [${t}] timed out. Continuing submission.`),a(null)},2500),o=window.grecaptcha;if(o&&typeof o.ready=="function")try{o.ready(()=>{o.execute(e,{action:t}).then(n=>{clearTimeout(s),a(n)}).catch(n=>{clearTimeout(s),console.warn(`reCAPTCHA [${t}] execution error:`,n),a(null)})})}catch(n){clearTimeout(s),console.warn(`reCAPTCHA [${t}] error:`,n),a(null)}else clearTimeout(s),a(null)})}let q={};function se(){Z();const t=e=>{q[`t${e}`]=window.setTimeout(()=>{T(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function Z(){Object.values(q).forEach(clearTimeout),q={}}let _={moved:!1,calendar:!1,testimonials:!1},Y=null;function oe(){ee(),_={moved:!1,video:!1,calendar:!1,testimonials:!1},Y=()=>{window.scrollY>50&&!_.moved&&(_.moved=!0,T("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!_.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(_.calendar=!0,T("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!_.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(_.testimonials=!0,T("scroll_testimonials"))},window.addEventListener("scroll",Y,{passive:!0})}function ee(){Y&&(window.removeEventListener("scroll",Y),Y=null)}function ie(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}const g={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function ne(){return`
  ...
  `,t.appendChild(a);const s=new MutationObserver(()=>{const o=t.querySelector("iframe");o&&(o.style.position="relative",o.style.zIndex="2",o.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),s.disconnect())});s.observe(t,{childList:!0})}function ke(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),s=e.querySelector("video");a&&s&&a.addEventListener("click",o=>{o.stopPropagation(),s.muted=!1,s.currentTime=0,s.controls=!0,a.style.display="none",s.play().catch(n=>{console.error("Play failed:",n)})})})}function Ee(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",V(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const s=document.createElement("script");s.id="calendly-sdk",s.src="https://assets.calendly.com/assets/external/widget.js",s.async=!0,s.addEventListener("load",e,{once:!0}),document.head.appendChild(s)}}function Ae(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),s=document.getElementById("bv-play-btn"),o=document.getElementById("bv-controls"),n=document.getElementById("bv-playpause"),m=document.getElementById("bv-progress-fill"),p=document.getElementById("bv-progress-thumb"),y=document.getElementById("bv-progress-wrap"),v=document.getElementById("bv-time"),U=document.getElementById("bv-mute"),f=document.getElementById("bv-volume"),c=document.getElementById("bv-fullscreen"),h=document.getElementById("custom-video-wrap");if(!e||!a||!s||!o||!n)return;let x=null,k=null;const w=()=>{try{const i=window.AudioContext||window.webkitAudioContext;if(!i)return;if(!x){x=new i;const r=x.createMediaElementSource(e);k=x.createGain(),k.gain.value=2,r.connect(k),k.connect(x.destination)}x.state==="suspended"&&x.resume()}catch(i){console.warn("AudioContext boost failed:",i)}},I=e.getAttribute("data-src"),P=()=>{I&&!e.getAttribute("src")&&(e.setAttribute("src",I),e.load())};let A=!0;const D=5,R=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{A&&e.currentTime>=D&&(e.currentTime=0)}),setTimeout(R,800);const M=i=>{const r=Math.floor(i/60),u=Math.floor(i%60);return`${r}:${u.toString().padStart(2,"0")}`},S=90,C=60,O=(i,r)=>!t||r<=S?i/r*100:i<=S?i/S*C:C+(i-S)/(r-S)*(100-C),$=(i,r)=>!t||r<=S?i/100*r:i<=C?i/C*S:S+(i-C)/(100-C)*(r-S),b=()=>{if(!e.duration)return;const i=O(e.currentTime,e.duration);m&&(m.style.width=i+"%"),p&&(p.style.left=i+"%"),v&&(v.textContent=`${M(e.currentTime)} / ${M(e.duration)}`)},B=i=>{const r=n==null?void 0:n.querySelector(".icon-play"),u=n==null?void 0:n.querySelector(".icon-pause");r&&(r.style.display=i&&!A?"none":"block"),u&&(u.style.display=i&&!A?"block":"none"),a&&(a.style.display=i&&!A?"none":"flex"),h&&(i&&!A?h.classList.add("playing"):h.classList.remove("playing"))};a.addEventListener("click",()=>{if(A){A=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0}P(),w(),B(!0),e.play()}),e.addEventListener("click",()=>{if(A){A=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0,w(),B(!0),e.play();return}P(),w(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>B(!0)),e.addEventListener("pause",()=>B(!1)),e.addEventListener("ended",()=>B(!1)),e.addEventListener("timeupdate",b),e.addEventListener("loadedmetadata",b);let l=!1;const d={m25:!1,m50:!1,m75:!1,m100:!1},E={};if(e.addEventListener("timeupdate",()=>{const i=e.duration;if(!i)return;const r=e.currentTime,u=r/i*100;!l&&r>.5&&(l=!0,T("videoplay")),u>=25&&!d.m25&&(d.m25=!0,T("videowatch_25pct")),u>=50&&!d.m50&&(d.m50=!0,T("videowatch_50pct")),u>=75&&!d.m75&&(d.m75=!0,T("videowatch_75pct")),u>=98&&!d.m100&&(d.m100=!0,T("videowatch_complete"));const L=[10,30],W=Math.floor(r);L.forEach(F=>{W>=F&&!E[F]&&(E[F]=!0,T(`videowatch_${F}s`))})}),n.addEventListener("click",()=>{P(),w(),e.paused?e.play():e.pause()}),y){const i=u=>{const L=y.getBoundingClientRect(),W=u instanceof MouseEvent?u.clientX:u.touches[0].clientX,F=Math.max(0,Math.min(100,(W-L.left)/L.width*100));e.currentTime=$(F,e.duration),b()};let r=!1;y.addEventListener("mousedown",u=>{r=!0,i(u)}),window.addEventListener("mousemove",u=>{r&&i(u)}),window.addEventListener("mouseup",()=>{r=!1}),y.addEventListener("touchstart",u=>i(u),{passive:!0}),y.addEventListener("touchmove",u=>i(u),{passive:!0})}if(f&&f.addEventListener("input",()=>{e.volume=parseFloat(f.value),e.muted=e.volume===0}),U&&U.addEventListener("click",()=>{e.muted=!e.muted,f&&(f.value=e.muted?"0":String(e.volume||1))}),c&&h&&c.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():h.requestFullscreen?h.requestFullscreen():h.webkitRequestFullscreen?h.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),h){let i;const r=()=>{o.style.opacity="1",clearTimeout(i),i=window.setTimeout(()=>{e.paused||(o.style.opacity="0")},2500)};h.addEventListener("mousemove",r),h.addEventListener("mouseenter",r),h.addEventListener("mouseleave",()=>{e.paused||(o.style.opacity="0")}),e.addEventListener("play",()=>{i=window.setTimeout(()=>{o.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{o.style.opacity="1",clearTimeout(i)})}}function xe(){const t=document.getElementById("booking-modal"),e=document.getElementById("book-demo-btn-v2"),a=document.getElementById("booking-modal-close-btn"),s=document.getElementById("modal-step-1"),o=document.getElementById("modal-step-2"),n=document.getElementById("modal-step-3"),m=document.getElementById("modal-step-num"),p=document.getElementById("modal-step-title"),y=document.getElementById("modal-step-badge"),v=document.getElementById("modal-progress-bar"),U=document.getElementById("modal-step1-form"),f=document.getElementById("modal-input-name"),c=document.getElementById("modal-input-phone"),h=document.getElementById("modal-step1-error"),x=document.getElementById("modal-confirm-pricing-link");if(!t||!a)return;t.parentElement!==document.body&&document.body.appendChild(t);let k="",w="",I="";f&&localStorage.getItem("feather_booking_name")&&(f.value=localStorage.getItem("feather_booking_name")||""),c&&localStorage.getItem("feather_booking_phone")&&(c.value=localStorage.getItem("feather_booking_phone")||"");const P=document.getElementById("phone-flag-prefix"),A={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},D=()=>{if(!P||!c)return;const l=c.value.trim();let d="🇦🇪";for(const[E,i]of Object.entries(A))if(l.startsWith(E)){d=i;break}P.textContent=d},R=()=>{if(!c)return;let l=c.value,d="";for(const L of Object.keys(A))if(l.startsWith(L)){d=L+" ";break}if(!d&&l.startsWith("+")){const L=l.indexOf(" ");if(L>0)d=l.substring(0,L+1);else{const W=l.match(/^\+\d+/);W&&(d=W[0]+" ")}}const i=l.substring(d.length).replace(/\D/g,"").substring(0,9);let r="";i.length>0&&(i.length<=2?r=i:i.length<=5?r=`${i.substring(0,2)} ${i.substring(2)}`:r=`${i.substring(0,2)} ${i.substring(2,5)} ${i.substring(5)}`);const u=d+r;c.value!==u&&(c.value=u)};c&&((!c.value||c.value.trim()===""||c.value.trim()==="+971")&&(c.value="+971 "),c.addEventListener("input",l=>{const d=l;if(d.inputType&&d.inputType.startsWith("delete")){D();return}R(),D()}),D());const M=()=>{if(!k||!w)return;const l=`${k}|${w}`;if(I===l)return;I=l;const d=document.getElementById("modal-calendly-container");if(!d)return;d.innerHTML="",V(d);const r={url:`https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff&name=${encodeURIComponent(k)}&a1=${encodeURIComponent(w)}`,parentElement:d,prefill:{name:k,customAnswers:{a1:w}}},u=()=>window.Calendly.initInlineWidget(r);if(window.Calendly)u();else{const L=document.getElementById("calendly-sdk");L&&L.addEventListener("load",u,{once:!0})}},S=()=>{const l=(f==null?void 0:f.value.trim())||"",d=(c==null?void 0:c.value.trim())||"";l.length>=3&&d.length>=5&&(k=l,w=d,M())};f==null||f.addEventListener("input",S),c==null||c.addEventListener("input",S),S();const C=l=>{l===1?(s&&(s.style.display="block"),o&&(o.style.display="none"),n&&(n.style.display="none"),m&&(m.textContent="1"),p&&(p.textContent="Tell us about yourself"),y&&(y.style.display="inline"),v&&(v.style.width="50%")):l===2?(s&&(s.style.display="none"),o&&(o.style.display="block"),n&&(n.style.display="none"),m&&(m.textContent="2"),p&&(p.textContent="Schedule your demo call"),y&&(y.style.display="inline"),v&&(v.style.width="100%"),k=(f==null?void 0:f.value.trim())||"",w=(c==null?void 0:c.value.trim())||"",M()):l===3&&(s&&(s.style.display="none"),o&&(o.style.display="none"),n&&(n.style.display="block"),p&&(p.textContent="Call Confirmed!"),y&&(y.style.display="none"),v&&(v.style.width="100%"))},O=()=>{t.classList.add("active"),document.body.style.overflow="hidden",h&&(h.style.display="none"),I="",f&&localStorage.getItem("feather_booking_name")&&(f.value=localStorage.getItem("feather_booking_name")||""),c&&localStorage.getItem("feather_booking_phone")&&(c.value=localStorage.getItem("feather_booking_phone")||""),C(1)},$=()=>{t.classList.remove("active"),document.body.style.overflow=""},b=l=>{l&&l.preventDefault();const d=(f==null?void 0:f.value.trim())||"",E=(c==null?void 0:c.value.trim())||"";if(!d||!E){h&&(h.style.display="block");return}const i=d.split(" ").map(r=>r.charAt(0).toUpperCase()+r.slice(1)).join(" ");h&&(h.style.display="none"),k=i,w=E,C(2)};U&&U.addEventListener("submit",b),e&&e.addEventListener("click",O),a.addEventListener("click",$),t.addEventListener("click",l=>{l.target===t&&$()});const B=l=>{l.key==="Escape"&&t.classList.contains("active")&&$()};window.addEventListener("keydown",B),x&&x.addEventListener("click",l=>{l.preventDefault(),$(),N("pricing",!0)}),window.goToBookingStep=C,window.openBookingModal=O}let ae=!0;function Ce(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn"),a=document.getElementById("strat-modal-step-1"),s=document.getElementById("strat-modal-step-2"),o=document.getElementById("strat-modal-step-3"),n=document.getElementById("strat-modal-step-4"),m=document.getElementById("strat-modal-step-num"),p=document.getElementById("strat-modal-step-title"),y=document.getElementById("strat-modal-step-badge"),v=document.getElementById("strat-modal-progress-bar"),U=document.getElementById("strat-modal-step1-form"),f=document.getElementById("strat-modal-step2-form"),c=document.getElementById("strat-input-name"),h=document.getElementById("strat-input-phone"),x=document.getElementById("strat-input-business"),k=document.getElementById("strat-select-revenue"),w=document.getElementById("strat-modal-step1-error"),I=document.getElementById("strat-modal-step2-error"),P=document.getElementById("strat-modal-confirm-pricing-link");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);let A="",D="",R="",M="";const S=()=>{c&&(c.value=""),h&&(h.value="+971 "),x&&(x.value=""),k&&(k.value=""),w&&(w.style.display="none"),I&&(I.style.display="none"),O(1),t.classList.add("active"),document.body.style.overflow="hidden"},C=()=>{t.classList.remove("active"),document.body.style.overflow=""},O=b=>{!a||!s||!o||!n||!m||!p||!y||!v||(b===1?(a.style.display="block",s.style.display="none",o.style.display="none",n.style.display="none",y.style.display="inline",m.textContent="1",p.textContent="Tell us about yourself",v.style.width="33%"):b===2?(a.style.display="none",s.style.display="block",o.style.display="none",n.style.display="none",y.style.display="inline",m.textContent="2",p.textContent="Your business details",v.style.width="66%"):b===3?(a.style.display="none",s.style.display="none",o.style.display="block",n.style.display="none",y.style.display="inline",m.textContent="3",p.textContent="Schedule your strategy call",v.style.width="100%",$()):b===4&&(a.style.display="none",s.style.display="none",o.style.display="none",n.style.display="block",y.style.display="none",p.textContent="Call Scheduled!",v.style.width="100%"))},$=()=>{const b=document.getElementById("strat-modal-calendly-container");if(!b)return;const B=M==="Under AED 5k/month"||M==="Under $5k"||M==="$0 - $5k";ae=!B;const l=B?"https://calendly.com/officialatlanticbear/intro-call?primary_color=3b69ff":"https://calendly.com/officialatlanticbear/strategy-call?primary_color=3b69ff",d=M.replace(/–/g,"-").trim(),E=`${l}&name=${encodeURIComponent(A)}&a1=${encodeURIComponent(D)}&a2=${encodeURIComponent(R)}&a3=${encodeURIComponent(d)}&a4=${encodeURIComponent(d)}`;b.innerHTML="",V(b);const i={url:E,parentElement:b,prefill:{name:A,customAnswers:{a1:D,a2:R,a3:d,a4:d,a5:d}}},r=()=>window.Calendly.initInlineWidget(i);if(window.Calendly)r();else{const u=document.getElementById("calendly-sdk");u&&u.addEventListener("load",r,{once:!0})}};U&&U.addEventListener("submit",b=>{b.preventDefault();const B=(c==null?void 0:c.value.trim())||"",l=(h==null?void 0:h.value.trim())||"";if(!B||!l){w&&(w.style.display="block");return}w&&(w.style.display="none"),A=B,D=l,O(2)}),f&&f.addEventListener("submit",async b=>{b.preventDefault();const B=(x==null?void 0:x.value.trim())||"",l=(k==null?void 0:k.value)||"";if(!B||!l){I&&(I.style.display="block");return}if(I&&(I.style.display="none"),R=B,M=l,!(l==="Under AED 5k/month"||l==="Under $5k"||l==="$0 - $5k")){const E=document.getElementById("strat-modal-step2-submit-btn");E&&(E.disabled=!0,E.textContent="Verifying...");const i=await X("booking_submit");fetch("https://script.google.com/macros/s/AKfycbxhmc6G4n4zpk0SGvjzP81_Cd9ipLxM3Wx5MZNWzF02tBqqUMD0JCAuDnH1OojQfv7vJQ/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({action:"form_submit",name:A,phone:D,business:R,revenue:M,source:"strategy_call",recaptchaToken:i||""})}).catch(r=>console.error("Google Sheet submission failed:",r)),E&&(E.disabled=!1,E.textContent="Continue to Calendar →")}O(3)}),e.addEventListener("click",C),t.addEventListener("click",b=>{b.target===t&&C()}),window.addEventListener("keydown",b=>{b.key==="Escape"&&t.classList.contains("active")&&C()}),P&&P.addEventListener("click",b=>{b.preventDefault(),C(),N("pricing",!0)}),window.goToStratBookingStep=O,window.openStratBookingModal=S}function N(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const s=document.getElementById("strat-booking-modal");s&&s.remove(),document.body.style.overflow="",Z(),ee();const o=document.getElementById("main-nav"),n=document.querySelector(".site-footer");t==="booking"||t==="booked"?(o&&(o.style.display="none"),n&&(n.style.display="none")):(o&&(o.style.display=""),n&&(n.style.display=""));const m=z("#main-content");m.style.opacity="0",m.style.transform="translateY(8px)",setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),m.innerHTML=te[t](),be(t),m.style.transition="opacity 0.3s ease, transform 0.3s ease",requestAnimationFrame(()=>{m.style.opacity="1",m.style.transform="translateY(0)"}),ye(),t==="contact"&&we(),(t==="booking"||t==="booked"||t==="booking-new")&&(T("pageload",2e3),se(),oe(),Ee(),Ae(t==="booking"||t==="booked"),t==="booking-new"?(xe(),document.querySelectorAll(".funnel-cta-btn").forEach(p=>{p.addEventListener("click",()=>{window.openBookingModal&&window.openBookingModal()})})):t==="booking"&&(Ce(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(p=>{p.addEventListener("click",()=>{window.openStratBookingModal&&window.openStratBookingModal()})}))),he(t),ke(),typeof window.fbq=="function"&&window.fbq("track","PageView"),e){const p=t==="home"?"/":`/${t}`;window.location.pathname!==p&&history.pushState(null,"",p)}},150)}function Be(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const s=a.getAttribute("data-link");s&&te[s]&&N(s)})}function Se(){const t=z("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{const t=document.getElementById("app");t.innerHTML=`
    ${ne()}
  ...
  `,Be(t),Se(),Q(),window.addEventListener("message",a=>{if(!a.origin||!a.origin.includes("calendly.com"))return;let s=!1;if(a&&a.data&&typeof a.data=="object"&&a.data.event==="calendly.event_scheduled"&&(s=!0),s){const o=document.getElementById("strat-booking-modal"),n=document.getElementById("booking-modal");o&&o.classList.contains("active")?(ae?(T("bookedcall_strategy"),typeof window.fbq=="function"&&!sessionStorage.getItem("fbq_schedule_fired")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1"))):T("bookedcall_intro"),o&&o.classList.remove("active")):(T("bookedcall"),n&&n.classList.remove("active")),document.body.style.overflow="",N("booked")}});const e=G(window.location.pathname);N(e,!1),window.addEventListener("popstate",()=>{const a=G(window.location.pathname);N(a,!1)})});
