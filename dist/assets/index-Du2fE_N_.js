(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const le={ogImage:"/og-image.png"},j={site:le},$=(t,e=document)=>e.querySelector(t),F=(t,e=document)=>[...e.querySelectorAll(t)],H="atlanticbear_analytics_8d24";function C(){if(sessionStorage.getItem("notrack"))return!0;try{if(new URLSearchParams(window.location.search).get("preview")==="true")return!0}catch{}return!1}function g(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${H}/${t}`).catch(()=>{});try{const i=ue();fetch(`https://abacus.jasoncameron.dev/hit/${H}/${i}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}let U={};function ce(){Q();const t=e=>{U[`t${e}`]=window.setTimeout(()=>{g(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function Q(){Object.values(U).forEach(clearTimeout),U={}}let A={moved:!1,calendar:!1,testimonials:!1},L=null;function de(){X(),A={moved:!1,video:!1,calendar:!1,testimonials:!1},L=()=>{window.scrollY>50&&!A.moved&&(A.moved=!0,g("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!A.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(A.calendar=!0,g("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!A.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(A.testimonials=!0,g("scroll_testimonials"))},window.addEventListener("scroll",L,{passive:!0})}function X(){L&&(window.removeEventListener("scroll",L),L=null)}function ue(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),i=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${a}-${i}-${s}`}const u={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function pe(){return`
  ...
  <section class="cc-section">
    ...
    </div>`).join("")}</div>`}function ge(){return`
  <!-- WHO WE BUILD FOR -->
  ...
  </div>`}function J(t,e,a){const i=a.map(s=>`
  ...
  </div>`}function Be(){return ee("launch")}function Ie(){return ee("growth")}const te={home:fe,pricing:ke,contact:Ee,testimonials:xe,booking:Te,booked:Le,"meta-ads":be,"meta-ads-shazay":we,terms:Ae,privacy:Se,launch:Be,growth:Ie},G={home:{title:"Website Design Agency in Dubai, UAE | Atlantic Bear",desc:"Custom website design agency in Dubai, UAE. We build professional, conversion-focused websites for serious UAE business owners. Live in 5 days, fully managed."},pricing:{title:"Website Design Pricing in Dubai & UAE | Atlantic Bear",desc:"Transparent pricing for custom website design in Dubai and the UAE. Fully managed, no contracts, live in 5 days. Plans from AED 3,500 setup + AED 300/mo."},contact:{title:"Contact a Dubai Website Design Agency | Atlantic Bear",desc:"Get in touch with Atlantic Bear, a custom website design agency based in Dubai. Fast response, usually within a few hours. Start your UAE website project today."},testimonials:{title:"Client Reviews & Website Transformations | Atlantic Bear Dubai",desc:"See real client results from Atlantic Bear. Before and after website case studies for businesses in the UAE and UK. Watch client video testimonials."},booking:{title:"Book a Free Call | Website Agency Dubai | Atlantic Bear",desc:"Book a free 30-minute strategy call with Atlantic Bear, a website design agency in Dubai. Watch our overview video and schedule your slot."},booked:{title:"Call Confirmed | Atlantic Bear",desc:"Your call is locked in. Add the event to your calendar and watch the pre-call video before our session."},"meta-ads":{title:"Facebook & Instagram Ads Dubai, UAE | Atlantic Bear",desc:"Run targeted Facebook and Instagram ad campaigns in Dubai and the UAE with Atlantic Bear. Local targeting, ad creatives, and direct WhatsApp leads. AED 2,500/mo."},"meta-ads-shazay":{title:"TikTok Ads Retainer Payment | Atlantic Bear",desc:"Set up your Atlantic Bear TikTok Ads retainer subscription, billed every 15 days."},terms:{title:"Terms & Conditions | Atlantic Bear Website Agency Dubai",desc:"The terms covering Atlantic Bear website design, development, hosting, and maintenance services for businesses in Dubai and the UAE."},privacy:{title:"Privacy Policy | Atlantic Bear Website Agency Dubai",desc:"How Atlantic Bear collects, uses, stores, and protects the personal information you share through our website."},launch:{title:"The Launch Plan | Atlantic Bear",desc:"Atlantic Bear Launch Plan, internal sales presentation."},growth:{title:"The Growth Plan | Atlantic Bear",desc:"Atlantic Bear Growth Plan, internal sales presentation."}};function We(t){const e=document.getElementById("faq-schema");if(e&&e.remove(),t!=="contact")return;const a=document.createElement("script");a.type="application/ld+json",a.id="faq-schema",a.textContent=JSON.stringify({"@context":"https://schema.org","@type":"FAQPage",mainEntity:Z.map(i=>({"@type":"Question",name:i.q,acceptedAnswer:{"@type":"Answer",text:i.a}}))}),document.head.appendChild(a)}const Pe=["meta-ads-shazay"];function qe(t){const e=G[t]||G.home;document.title=e.title,We(t);let a=document.querySelector('meta[name="robots"]');Pe.includes(t)?(a||(a=document.createElement("meta"),a.setAttribute("name","robots"),document.head.appendChild(a)),a.setAttribute("content","noindex, nofollow")):a&&a.remove();let i=document.querySelector('meta[name="description"]');i||(i=document.createElement("meta"),i.setAttribute("name","description"),document.head.appendChild(i)),i.setAttribute("content",e.desc);let s=document.querySelector('link[rel="canonical"]');s||(s=document.createElement("link"),s.setAttribute("rel","canonical"),document.head.appendChild(s));const o=`${window.location.origin}${t==="home"?"":"/"+t}`;s.setAttribute("href",o);const r={"og:title":e.title,"og:description":e.desc,"og:url":o,"og:type":"website","og:image":`${window.location.origin}${j.site.ogImage}`};for(const[l,m]of Object.entries(r)){let h=document.querySelector(`meta[property="${l}"]`);h||(h=document.createElement("meta"),h.setAttribute("property",l),document.head.appendChild(h)),h.setAttribute("content",m)}const p={"twitter:card":"summary_large_image","twitter:title":e.title,"twitter:description":e.desc,"twitter:image":`${window.location.origin}${j.site.ogImage}`};for(const[l,m]of Object.entries(p)){let h=document.querySelector(`meta[name="${l}"]`);h||(h=document.createElement("meta"),h.setAttribute("name",l),document.head.appendChild(h)),h.setAttribute("content",m)}}const De=["/blog"];function ae(t){return De.some(e=>t===e||t.startsWith(e+"/"))}function V(t){const e=t.replace(/^\/|\/$/g,"");return e==="pricing"||e==="work"||e==="contact"||e==="testimonials"||e==="booking"||e==="booking-new"||e==="meta-ads"||e==="meta-ads-shazay"||e==="booked"||e==="terms"||e==="privacy"||e==="launch"||e==="growth"?e:"home"}function Me(t){F("#main-nav [data-link]").forEach(a=>a.classList.remove("active"));const e=$(`#main-nav [data-link="${t}"].nav-link`);e&&e.classList.add("active")}const Oe=[".section-title",".section-sub",".facts-headline",".fact-hero-block",".facts-stat-block",".basic-system-card",".step",".feature-item",".teaser-card",".tier-card",".level-one-card",".pricing-plan-card",".guarantee-card",".pricing-bonus-block",".problem-card",".contact-method",".cc-copy",".cc-visual",".reviews-head",".competitor-banner-text",".meta-ads-teaser-box"].join(",");function Ue(){Array.from(document.querySelectorAll(Oe)).forEach(e=>{if(e.classList.contains("reveal")||e.classList.contains("revealed"))return;e.classList.add("reveal");const a=e.parentElement;if(!a)return;const s=Array.from(a.children).filter(o=>o.classList.contains("reveal")).indexOf(e);s>0&&!e.style.transitionDelay&&(e.style.transitionDelay=`${Math.min(s*.07,.35)}s`)})}function $e(){const t=F(".reveal"),e=new IntersectionObserver(a=>{a.forEach(i=>{i.isIntersecting&&(i.target.classList.add("revealed"),e.unobserve(i.target))})},{threshold:.07,rootMargin:"0px 0px -30px 0px"});t.forEach(a=>e.observe(a))}function Fe(t){const e=t.innerHTML,a=(t.textContent||"").trim();if(!a)return;t.textContent="",t.classList.add("is-typing");let i=0;const s=()=>{i+=1,t.textContent=a.slice(0,i),i<a.length?window.setTimeout(s,105):(t.innerHTML=e,t.classList.remove("is-typing"))};window.setTimeout(s,90)}function Re(){const t=F(".fact-hero-num, .facts-stat-num");if(!t.length||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;t.forEach(a=>{a.style.minHeight=`${a.getBoundingClientRect().height}px`});const e=new IntersectionObserver(a=>{a.forEach((i,s)=>{if(!i.isIntersecting)return;const o=i.target;e.unobserve(o),window.setTimeout(()=>Fe(o),s*150)})},{threshold:.4});t.forEach(a=>e.observe(a))}function ze(){const t="P-3J276348CL7673454NKNKCRA",e="#paypal-button-container-"+t,a="https://www.paypal.com/sdk/js?client-id=BAAeLN9PQY_40P1TyOqzvSGlsxkJvgSNc84tV2boPr7iX-TUntDkuIFWfjw3zc3V8zc13VS2nx64j-E710&vault=true&intent=subscription";function i(){const r=window.paypal,p=document.querySelector(e);!r||!p||p.dataset.rendered==="1"||(p.dataset.rendered="1",r.Buttons({style:{shape:"rect",color:"blue",layout:"vertical",label:"subscribe"},createSubscription:function(l,m){return m.subscription.create({plan_id:t})},onApprove:function(){const l=document.getElementById("paypal-shazay-success");l&&(l.style.display="block"),p.style.display="none"}}).render(e))}if(window.paypal){i();return}const s=document.getElementById("paypal-sdk-shazay");if(s){s.addEventListener("load",i,{once:!0});return}const o=document.createElement("script");o.id="paypal-sdk-shazay",o.src=a,o.setAttribute("data-sdk-integration-source","button-factory"),o.onload=i,document.body.appendChild(o)}function se(t){window.getComputedStyle(t).position==="static"&&(t.style.position="relative");const a=document.createElement("div");a.className="calendly-spinner-wrap",a.style.display="flex",a.style.justifyContent="center",a.style.alignItems="center",a.style.position="absolute",a.style.top="50%",a.style.left="50%",a.style.transform="translate(-50%, -50%)",a.style.pointerEvents="none",a.style.zIndex="1",a.innerHTML=`
  ...
  `,t.appendChild(a);const i=new MutationObserver(()=>{const s=t.querySelector("iframe");s&&(s.style.position="relative",s.style.zIndex="2",s.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),i.disconnect())});i.observe(t,{childList:!0})}function Ye(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),i=e.querySelector("video");a&&i&&a.addEventListener("click",s=>{s.stopPropagation(),i.muted=!1,i.currentTime=0,i.controls=!0,a.style.display="none",i.play().catch(o=>{console.error("Play failed:",o)})})})}function Ne(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",se(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const i=document.createElement("script");i.id="calendly-sdk",i.src="https://assets.calendly.com/assets/external/widget.js",i.async=!0,i.addEventListener("load",e,{once:!0}),document.head.appendChild(i)}}function _e(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),i=document.getElementById("bv-play-btn"),s=document.getElementById("bv-controls"),o=document.getElementById("bv-playpause"),r=document.getElementById("bv-progress-fill"),p=document.getElementById("bv-progress-thumb"),l=document.getElementById("bv-progress-wrap"),m=document.getElementById("bv-time"),h=document.getElementById("bv-mute"),w=document.getElementById("bv-volume"),f=document.getElementById("bv-fullscreen"),v=document.getElementById("custom-video-wrap");if(!e||!a||!i||!s||!o)return;e.volume=.9;let k=null,B=null;const I=()=>{try{const n=window.AudioContext||window.webkitAudioContext;if(!n)return;if(!k){k=new n;const c=k.createMediaElementSource(e);B=k.createGain(),B.gain.value=2,c.connect(B),B.connect(k.destination)}k.state==="suspended"&&k.resume()}catch(n){console.warn("AudioContext boost failed:",n)}},R=e.getAttribute("data-src"),q=()=>{R&&!e.getAttribute("src")&&(e.setAttribute("src",R),e.load())};let y=!0;const ie=5,oe=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{y&&e.currentTime>=ie&&(e.currentTime=0)}),setTimeout(oe,800);const z=n=>{const c=Math.floor(n/60),d=Math.floor(n%60);return`${c}:${d.toString().padStart(2,"0")}`},x=90,E=60,ne=(n,c)=>!t||c<=x?n/c*100:n<=x?n/x*E:E+(n-x)/(c-x)*(100-E),re=(n,c)=>!t||c<=x?n/100*c:n<=E?n/E*x:x+(n-E)/(100-E)*(c-x),D=()=>{if(!e.duration)return;const n=ne(e.currentTime,e.duration);r&&(r.style.width=n+"%"),p&&(p.style.left=n+"%"),m&&(m.textContent=`${z(e.currentTime)} / ${z(e.duration)}`)},T=n=>{const c=o==null?void 0:o.querySelector(".icon-play"),d=o==null?void 0:o.querySelector(".icon-pause");c&&(c.style.display=n&&!y?"none":"block"),d&&(d.style.display=n&&!y?"block":"none"),a&&(a.style.display=n&&!y?"none":"flex"),v&&(n&&!y?v.classList.add("playing"):v.classList.remove("playing"))};a.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const n=e.src.split("#")[0];e.src!==n&&(e.src=n,e.load()),e.currentTime=0}q(),I(),T(!0),e.play()}),e.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const n=e.src.split("#")[0];e.src!==n&&(e.src=n,e.load()),e.currentTime=0,I(),T(!0),e.play();return}q(),I(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>T(!0)),e.addEventListener("pause",()=>T(!1)),e.addEventListener("ended",()=>T(!1)),e.addEventListener("timeupdate",D),e.addEventListener("loadedmetadata",D);let Y=!1,N=!1;const b={m25:!1,m50:!1,m75:!1,m95:!1,m100:!1},_={};if(e.addEventListener("play",()=>{!N&&!y&&(N=!0,typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","VSL_Play"))}),e.addEventListener("timeupdate",()=>{const n=e.duration;if(!n)return;const c=e.currentTime,d=c/n*100;if(!Y&&c>.5&&!y&&(Y=!0,g("videoplay")),y)return;d>=25&&!b.m25&&(b.m25=!0,g("videowatch_25pct"),typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","VSL_25")),d>=50&&!b.m50&&(b.m50=!0,g("videowatch_50pct"),typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","VSL_50")),d>=75&&!b.m75&&(b.m75=!0,g("videowatch_75pct"),typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","VSL_75")),d>=95&&!b.m95&&(b.m95=!0,typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","VSL_95")),d>=98&&!b.m100&&(b.m100=!0,g("videowatch_complete"));const W=[10,30],M=Math.floor(c);W.forEach(S=>{M>=S&&!_[S]&&(_[S]=!0,g(`videowatch_${S}s`))})}),o.addEventListener("click",()=>{q(),I(),e.paused?e.play():e.pause()}),l){const n=d=>{const W=l.getBoundingClientRect(),M=d instanceof MouseEvent?d.clientX:d.touches[0].clientX,S=Math.max(0,Math.min(100,(M-W.left)/W.width*100));e.currentTime=re(S,e.duration),D()};let c=!1;l.addEventListener("mousedown",d=>{c=!0,n(d)}),window.addEventListener("mousemove",d=>{c&&n(d)}),window.addEventListener("mouseup",()=>{c=!1}),l.addEventListener("touchstart",d=>n(d),{passive:!0}),l.addEventListener("touchmove",d=>n(d),{passive:!0})}if(w&&w.addEventListener("input",()=>{e.volume=parseFloat(w.value),e.muted=e.volume===0}),h&&h.addEventListener("click",()=>{e.muted=!e.muted,w&&(w.value=e.muted?"0":String(e.volume||1))}),f&&v&&f.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():v.requestFullscreen?v.requestFullscreen():v.webkitRequestFullscreen?v.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),v){let n;const c=()=>{s.style.opacity="1",clearTimeout(n),n=window.setTimeout(()=>{e.paused||(s.style.opacity="0")},2500)};v.addEventListener("mousemove",c),v.addEventListener("mouseenter",c),v.addEventListener("mouseleave",()=>{e.paused||(s.style.opacity="0")}),e.addEventListener("play",()=>{n=window.setTimeout(()=>{s.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{s.style.opacity="1",clearTimeout(n)})}}function je(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);const a=()=>{const o=document.getElementById("strat-modal-calendly-container");if(!o)return;const r="https://calendly.com/officialatlanticbear/strategy-call?hide_gdpr_banner=1&primary_color=3b69ff";o.innerHTML="",se(o);const p=()=>window.Calendly.initInlineWidget({url:r,parentElement:o});if(window.Calendly)p();else{const l=document.getElementById("calendly-sdk");l&&l.addEventListener("load",p,{once:!0})}},i=()=>{t.classList.add("active"),document.body.style.overflow="hidden",a()},s=()=>{t.classList.remove("active"),document.body.style.overflow=""};e.addEventListener("click",s),window.addEventListener("keydown",o=>{o.key==="Escape"&&t.classList.contains("active")&&s()}),window.openStratBookingModal=i}const K=["home","pricing","testimonials","meta-ads","contact","booking","booked"];let O=null;function P(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const i=document.getElementById("strat-booking-modal");i&&i.remove(),document.body.style.overflow="",Q(),X();const s=document.getElementById("main-nav"),o=document.querySelector(".site-footer");t==="booking"?(s&&(s.style.display="none"),o&&(o.style.display="none")):(s&&(s.style.display=""),o&&(o.style.display=""));const r=$("#main-content"),p=O?K.indexOf(O):-1,l=K.indexOf(t),m=p===-1||l>=p,h=m?"-8%":"8%",w=m?"8%":"-8%";O=t;const f=window.matchMedia("(prefers-reduced-motion: reduce)").matches;r.style.transition=f?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",r.style.opacity="0",f||(r.style.transform=`translateX(${h})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),r.style.transition="none",f||(r.style.transform=`translateX(${w})`),r.innerHTML=te[t](),Me(t),requestAnimationFrame(()=>{r.style.transition=f?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",r.style.opacity="1",r.style.transform="translateX(0)"}),Ue(),$e(),Re(),t==="meta-ads-shazay"&&ze(),(t==="booking"||t==="booked")&&(g("pageload",2e3),ce(),de(),Ne(),_e(t==="booking"),t==="booking"&&(je(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(v=>{v.addEventListener("click",()=>{typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","BookButtonClick"),window.openStratBookingModal&&window.openStratBookingModal()})}))),qe(t),Ye(),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&window.fbq("track","PageView"),e){const v=t==="home"?"/":`/${t}`;window.location.pathname!==v&&history.pushState(null,"",v)}},260)}function He(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;const i=a.getAttribute("href")||"";if(ae(i))return;e.preventDefault();const s=a.getAttribute("data-link");s&&te[s]&&P(s)})}function Ge(){const t=$("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}document.addEventListener("DOMContentLoaded",()=>{const t=new URLSearchParams(window.location.search);(t.get("notrack")==="1"||t.get("preview")==="true")&&sessionStorage.setItem("notrack","1");const e=t.get("fbclid"),a=(t.get("utm_source")||"").toLowerCase();(!!e||["facebook","instagram","fb","meta"].some(r=>a.includes(r)))&&sessionStorage.setItem("came_from_meta","1");const s=document.getElementById("app");if(s.innerHTML=`
    ${pe()}
  ...
  `,He(s),Ge(),window.addEventListener("message",r=>{if(!r.origin||!r.origin.includes("calendly.com"))return;let p=!1;if(r&&r.data){let l=r.data;if(typeof l=="string")try{l=JSON.parse(l)}catch{}typeof l=="object"&&l&&l.event==="calendly.event_scheduled"&&(p=!0)}if(p){const l=document.getElementById("strat-booking-modal"),m=document.getElementById("booking-modal");l&&l.classList.contains("active")?(g("bookedcall_strategy"),typeof window.fbq=="function"&&sessionStorage.getItem("came_from_meta")&&!sessionStorage.getItem("fbq_schedule_fired")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1")),l&&l.classList.remove("active")):(g("bookedcall"),m&&m.classList.remove("active")),document.body.style.overflow="",P("booked")}}),ae(window.location.pathname)){if(!sessionStorage.getItem("static_route_reload")){sessionStorage.setItem("static_route_reload","1"),window.location.reload();return}}else sessionStorage.removeItem("static_route_reload");const o=V(window.location.pathname);P(o,!1),window.addEventListener("popstate",()=>{const r=V(window.location.pathname);P(r,!1)})});
