(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const p of i.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&s(p)}).observe(document,{childList:!0,subtree:!0});function a(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(o){if(o.ep)return;o.ep=!0;const i=a(o);fetch(o.href,i)}})();const V=(t,e=document)=>e.querySelector(t),z=(t,e=document)=>[...e.querySelectorAll(t)],j="atlanticbear_analytics_8d24";function x(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${j}/${t}`).catch(()=>{});try{const s=te();fetch(`https://abacus.jasoncameron.dev/hit/${j}/${s}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}let q={};function Q(){K();const t=e=>{q[`t${e}`]=window.setTimeout(()=>{x(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function K(){Object.values(q).forEach(clearTimeout),q={}}let T={moved:!1,calendar:!1,testimonials:!1},F=null;function ee(){J(),T={moved:!1,video:!1,calendar:!1,testimonials:!1},F=()=>{window.scrollY>50&&!T.moved&&(T.moved=!0,x("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!T.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(T.calendar=!0,x("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!T.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(T.testimonials=!0,x("scroll_testimonials"))},window.addEventListener("scroll",F,{passive:!0})}function J(){F&&(window.removeEventListener("scroll",F),F=null)}function te(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}const f={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function ae(){return`
  <nav class="nav" id="main-nav">
    ...
    <div class="nav-actions">
      ...
      <a href="/booking" class="btn btn-dark btn-sm" data-link="booking" id="nav-book-cta">Book a Call ${f.arrow}</a>
    </div>
  ...
  <section class="free-demo-section reveal">
    <div class="container">
      <div class="free-demo-inner">
        ...
        <a href="/booking" class="btn btn-dark btn-large free-demo-cta" data-link="booking" id="home-free-demo-cta">Get Your Free Demo ${f.arrow}</a>
    ...
    <div class="container">
      ...
      <div class="feature-grid">
        ...
        <div class="feature-item reveal" style="display:flex; flex-direction:column; justify-content:center; background:var(--surface);">
          ...
          <a href="/booking" class="btn btn-dark btn-sm" data-link="booking" style="align-self:flex-start;">Book a Call ${f.arrow}</a>
        </div>
      </div>
    </div>
  </section>
  ...
  `,t.appendChild(a);const s=new MutationObserver(()=>{const o=t.querySelector("iframe");o&&(o.style.position="relative",o.style.zIndex="2",o.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),s.disconnect())});s.observe(t,{childList:!0})}function fe(){const t=document.querySelectorAll(".custom-testimonial-video-wrap");setTimeout(()=>{t.forEach(e=>{const a=e.querySelector("video");a&&a.play().catch(s=>{console.warn("Autoplay muted failed:",s)})})},4e3),t.forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),s=e.querySelector("video");a&&s&&a.addEventListener("click",o=>{o.stopPropagation(),s.muted=!1,s.currentTime=0,s.controls=!0,a.style.display="none",s.play().catch(i=>{console.error("Play failed:",i)})})})}function ge(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",Z(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const s=document.createElement("script");s.id="calendly-sdk",s.src="https://assets.calendly.com/assets/external/widget.js",s.async=!0,s.addEventListener("load",e,{once:!0}),document.head.appendChild(s)}}function he(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),s=document.getElementById("bv-play-btn"),o=document.getElementById("bv-controls"),i=document.getElementById("bv-playpause"),p=document.getElementById("bv-progress-fill"),m=document.getElementById("bv-progress-thumb"),g=document.getElementById("bv-progress-wrap"),v=document.getElementById("bv-time"),D=document.getElementById("bv-mute"),u=document.getElementById("bv-volume"),r=document.getElementById("bv-fullscreen"),h=document.getElementById("custom-video-wrap");if(!e||!a||!s||!o||!i)return;let A=null,k=null;const E=()=>{try{const n=window.AudioContext||window.webkitAudioContext;if(!n)return;if(!A){A=new n;const l=A.createMediaElementSource(e);k=A.createGain(),k.gain.value=2,l.connect(k),k.connect(A.destination)}A.state==="suspended"&&A.resume()}catch(n){console.warn("AudioContext boost failed:",n)}},O=e.getAttribute("data-src"),C=()=>{O&&!e.getAttribute("src")&&(e.setAttribute("src",O),e.load())};let I=!0;const _=5,N=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{I&&e.currentTime>=_&&(e.currentTime=0)}),setTimeout(N,800);const L=n=>{const l=Math.floor(n/60),d=Math.floor(n%60);return`${l}:${d.toString().padStart(2,"0")}`},w=90,B=60,P=(n,l)=>!t||l<=w?n/l*100:n<=w?n/w*B:B+(n-w)/(l-w)*(100-B),U=(n,l)=>!t||l<=w?n/100*l:n<=B?n/B*w:w+(n-B)/(100-B)*(l-w),W=()=>{if(!e.duration)return;const n=P(e.currentTime,e.duration);p&&(p.style.width=n+"%"),m&&(m.style.left=n+"%"),v&&(v.textContent=`${L(e.currentTime)} / ${L(e.duration)}`)},c=n=>{const l=i==null?void 0:i.querySelector(".icon-play"),d=i==null?void 0:i.querySelector(".icon-pause");l&&(l.style.display=n?"none":"block"),d&&(d.style.display=n?"block":"none"),a&&(a.style.display=n?"none":"flex"),h&&(n?h.classList.add("playing"):h.classList.remove("playing"))};a.addEventListener("click",()=>{I=!1,C(),e.muted=!1,e.currentTime=0,E(),e.play()}),e.addEventListener("click",()=>{if(I){I=!1,e.muted=!1,e.currentTime=0,E(),e.play();return}C(),E(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>c(!0)),e.addEventListener("pause",()=>c(!1)),e.addEventListener("ended",()=>c(!1)),e.addEventListener("timeupdate",W),e.addEventListener("loadedmetadata",W);let b=!1;const y={m25:!1,m50:!1,m75:!1,m100:!1},S={};if(e.addEventListener("timeupdate",()=>{const n=e.duration;if(!n)return;const l=e.currentTime,d=l/n*100;!b&&l>.5&&(b=!0,x("videoplay")),d>=25&&!y.m25&&(y.m25=!0,x("videowatch_25pct")),d>=50&&!y.m50&&(y.m50=!0,x("videowatch_50pct")),d>=75&&!y.m75&&(y.m75=!0,x("videowatch_75pct")),d>=98&&!y.m100&&(y.m100=!0,x("videowatch_complete"));const Y=[10,30],$=Math.floor(l);Y.forEach(M=>{$>=M&&!S[M]&&(S[M]=!0,x(`videowatch_${M}s`))})}),i.addEventListener("click",()=>{C(),E(),e.paused?e.play():e.pause()}),g){const n=d=>{const Y=g.getBoundingClientRect(),$=d instanceof MouseEvent?d.clientX:d.touches[0].clientX,M=Math.max(0,Math.min(100,($-Y.left)/Y.width*100));e.currentTime=U(M,e.duration),W()};let l=!1;g.addEventListener("mousedown",d=>{l=!0,n(d)}),window.addEventListener("mousemove",d=>{l&&n(d)}),window.addEventListener("mouseup",()=>{l=!1}),g.addEventListener("touchstart",d=>n(d),{passive:!0}),g.addEventListener("touchmove",d=>n(d),{passive:!0})}if(u&&u.addEventListener("input",()=>{e.volume=parseFloat(u.value),e.muted=e.volume===0}),D&&D.addEventListener("click",()=>{e.muted=!e.muted,u&&(u.value=e.muted?"0":String(e.volume||1))}),r&&h&&r.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():h.requestFullscreen?h.requestFullscreen():h.webkitRequestFullscreen?h.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),h){let n;const l=()=>{o.style.opacity="1",clearTimeout(n),n=window.setTimeout(()=>{e.paused||(o.style.opacity="0")},2500)};h.addEventListener("mousemove",l),h.addEventListener("mouseenter",l),h.addEventListener("mouseleave",()=>{e.paused||(o.style.opacity="0")}),e.addEventListener("play",()=>{n=window.setTimeout(()=>{o.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{o.style.opacity="1",clearTimeout(n)})}}function be(){const t=document.getElementById("booking-modal"),e=document.getElementById("book-demo-btn-v2"),a=document.getElementById("booking-modal-close-btn"),s=document.getElementById("modal-step-1"),o=document.getElementById("modal-step-2"),i=document.getElementById("modal-step-3"),p=document.getElementById("modal-step-num"),m=document.getElementById("modal-step-title"),g=document.getElementById("modal-step-badge"),v=document.getElementById("modal-progress-bar"),D=document.getElementById("modal-step1-form"),u=document.getElementById("modal-input-name"),r=document.getElementById("modal-input-phone"),h=document.getElementById("modal-step1-error"),A=document.getElementById("modal-confirm-pricing-link");if(!t||!a)return;t.parentElement!==document.body&&document.body.appendChild(t);let k="",E="",O="";u&&localStorage.getItem("feather_booking_name")&&(u.value=localStorage.getItem("feather_booking_name")||""),r&&localStorage.getItem("feather_booking_phone")&&(r.value=localStorage.getItem("feather_booking_phone")||"");const C=document.getElementById("phone-flag-prefix"),I={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},_=()=>{if(!C||!r)return;const c=r.value.trim();let b="🇦🇪";for(const[y,S]of Object.entries(I))if(c.startsWith(y)){b=S;break}C.textContent=b};r&&((!r.value||r.value.trim()===""||r.value.trim()==="+971")&&(r.value="+971 "),r.addEventListener("input",_),_());const N=()=>{if(!k||!E)return;const c=`${k}|${E}`;if(O===c)return;O=c;const b=document.getElementById("modal-calendly-container");if(!b)return;b.innerHTML="",Z(b);const n={url:`https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff&name=${encodeURIComponent(k)}&a1=${encodeURIComponent(E)}`,parentElement:b,prefill:{name:k,customAnswers:{a1:E}}},l=()=>window.Calendly.initInlineWidget(n);if(window.Calendly)l();else{const d=document.getElementById("calendly-sdk");d&&d.addEventListener("load",l,{once:!0})}},L=()=>{const c=(u==null?void 0:u.value.trim())||"",b=(r==null?void 0:r.value.trim())||"";c.length>=3&&b.length>=5&&(k=c,E=b,N())};u==null||u.addEventListener("input",L),r==null||r.addEventListener("input",L),L();const w=c=>{c===1?(s&&(s.style.display="block"),o&&(o.style.display="none"),i&&(i.style.display="none"),p&&(p.textContent="1"),m&&(m.textContent="Tell us about yourself"),g&&(g.style.display="inline"),v&&(v.style.width="50%")):c===2?(s&&(s.style.display="none"),o&&(o.style.display="block"),i&&(i.style.display="none"),p&&(p.textContent="2"),m&&(m.textContent="Schedule your demo call"),g&&(g.style.display="inline"),v&&(v.style.width="100%"),k=(u==null?void 0:u.value.trim())||"",E=(r==null?void 0:r.value.trim())||"",N()):c===3&&(s&&(s.style.display="none"),o&&(o.style.display="none"),i&&(i.style.display="block"),m&&(m.textContent="Call Confirmed!"),g&&(g.style.display="none"),v&&(v.style.width="100%"))},B=()=>{t.classList.add("active"),document.body.style.overflow="hidden",h&&(h.style.display="none"),u&&localStorage.getItem("feather_booking_name")&&(u.value=localStorage.getItem("feather_booking_name")||""),r&&localStorage.getItem("feather_booking_phone")&&(r.value=localStorage.getItem("feather_booking_phone")||""),w(1)},P=()=>{t.classList.remove("active"),document.body.style.overflow=""},U=c=>{c&&c.preventDefault();const b=(u==null?void 0:u.value.trim())||"",y=(r==null?void 0:r.value.trim())||"";if(!b||!y){h&&(h.style.display="block");return}h&&(h.style.display="none"),k=b,E=y,localStorage.setItem("feather_booking_name",b),localStorage.setItem("feather_booking_phone",y),fetch("https://script.google.com/macros/s/AKfycbyE6OQMsiNActyf_24Emjw3AepiNzWZwGc3VZWi2RCWxM1Jg04yWZSIKfxJ8ff5Cu2-/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({name:b,phone:y,source:"booking_funnel"})}).catch(S=>console.error("Google Sheet submission failed:",S)),w(2)};D&&D.addEventListener("submit",U),e&&e.addEventListener("click",B),a.addEventListener("click",P),t.addEventListener("click",c=>{c.target===t&&P()});const W=c=>{c.key==="Escape"&&t.classList.contains("active")&&P()};window.addEventListener("keydown",W),A&&A.addEventListener("click",c=>{c.preventDefault(),P(),R("pricing",!0)}),window.goToBookingStep=w,window.openBookingModal=B}function R(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove(),document.body.style.overflow="",K(),J();const s=document.getElementById("main-nav"),o=document.querySelector(".site-footer");t==="booking"?(s&&(s.style.display="none"),o&&(o.style.display="none")):(s&&(s.style.display=""),o&&(o.style.display=""));const i=V("#main-content");i.style.opacity="0",i.style.transform="translateY(8px)",setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),i.innerHTML=X[t](),pe(t),i.style.transition="opacity 0.3s ease, transform 0.3s ease",requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),ve(),t==="contact"&&me(),t==="booking"||t==="booking-new"){x("pageload",2e3),Q(),ee(),ge(),he(t==="booking");const p=document.getElementById("skip-to-booking-btn");p&&p.addEventListener("click",m=>{m.preventDefault();const g=document.getElementById("booking-calendar");g&&g.scrollIntoView({behavior:"smooth",block:"start"})}),(t==="booking-new"||t==="booking")&&be(),t==="booking"&&document.querySelectorAll(".funnel-cta-btn").forEach(m=>{m.addEventListener("click",()=>{window.openBookingModal&&window.openBookingModal()})})}if(ue(t),fe(),typeof window.fbq=="function"&&window.fbq("track","PageView"),e){const p=t==="home"?"/":`/${t}`;window.location.pathname!==p&&history.pushState(null,"",p)}},150)}function ye(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const s=a.getAttribute("data-link");s&&X[s]&&R(s)})}function we(){const t=V("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{const t=document.getElementById("app");t.innerHTML=`
    ${ae()}
  ...
  `,ye(t),we(),window.addEventListener("message",a=>{let s=!1;if(a&&a.data&&(typeof a.data=="string"&&a.data.includes("calendly.event_scheduled")||typeof a.data=="object"&&(a.data.event==="calendly.event_scheduled"||a.data.event&&a.data.event.indexOf("event_scheduled")!==-1))&&(s=!0),s){x("bookedcall"),typeof window.fbq=="function"&&window.fbq("track","Schedule");const o=document.getElementById("booking-modal");o&&o.classList.contains("active")&&typeof window.goToBookingStep=="function"&&window.goToBookingStep(3)}});const e=H(window.location.pathname);R(e,!1),window.addEventListener("popstate",()=>{const a=H(window.location.pathname);R(a,!1)})});
