(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}})();const R=(t,e=document)=>e.querySelector(t),j=(t,e=document)=>[...e.querySelectorAll(t)],$="atlanticbear_analytics_8d24";function E(t,e=0){const s=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${$}/${t}`).catch(()=>{});try{const a=X();fetch(`https://abacus.jasoncameron.dev/hit/${$}/${a}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(s,e):s()}let N={};function K(){G();const t=e=>{N[`t${e}`]=window.setTimeout(()=>{E(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function G(){Object.values(N).forEach(clearTimeout),N={}}let C={moved:!1,calendar:!1,testimonials:!1},W=null;function J(){H(),C={moved:!1,video:!1,calendar:!1,testimonials:!1},W=()=>{window.scrollY>50&&!C.moved&&(C.moved=!0,E("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!C.calendar){const s=t.getBoundingClientRect();s.top+s.height/2<window.innerHeight&&(C.calendar=!0,E("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!C.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(C.testimonials=!0,E("scroll_testimonials"))},window.addEventListener("scroll",W,{passive:!0})}function H(){W&&(window.removeEventListener("scroll",W),W=null)}function X(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),s=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${s}-${a}-${o}`}const m={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function Z(){return`
  ...
  </footer>`}function ee(){const t=[{num:"3 Days",desc:"From kick-off to live"},{num:"100%",desc:"Mobile responsive"},{num:"Fully Custom",desc:"No templates, ever"},{num:"3+ Years",desc:"Building in the UAE"},{num:"81%",desc:"Of customers research online first"},{num:"SEO Ready",desc:"Google-optimised from day one"}],e=()=>t.map(a=>`<span class="marquee-badge"><span class="marquee-num">${a.num}</span><span class="marquee-desc">${a.desc}</span></span><span class="marquee-sep">·</span>`).join(""),s=e()+e()+e()+e();return`
  <!-- HERO -->
  ...
  `}const z={home:ee,pricing:te,work:ae,contact:oe,testimonials:se,booking:ie,"booking-new":ne},q={home:{title:"Atlantic Bear | Custom Website Design Agency in the UAE",desc:"Atlantic Bear is a leading website agency in the UAE. We build custom, premium websites for businesses. Get a free demo of your website before you pay anything."},pricing:{title:"More Clients Starts Here | Atlantic Bear Pricing",desc:"Transparent pricing for fully-managed brand positioning and high-conversion client acquisition platforms in the UAE. See your online presence live in 5 days, see it finished before you pay anything."},work:{title:"Our Work | Atlantic Bear Portfolio",desc:"Explore custom websites designed and developed for UAE businesses. Professional layouts, mobile optimization, and fast load times."},contact:{title:"Contact Atlantic Bear | Start Your UAE Website Project",desc:"Get in touch with Atlantic Bear. Let's discuss your business website needs. Fast response and custom layouts in Dubai & UAE."},testimonials:{title:"Client Testimonials & Transformations | Atlantic Bear",desc:"See real website transformations by Atlantic Bear. Before and after case studies showing how we help businesses across the UAE look professional online."},booking:{title:"Book a Call | Atlantic Bear Discovery Session",desc:"Watch our video, schedule your free 30-minute discovery call, and view our client success stories. Start your UAE website project today."},"booking-new":{title:"Book a Call (New Flow) | Atlantic Bear Discovery Session",desc:"Watch our video, tell us about yourself, and schedule your free 30-minute discovery call. Start your UAE website project today."}};function le(t){const e=q[t]||q.home;document.title=e.title;let s=document.querySelector('meta[name="description"]');s||(s=document.createElement("meta"),s.setAttribute("name","description"),document.head.appendChild(s)),s.setAttribute("content",e.desc);let a=document.querySelector('link[rel="canonical"]');a||(a=document.createElement("link"),a.setAttribute("rel","canonical"),document.head.appendChild(a));const o=`${window.location.origin}${t==="home"?"":"/"+t}`;a.setAttribute("href",o);const i={"og:title":e.title,"og:description":e.desc,"og:url":o,"og:type":"website","og:image":`${window.location.origin}/logo.png`};for(const[v,g]of Object.entries(i)){let u=document.querySelector(`meta[property="${v}"]`);u||(u=document.createElement("meta"),u.setAttribute("property",v),document.head.appendChild(u)),u.setAttribute("content",g)}const d={"twitter:card":"summary_large_image","twitter:title":e.title,"twitter:description":e.desc,"twitter:image":`${window.location.origin}/logo.png`};for(const[v,g]of Object.entries(d)){let u=document.querySelector(`meta[name="${v}"]`);u||(u=document.createElement("meta"),u.setAttribute("name",v),document.head.appendChild(u)),u.setAttribute("content",g)}}function V(t){const e=t.replace(/^\/|\/$/g,"");return e==="pricing"||e==="work"||e==="contact"||e==="testimonials"||e==="booking"||e==="booking-new"?e:"home"}function re(t){j("#main-nav [data-link]").forEach(s=>s.classList.remove("active"));const e=R(`#main-nav [data-link="${t}"].nav-link`);e&&e.classList.add("active")}function ce(){const t=j(".reveal"),e=new IntersectionObserver(s=>{s.forEach(a=>{a.isIntersecting&&(a.target.classList.add("revealed"),e.unobserve(a.target))})},{threshold:.07,rootMargin:"0px 0px -30px 0px"});t.forEach(s=>e.observe(s))}function de(){const t=document.getElementById("contact-form");if(!t)return;const e=document.createElement("script");e.src="https://unpkg.com/@formspree/ajax@1",e.defer=!0,document.head.appendChild(e),e.onload=()=>{window.formspree&&window.formspree("initForm",{formElement:"#contact-form",formId:"mykanvrr"})},t.addEventListener("submit",async s=>{s.preventDefault();const a=document.getElementById("form-submit-btn"),o=document.querySelector("[data-fs-success]"),i=document.querySelector('[data-fs-error]:not([data-fs-error="name"]):not([data-fs-error="email"]):not([data-fs-error="message"])');a&&(a.disabled=!0,a.textContent="Sending...");try{const d=new FormData(t);if((await fetch("https://formspree.io/f/mykanvrr",{method:"POST",body:d,headers:{Accept:"application/json"}})).ok)t.style.display="none",o&&(o.style.display="block",o.style.textAlign="center",o.style.padding="18px",o.style.background="rgba(62,207,142,.07)",o.style.borderRadius="10px",o.style.border="1px solid rgba(62,207,142,.20)");else throw new Error("Server error")}catch{i&&(i.textContent="Something went wrong. Please try again or email officialatlanticbear@gmail.com.",i.style.color="var(--red)",i.style.fontSize="0.85rem",i.style.marginTop="8px"),a&&(a.disabled=!1,a.textContent="Try again")}})}function ue(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{window.Calendly&&(t.innerHTML="",window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t}))},s=()=>{if(window.Calendly){e();return}let a=document.getElementById("calendly-sdk");a||(a=document.createElement("script"),a.id="calendly-sdk",a.src="https://assets.calendly.com/assets/external/widget.js",a.async=!0,document.head.appendChild(a)),a.onload=()=>{e()}};if(window.Calendly){e();return}setTimeout(s,1500)}function pe(t=!1){const e=document.getElementById("booking-video"),s=document.getElementById("bv-overlay"),a=document.getElementById("bv-play-btn"),o=document.getElementById("bv-controls"),i=document.getElementById("bv-playpause"),d=document.getElementById("bv-progress-fill"),v=document.getElementById("bv-progress-thumb"),g=document.getElementById("bv-progress-wrap"),u=document.getElementById("bv-time"),P=document.getElementById("bv-mute"),c=document.getElementById("bv-volume"),f=document.getElementById("bv-fullscreen"),h=document.getElementById("custom-video-wrap");if(!e||!s||!a||!o||!i)return;let x=null,k=null;const A=()=>{try{const n=window.AudioContext||window.webkitAudioContext;if(!n)return;if(!x){x=new n;const l=x.createMediaElementSource(e);k=x.createGain(),k.gain.value=2,l.connect(k),k.connect(x.destination)}x.state==="suspended"&&x.resume()}catch(n){console.warn("AudioContext boost failed:",n)}},D=e.getAttribute("data-src"),S=()=>{D&&!e.getAttribute("src")&&(e.setAttribute("src",D),e.load())};setTimeout(()=>{S()},1500);const T=n=>{const l=Math.floor(n/60),p=Math.floor(n%60);return`${l}:${p.toString().padStart(2,"0")}`},w=90,B=60,I=(n,l)=>!t||l<=w?n/l*100:n<=w?n/w*B:B+(n-w)/(l-w)*(100-B),Y=(n,l)=>!t||l<=w?n/100*l:n<=B?n/B*w:w+(n-B)/(100-B)*(l-w),M=()=>{if(!e.duration)return;const n=I(e.currentTime,e.duration);d&&(d.style.width=n+"%"),v&&(v.style.left=n+"%"),u&&(u.textContent=`${T(e.currentTime)} / ${T(e.duration)}`)},r=n=>{const l=i==null?void 0:i.querySelector(".icon-play"),p=i==null?void 0:i.querySelector(".icon-pause");l&&(l.style.display=n?"none":"block"),p&&(p.style.display=n?"block":"none"),s&&(s.style.display=n?"none":"flex"),h&&(n?h.classList.add("playing"):h.classList.remove("playing"))};s.addEventListener("click",()=>{S(),A(),e.play()}),e.addEventListener("click",()=>{S(),A(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>r(!0)),e.addEventListener("pause",()=>r(!1)),e.addEventListener("ended",()=>r(!1)),e.addEventListener("timeupdate",M),e.addEventListener("loadedmetadata",M);let b=!1;const y={m25:!1,m50:!1,m75:!1,m100:!1},O={};if(e.addEventListener("timeupdate",()=>{const n=e.duration;if(!n)return;const l=e.currentTime,p=l/n*100;!b&&l>.5&&(b=!0,E("videoplay")),p>=25&&!y.m25&&(y.m25=!0,E("videowatch_25pct")),p>=50&&!y.m50&&(y.m50=!0,E("videowatch_50pct")),p>=75&&!y.m75&&(y.m75=!0,E("videowatch_75pct")),p>=98&&!y.m100&&(y.m100=!0,E("videowatch_complete"));const F=[10,30],U=Math.floor(l);F.forEach(L=>{U>=L&&!O[L]&&(O[L]=!0,E(`videowatch_${L}s`))})}),i.addEventListener("click",()=>{S(),A(),e.paused?e.play():e.pause()}),g){const n=p=>{const F=g.getBoundingClientRect(),U=p instanceof MouseEvent?p.clientX:p.touches[0].clientX,L=Math.max(0,Math.min(100,(U-F.left)/F.width*100));e.currentTime=Y(L,e.duration),M()};let l=!1;g.addEventListener("mousedown",p=>{l=!0,n(p)}),window.addEventListener("mousemove",p=>{l&&n(p)}),window.addEventListener("mouseup",()=>{l=!1}),g.addEventListener("touchstart",p=>n(p),{passive:!0}),g.addEventListener("touchmove",p=>n(p),{passive:!0})}if(c&&c.addEventListener("input",()=>{e.volume=parseFloat(c.value),e.muted=e.volume===0}),P&&P.addEventListener("click",()=>{e.muted=!e.muted,c&&(c.value=e.muted?"0":String(e.volume||1))}),f&&h&&f.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():h.requestFullscreen?h.requestFullscreen():h.webkitRequestFullscreen?h.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),h){let n;const l=()=>{o.style.opacity="1",clearTimeout(n),n=window.setTimeout(()=>{e.paused||(o.style.opacity="0")},2500)};h.addEventListener("mousemove",l),h.addEventListener("mouseenter",l),h.addEventListener("mouseleave",()=>{e.paused||(o.style.opacity="0")}),e.addEventListener("play",()=>{n=window.setTimeout(()=>{o.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{o.style.opacity="1",clearTimeout(n)})}}function ve(){const t=document.getElementById("booking-modal"),e=document.getElementById("book-demo-btn-v2"),s=document.getElementById("booking-modal-close-btn"),a=document.getElementById("modal-step-1"),o=document.getElementById("modal-step-2"),i=document.getElementById("modal-step-3"),d=document.getElementById("modal-step-num"),v=document.getElementById("modal-step-title"),g=document.getElementById("modal-step-badge"),u=document.getElementById("modal-progress-bar"),P=document.getElementById("modal-step1-form"),c=document.getElementById("modal-input-name"),f=document.getElementById("modal-input-phone"),h=document.getElementById("modal-step1-error"),x=document.getElementById("modal-confirm-pricing-link");if(!t||!s)return;t.parentElement!==document.body&&document.body.appendChild(t);let k="",A="",D="";c&&localStorage.getItem("feather_booking_name")&&(c.value=localStorage.getItem("feather_booking_name")||""),f&&localStorage.getItem("feather_booking_phone")&&(f.value=localStorage.getItem("feather_booking_phone")||"");const S=()=>{if(!k||!A)return;const r=`${k}|${A}`;if(D===r)return;D=r;const b=document.getElementById("modal-calendly-container");if(b){b.innerHTML="";const n={url:`https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff&name=${encodeURIComponent(k)}&a1=${encodeURIComponent(A)}`,parentElement:b,prefill:{name:k,customAnswers:{a1:A}}};if(window.Calendly)window.Calendly.initInlineWidget(n);else{let l=document.getElementById("calendly-sdk");l||(l=document.createElement("script"),l.id="calendly-sdk",l.src="https://assets.calendly.com/assets/external/widget.js",l.async=!0,document.head.appendChild(l)),l.onload=()=>{window.Calendly&&window.Calendly.initInlineWidget(n)}}}},T=()=>{const r=(c==null?void 0:c.value.trim())||"",b=(f==null?void 0:f.value.trim())||"";r.length>=3&&b.length>=5&&(k=r,A=b,S())};c==null||c.addEventListener("input",T),f==null||f.addEventListener("input",T),setTimeout(()=>{if(T(),!window.Calendly){let r=document.getElementById("calendly-sdk");r||(r=document.createElement("script"),r.id="calendly-sdk",r.src="https://assets.calendly.com/assets/external/widget.js",r.async=!0,document.head.appendChild(r))}},1500);const w=r=>{r===1?(a&&(a.style.display="block"),o&&(o.style.display="none"),i&&(i.style.display="none"),d&&(d.textContent="1"),v&&(v.textContent="Tell us about yourself"),g&&(g.style.display="inline"),u&&(u.style.width="50%")):r===2?(a&&(a.style.display="none"),o&&(o.style.display="block"),i&&(i.style.display="none"),d&&(d.textContent="2"),v&&(v.textContent="Schedule your demo call"),g&&(g.style.display="inline"),u&&(u.style.width="100%"),k=(c==null?void 0:c.value.trim())||"",A=(f==null?void 0:f.value.trim())||"",S()):r===3&&(a&&(a.style.display="none"),o&&(o.style.display="none"),i&&(i.style.display="block"),v&&(v.textContent="Call Confirmed!"),g&&(g.style.display="none"),u&&(u.style.width="100%"))},B=()=>{t.classList.add("active"),document.body.style.overflow="hidden",h&&(h.style.display="none"),c&&localStorage.getItem("feather_booking_name")&&(c.value=localStorage.getItem("feather_booking_name")||""),f&&localStorage.getItem("feather_booking_phone")&&(f.value=localStorage.getItem("feather_booking_phone")||""),w(1)},I=()=>{t.classList.remove("active"),document.body.style.overflow=""},Y=r=>{r&&r.preventDefault();const b=(c==null?void 0:c.value.trim())||"",y=(f==null?void 0:f.value.trim())||"";if(!b||!y){h&&(h.style.display="block");return}h&&(h.style.display="none"),k=b,A=y,localStorage.setItem("feather_booking_name",b),localStorage.setItem("feather_booking_phone",y),localStorage.getItem("feather_booking_sheet_submitted")!=="true"&&fetch("https://script.google.com/macros/s/AKfycbyE6OQMsiNActyf_24Emjw3AepiNzWZwGc3VZWi2RCWxM1Jg04yWZSIKfxJ8ff5Cu2-/exec",{method:"POST",mode:"no-cors",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:b,phone:y,source:"booking_funnel"})}).then(()=>{localStorage.setItem("feather_booking_sheet_submitted","true")}).catch(O=>console.error("Google Sheet submission failed:",O)),w(2)};P&&P.addEventListener("submit",Y),e&&e.addEventListener("click",B),s.addEventListener("click",I),t.addEventListener("click",r=>{r.target===t&&I()});const M=r=>{r.key==="Escape"&&t.classList.contains("active")&&I()};window.addEventListener("keydown",M),x&&x.addEventListener("click",r=>{r.preventDefault(),I(),_("pricing",!0)}),window.goToBookingStep=w,window.openBookingModal=B}function _(t,e=!0){const s=document.getElementById("booking-modal");s&&s.remove(),document.body.style.overflow="",G(),H();const a=document.getElementById("main-nav"),o=document.querySelector(".site-footer");t==="booking"?(a&&(a.style.display="none"),o&&(o.style.display="none")):(a&&(a.style.display=""),o&&(o.style.display=""));const i=R("#main-content");i.style.opacity="0",i.style.transform="translateY(8px)",setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),i.innerHTML=z[t](),re(t),i.style.transition="opacity 0.3s ease, transform 0.3s ease",requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),ce(),t==="contact"&&de(),t==="booking"||t==="booking-new"){E("pageload",2e3),K(),J(),ue(),pe(t==="booking");const d=document.getElementById("skip-to-booking-btn");d&&d.addEventListener("click",v=>{v.preventDefault();const g=document.getElementById("booking-calendar");g&&g.scrollIntoView({behavior:"smooth",block:"start"})}),(t==="booking-new"||t==="booking")&&ve(),t==="booking"&&document.querySelectorAll(".funnel-cta-btn").forEach(v=>{v.addEventListener("click",()=>{window.openBookingModal&&window.openBookingModal()})})}if(le(t),typeof window.fbq=="function"&&window.fbq("track","PageView"),e){const d=t==="home"?"/":`/${t}`;window.location.pathname!==d&&history.pushState(null,"",d)}},150)}function me(t){t.addEventListener("click",e=>{const s=e.target.closest("[data-link]");if(!s||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const a=s.getAttribute("data-link");a&&z[a]&&_(a)})}function ge(){const t=R("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{const t=document.getElementById("app");t.innerHTML=`
    ${Z()}
  ...
  `,me(t),ge(),window.addEventListener("message",s=>{let a=!1;if(s&&s.data&&(typeof s.data=="string"&&s.data.includes("calendly.event_scheduled")||typeof s.data=="object"&&(s.data.event==="calendly.event_scheduled"||s.data.event&&s.data.event.indexOf("event_scheduled")!==-1))&&(a=!0),a){E("bookedcall"),typeof window.fbq=="function"&&window.fbq("track","Schedule");const o=document.getElementById("booking-modal");o&&o.classList.contains("active")&&typeof window.goToBookingStep=="function"&&window.goToBookingStep(3)}});const e=V(window.location.pathname);_(e,!1),window.addEventListener("popstate",()=>{const s=V(window.location.pathname);_(s,!1)})});
