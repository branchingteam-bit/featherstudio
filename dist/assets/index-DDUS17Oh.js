(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const ue={ogImage:"/og-image.png"},j={site:ue},U=(t,e=document)=>e.querySelector(t),z=(t,e=document)=>[...e.querySelectorAll(t)],H="atlanticbear_analytics_8d24";function C(){if(sessionStorage.getItem("notrack"))return!0;try{if(new URLSearchParams(window.location.search).get("preview")==="true")return!0}catch{}return!1}function g(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${H}/${t}`).catch(()=>{});try{const i=me();fetch(`https://abacus.jasoncameron.dev/hit/${H}/${i}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}let $={};function pe(){Q();const t=e=>{$[`t${e}`]=window.setTimeout(()=>{g(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function Q(){Object.values($).forEach(clearTimeout),$={}}let A={moved:!1,calendar:!1,testimonials:!1},B=null;function he(){X(),A={moved:!1,video:!1,calendar:!1,testimonials:!1},B=()=>{window.scrollY>50&&!A.moved&&(A.moved=!0,g("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!A.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(A.calendar=!0,g("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!A.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(A.testimonials=!0,g("scroll_testimonials"))},window.addEventListener("scroll",B,{passive:!0})}function X(){B&&(window.removeEventListener("scroll",B),B=null)}function me(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),i=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${a}-${i}-${s}`}const u={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function ve(){return`
  ...
  <section class="cc-section">
    ...
    </div>`).join("")}</div>`}function be(){return`
  <!-- WHO WE BUILD FOR -->
  ...
  </section>`}function ke(){const t=[{num:"5 Days",desc:"From kick-off to live"},{num:"100%",desc:"Mobile responsive"},{num:"Fully Custom",desc:"No templates, ever"},{num:"3+ Years",desc:"Building in the UAE"},{num:"81%",desc:"Of customers research online first"},{num:"SEO Ready",desc:"Google-optimised from day one"}],e=()=>t.map(i=>`<span class="marquee-badge"><span class="marquee-num">${i.num}</span><span class="marquee-desc">${i.desc}</span></span><span class="marquee-sep">·</span>`).join(""),a=e()+e()+e()+e();return`
  <!-- HERO -->
  ...
  `}const Ae="P-27V392505V141031PNKOZ3EQ",Se={};function J(){return window.location.pathname.replace(/^\/payment-?/,"").replace(/\/+$/,"").toLowerCase()}function Z(){return Se[J()]||Ae}function Ce(){const t=J(),e=t?t.split(/[-_]+/).filter(Boolean).map(s=>s.charAt(0).toUpperCase()+s.slice(1)).join(" "):"",a=Z();return`
  <div class="page-header" style="border-bottom:1px solid var(--border); padding-bottom: 40px;">
    <div class="container">
      ...
      <h1 style="color: #000;">${e?`Monthly retainer for ${e}`:"Your monthly retainer"}</h1>
            ...
            <div class="contact-methods">
              <a href="tel:+971502446531" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${u.phone}</svg>
                </div>
                <div>
              ...
              <a href="mailto:officialatlanticbear@gmail.com" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${u.mail}</svg>
                </div>
                <div>
              ...
              <a href="https://www.instagram.com/officialatlanticbear/" target="_blank" rel="noopener" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${u.instagram}</svg>
                </div>
                <div>
              ...
              <div class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${u.map}</svg>
                </div>
                <div>
  ...
  </div>`}function ee(t,e,a){const i=a.map(s=>`
    <section class="legal-block reveal">
      <h2>${s.h}</h2>
      ${s.p.map(o=>`<p>${o}</p>`).join("")}
    </section>`).join("");return`
  <div class="page-header" style="border-bottom:1px solid var(--border);">
    <div class="container">
  ...
  <section class="faq-section">
    ...
    <div class="faq-list reveal">${te.map(e=>`
  ...
  </section>`}function ae(t){const e=t==="launch",a=e?"AED 3,500":"AED 6,500",i="AED 300",s=e?"AED 1,750":"AED 3,250",o=e?"Launch Plan":"Growth Plan",r=e?"What's Included in the Launch Plan":"What's Included in the Growth Plan",v=e?["Up to 5 pages","Custom design, no templates","WhatsApp button, click-to-call","Mobile responsive"]:["Up to 15 pages","Photos and video","Custom design, no templates","Contact form","Mobile responsive"],l=e?["Written to rank on Google","Page titles and meta descriptions","SEO-ready structure"]:["Written to rank on Google","Targeting your service keywords","Blog SEO structure"],h=["Fully managed","Daily backups"],p=e?"1":"2",w=e?"One revision session per month. Book time with us, tell us what to change, we handle it.":"Two revision sessions per month. Book time with us, tell us what to change, we handle it.";function f(m){return m.map(k=>`<span class="sp-pill">${k}</span>`).join("")}return`
  <div class="sp-wrap">
    <!-- HEADER -->
    <div class="sp-header">
    ...
    <div class="sp-pillars">
      ...
      <div class="sp-pillar">
        ...
        <div class="sp-pillar-content">
          ...
          <div class="sp-pills"><span class="sp-pill sp-pill-accent">${p} session revision${e?"":"s"}/month</span></div>
        </div>
      </div>
    ...
    <div class="sp-investment">
      ...
      <div class="sp-inv-total">${a}<span class="sp-inv-mo"> + ${i}/mo</span></div>
      <div class="sp-inv-split">
        ...
        <div class="sp-inv-row sp-inv-row-monthly">
          ...
          <strong>${i}/month</strong>
        </div>
      </div>
      <p class="sp-inv-note">No contracts. You own everything. Cancel the monthly anytime.</p>
    </div>
  </div>`}function Me(){return ae("launch")}function Oe(){return ae("growth")}const se={home:ke,pricing:Te,contact:Le,testimonials:Be,booking:qe,booked:De,"meta-ads":xe,"meta-ads-shazay":Ee,payment:Ce,terms:Ie,privacy:Pe,launch:Me,growth:Oe},G={home:{title:"Website Design Agency in Dubai, UAE | Atlantic Bear",desc:"Custom website design agency in Dubai, UAE. We build professional, conversion-focused websites for serious UAE business owners. Live in 5 days, fully managed."},pricing:{title:"Website Design Pricing in Dubai & UAE | Atlantic Bear",desc:"Transparent pricing for custom website design in Dubai and the UAE. Fully managed, no contracts, live in 5 days. Plans from AED 3,500 setup + AED 300/mo."},contact:{title:"Contact a Dubai Website Design Agency | Atlantic Bear",desc:"Get in touch with Atlantic Bear, a custom website design agency based in Dubai. Fast response, usually within a few hours. Start your UAE website project today."},testimonials:{title:"Client Reviews & Website Transformations | Atlantic Bear Dubai",desc:"See real client results from Atlantic Bear. Before and after website case studies for businesses in the UAE and UK. Watch client video testimonials."},booking:{title:"Book a Free Call | Website Agency Dubai | Atlantic Bear",desc:"Book a free 30-minute strategy call with Atlantic Bear, a website design agency in Dubai. Watch our overview video and schedule your slot."},booked:{title:"Call Confirmed | Atlantic Bear",desc:"Your call is locked in. Add the event to your calendar and watch the pre-call video before our session."},"meta-ads":{title:"Facebook & Instagram Ads Dubai, UAE | Atlantic Bear",desc:"Run targeted Facebook and Instagram ad campaigns in Dubai and the UAE with Atlantic Bear. Local targeting, ad creatives, and direct WhatsApp leads. AED 2,500/mo."},"meta-ads-shazay":{title:"TikTok Ads Retainer Payment | Atlantic Bear",desc:"Set up your Atlantic Bear TikTok Ads retainer subscription, billed every 15 days."},payment:{title:"Monthly Retainer Payment | Atlantic Bear",desc:"Set up your Atlantic Bear monthly retainer subscription."},terms:{title:"Terms & Conditions | Atlantic Bear Website Agency Dubai",desc:"The terms covering Atlantic Bear website design, development, hosting, and maintenance services for businesses in Dubai and the UAE."},privacy:{title:"Privacy Policy | Atlantic Bear Website Agency Dubai",desc:"How Atlantic Bear collects, uses, stores, and protects the personal information you share through our website."},launch:{title:"The Launch Plan | Atlantic Bear",desc:"Atlantic Bear Launch Plan, internal sales presentation."},growth:{title:"The Growth Plan | Atlantic Bear",desc:"Atlantic Bear Growth Plan, internal sales presentation."}};function $e(t){const e=document.getElementById("faq-schema");if(e&&e.remove(),t!=="contact")return;const a=document.createElement("script");a.type="application/ld+json",a.id="faq-schema",a.textContent=JSON.stringify({"@context":"https://schema.org","@type":"FAQPage",mainEntity:te.map(i=>({"@type":"Question",name:i.q,acceptedAnswer:{"@type":"Answer",text:i.a}}))}),document.head.appendChild(a)}const Ue=["meta-ads-shazay","payment"];function ze(t){const e=G[t]||G.home;document.title=e.title,$e(t);let a=document.querySelector('meta[name="robots"]');Ue.includes(t)?(a||(a=document.createElement("meta"),a.setAttribute("name","robots"),document.head.appendChild(a)),a.setAttribute("content","noindex, nofollow")):a&&a.remove();let i=document.querySelector('meta[name="description"]');i||(i=document.createElement("meta"),i.setAttribute("name","description"),document.head.appendChild(i)),i.setAttribute("content",e.desc);let s=document.querySelector('link[rel="canonical"]');s||(s=document.createElement("link"),s.setAttribute("rel","canonical"),document.head.appendChild(s));const o=`${window.location.origin}${t==="home"?"":"/"+t}`;s.setAttribute("href",o);const r={"og:title":e.title,"og:description":e.desc,"og:url":o,"og:type":"website","og:image":`${window.location.origin}${j.site.ogImage}`};for(const[l,h]of Object.entries(r)){let p=document.querySelector(`meta[property="${l}"]`);p||(p=document.createElement("meta"),p.setAttribute("property",l),document.head.appendChild(p)),p.setAttribute("content",h)}const v={"twitter:card":"summary_large_image","twitter:title":e.title,"twitter:description":e.desc,"twitter:image":`${window.location.origin}${j.site.ogImage}`};for(const[l,h]of Object.entries(v)){let p=document.querySelector(`meta[name="${l}"]`);p||(p=document.createElement("meta"),p.setAttribute("name",l),document.head.appendChild(p)),p.setAttribute("content",h)}}const Fe=["/blog"];function ie(t){return Fe.some(e=>t===e||t.startsWith(e+"/"))}function V(t){const e=t.replace(/^\/|\/$/g,"");return e==="payment"||e.startsWith("payment-")?"payment":e==="pricing"||e==="work"||e==="contact"||e==="testimonials"||e==="booking"||e==="booking-new"||e==="meta-ads"||e==="meta-ads-shazay"||e==="booked"||e==="terms"||e==="privacy"||e==="launch"||e==="growth"?e:"home"}function Re(t){z("#main-nav [data-link]").forEach(a=>a.classList.remove("active"));const e=U(`#main-nav [data-link="${t}"].nav-link`);e&&e.classList.add("active")}const Ye=[".section-title",".section-sub",".facts-headline",".fact-hero-block",".facts-stat-block",".basic-system-card",".step",".feature-item",".teaser-card",".tier-card",".level-one-card",".pricing-plan-card",".guarantee-card",".pricing-bonus-block",".problem-card",".contact-method",".cc-copy",".cc-visual",".reviews-head",".competitor-banner-text",".meta-ads-teaser-box"].join(",");function Ne(){Array.from(document.querySelectorAll(Ye)).forEach(e=>{if(e.classList.contains("reveal")||e.classList.contains("revealed"))return;e.classList.add("reveal");const a=e.parentElement;if(!a)return;const s=Array.from(a.children).filter(o=>o.classList.contains("reveal")).indexOf(e);s>0&&!e.style.transitionDelay&&(e.style.transitionDelay=`${Math.min(s*.07,.35)}s`)})}function _e(){const t=z(".reveal"),e=new IntersectionObserver(a=>{a.forEach(i=>{i.isIntersecting&&(i.target.classList.add("revealed"),e.unobserve(i.target))})},{threshold:.07,rootMargin:"0px 0px -30px 0px"});t.forEach(a=>e.observe(a))}function je(t){const e=t.innerHTML,a=(t.textContent||"").trim();if(!a)return;t.textContent="",t.classList.add("is-typing");let i=0;const s=()=>{i+=1,t.textContent=a.slice(0,i),i<a.length?window.setTimeout(s,105):(t.innerHTML=e,t.classList.remove("is-typing"))};window.setTimeout(s,90)}function He(){const t=z(".fact-hero-num, .facts-stat-num");if(!t.length||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;t.forEach(a=>{a.style.minHeight=`${a.getBoundingClientRect().height}px`});const e=new IntersectionObserver(a=>{a.forEach((i,s)=>{if(!i.isIntersecting)return;const o=i.target;e.unobserve(o),window.setTimeout(()=>je(o),s*150)})},{threshold:.4});t.forEach(a=>e.observe(a))}function oe(t="P-3J276348CL7673454NKNKCRA",e="paypal-shazay-success"){const a="#paypal-button-container-"+t,i="https://www.paypal.com/sdk/js?client-id=BAAeLN9PQY_40P1TyOqzvSGlsxkJvgSNc84tV2boPr7iX-TUntDkuIFWfjw3zc3V8zc13VS2nx64j-E710&vault=true&intent=subscription";function s(){const v=window.paypal,l=document.querySelector(a);!v||!l||l.dataset.rendered==="1"||(l.dataset.rendered="1",v.Buttons({style:{shape:"rect",color:"blue",layout:"vertical",label:"subscribe"},createSubscription:function(h,p){return p.subscription.create({plan_id:t})},onApprove:function(){const h=document.getElementById(e);h&&(h.style.display="block"),l.style.display="none"}}).render(a))}if(window.paypal){s();return}const o=document.getElementById("paypal-sdk-subscription");if(o){o.addEventListener("load",s,{once:!0});return}const r=document.createElement("script");r.id="paypal-sdk-subscription",r.src=i,r.setAttribute("data-sdk-integration-source","button-factory"),r.onload=s,document.body.appendChild(r)}function Ge(){oe(Z(),"payment-success")}function ne(t){window.getComputedStyle(t).position==="static"&&(t.style.position="relative");const a=document.createElement("div");a.className="calendly-spinner-wrap",a.style.display="flex",a.style.justifyContent="center",a.style.alignItems="center",a.style.position="absolute",a.style.top="50%",a.style.left="50%",a.style.transform="translate(-50%, -50%)",a.style.pointerEvents="none",a.style.zIndex="1",a.innerHTML=`
  ...
  `,t.appendChild(a);const i=new MutationObserver(()=>{const s=t.querySelector("iframe");s&&(s.style.position="relative",s.style.zIndex="2",s.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),i.disconnect())});i.observe(t,{childList:!0})}function Ve(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),i=e.querySelector("video");a&&i&&a.addEventListener("click",s=>{s.stopPropagation(),i.muted=!1,i.currentTime=0,i.controls=!0,a.style.display="none",i.play().catch(o=>{console.error("Play failed:",o)})})})}function Ke(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",ne(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const i=document.createElement("script");i.id="calendly-sdk",i.src="https://assets.calendly.com/assets/external/widget.js",i.async=!0,i.addEventListener("load",e,{once:!0}),document.head.appendChild(i)}}function Qe(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),i=document.getElementById("bv-play-btn"),s=document.getElementById("bv-controls"),o=document.getElementById("bv-playpause"),r=document.getElementById("bv-progress-fill"),v=document.getElementById("bv-progress-thumb"),l=document.getElementById("bv-progress-wrap"),h=document.getElementById("bv-time"),p=document.getElementById("bv-mute"),w=document.getElementById("bv-volume"),f=document.getElementById("bv-fullscreen"),m=document.getElementById("custom-video-wrap");if(!e||!a||!i||!s||!o)return;e.volume=.9;let k=null,L=null;const I=()=>{try{const n=window.AudioContext||window.webkitAudioContext;if(!n)return;if(!k){k=new n;const c=k.createMediaElementSource(e);L=k.createGain(),L.gain.value=2,c.connect(L),L.connect(k.destination)}k.state==="suspended"&&k.resume()}catch(n){console.warn("AudioContext boost failed:",n)}},F=e.getAttribute("data-src"),q=()=>{F&&!e.getAttribute("src")&&(e.setAttribute("src",F),e.load())};let y=!0;const re=5,le=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{y&&e.currentTime>=re&&(e.currentTime=0)}),setTimeout(le,800);const R=n=>{const c=Math.floor(n/60),d=Math.floor(n%60);return`${c}:${d.toString().padStart(2,"0")}`},x=90,E=60,ce=(n,c)=>!t||c<=x?n/c*100:n<=x?n/x*E:E+(n-x)/(c-x)*(100-E),de=(n,c)=>!t||c<=x?n/100*c:n<=E?n/E*x:x+(n-E)/(100-E)*(c-x),D=()=>{if(!e.duration)return;const n=ce(e.currentTime,e.duration);r&&(r.style.width=n+"%"),v&&(v.style.left=n+"%"),h&&(h.textContent=`${R(e.currentTime)} / ${R(e.duration)}`)},T=n=>{const c=o==null?void 0:o.querySelector(".icon-play"),d=o==null?void 0:o.querySelector(".icon-pause");c&&(c.style.display=n&&!y?"none":"block"),d&&(d.style.display=n&&!y?"block":"none"),a&&(a.style.display=n&&!y?"none":"flex"),m&&(n&&!y?m.classList.add("playing"):m.classList.remove("playing"))};a.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const n=e.src.split("#")[0];e.src!==n&&(e.src=n,e.load()),e.currentTime=0}q(),I(),T(!0),e.play()}),e.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const n=e.src.split("#")[0];e.src!==n&&(e.src=n,e.load()),e.currentTime=0,I(),T(!0),e.play();return}q(),I(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>T(!0)),e.addEventListener("pause",()=>T(!1)),e.addEventListener("ended",()=>T(!1)),e.addEventListener("timeupdate",D),e.addEventListener("loadedmetadata",D);let Y=!1,N=!1;const b={m25:!1,m50:!1,m75:!1,m95:!1,m100:!1},_={};if(e.addEventListener("play",()=>{!N&&!y&&(N=!0,typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","VSL_Play"))}),e.addEventListener("timeupdate",()=>{const n=e.duration;if(!n)return;const c=e.currentTime,d=c/n*100;if(!Y&&c>.5&&!y&&(Y=!0,g("videoplay")),y)return;d>=25&&!b.m25&&(b.m25=!0,g("videowatch_25pct"),typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","VSL_25")),d>=50&&!b.m50&&(b.m50=!0,g("videowatch_50pct"),typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","VSL_50")),d>=75&&!b.m75&&(b.m75=!0,g("videowatch_75pct"),typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","VSL_75")),d>=95&&!b.m95&&(b.m95=!0,typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","VSL_95")),d>=98&&!b.m100&&(b.m100=!0,g("videowatch_complete"));const P=[10,30],M=Math.floor(c);P.forEach(S=>{M>=S&&!_[S]&&(_[S]=!0,g(`videowatch_${S}s`))})}),o.addEventListener("click",()=>{q(),I(),e.paused?e.play():e.pause()}),l){const n=d=>{const P=l.getBoundingClientRect(),M=d instanceof MouseEvent?d.clientX:d.touches[0].clientX,S=Math.max(0,Math.min(100,(M-P.left)/P.width*100));e.currentTime=de(S,e.duration),D()};let c=!1;l.addEventListener("mousedown",d=>{c=!0,n(d)}),window.addEventListener("mousemove",d=>{c&&n(d)}),window.addEventListener("mouseup",()=>{c=!1}),l.addEventListener("touchstart",d=>n(d),{passive:!0}),l.addEventListener("touchmove",d=>n(d),{passive:!0})}if(w&&w.addEventListener("input",()=>{e.volume=parseFloat(w.value),e.muted=e.volume===0}),p&&p.addEventListener("click",()=>{e.muted=!e.muted,w&&(w.value=e.muted?"0":String(e.volume||1))}),f&&m&&f.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():m.requestFullscreen?m.requestFullscreen():m.webkitRequestFullscreen?m.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),m){let n;const c=()=>{s.style.opacity="1",clearTimeout(n),n=window.setTimeout(()=>{e.paused||(s.style.opacity="0")},2500)};m.addEventListener("mousemove",c),m.addEventListener("mouseenter",c),m.addEventListener("mouseleave",()=>{e.paused||(s.style.opacity="0")}),e.addEventListener("play",()=>{n=window.setTimeout(()=>{s.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{s.style.opacity="1",clearTimeout(n)})}}function Xe(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);const a=()=>{const o=document.getElementById("strat-modal-calendly-container");if(!o)return;const r="https://calendly.com/officialatlanticbear/strategy-call?hide_gdpr_banner=1&primary_color=3b69ff";o.innerHTML="",ne(o);const v=()=>window.Calendly.initInlineWidget({url:r,parentElement:o});if(window.Calendly)v();else{const l=document.getElementById("calendly-sdk");l&&l.addEventListener("load",v,{once:!0})}},i=()=>{t.classList.add("active"),document.body.style.overflow="hidden",a()},s=()=>{t.classList.remove("active"),document.body.style.overflow=""};e.addEventListener("click",s),window.addEventListener("keydown",o=>{o.key==="Escape"&&t.classList.contains("active")&&s()}),window.openStratBookingModal=i}const K=["home","pricing","testimonials","meta-ads","contact","booking","booked"];let O=null;function W(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const i=document.getElementById("strat-booking-modal");i&&i.remove(),document.body.style.overflow="",Q(),X();const s=document.getElementById("main-nav"),o=document.querySelector(".site-footer");t==="booking"?(s&&(s.style.display="none"),o&&(o.style.display="none")):(s&&(s.style.display=""),o&&(o.style.display=""));const r=U("#main-content"),v=O?K.indexOf(O):-1,l=K.indexOf(t),h=v===-1||l>=v,p=h?"-8%":"8%",w=h?"8%":"-8%";O=t;const f=window.matchMedia("(prefers-reduced-motion: reduce)").matches;r.style.transition=f?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",r.style.opacity="0",f||(r.style.transform=`translateX(${p})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),r.style.transition="none",f||(r.style.transform=`translateX(${w})`),r.innerHTML=se[t](),Re(t),requestAnimationFrame(()=>{r.style.transition=f?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",r.style.opacity="1",r.style.transform="translateX(0)"}),Ne(),_e(),He(),t==="meta-ads-shazay"&&oe(),t==="payment"&&Ge(),(t==="booking"||t==="booked")&&(g("pageload",2e3),pe(),he(),Ke(),Qe(t==="booking"),t==="booking"&&(Xe(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(m=>{m.addEventListener("click",()=>{typeof window.fbq=="function"&&!C()&&window.fbq("trackCustom","BookButtonClick"),window.openStratBookingModal&&window.openStratBookingModal()})}))),ze(t),Ve(),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&window.fbq("track","PageView"),e){const m=t==="home"?"/":`/${t}`;window.location.pathname!==m&&history.pushState(null,"",m)}},260)}function Je(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;const i=a.getAttribute("href")||"";if(ie(i))return;e.preventDefault();const s=a.getAttribute("data-link");s&&se[s]&&W(s)})}function Ze(){const t=U("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}document.addEventListener("DOMContentLoaded",()=>{const t=new URLSearchParams(window.location.search);(t.get("notrack")==="1"||t.get("preview")==="true")&&sessionStorage.setItem("notrack","1");const e=t.get("fbclid"),a=(t.get("utm_source")||"").toLowerCase();(!!e||["facebook","instagram","fb","meta"].some(r=>a.includes(r)))&&sessionStorage.setItem("came_from_meta","1");const s=document.getElementById("app");if(s.innerHTML=`
    ${ve()}
  ...
  `,Je(s),Ze(),window.addEventListener("message",r=>{if(!r.origin||!r.origin.includes("calendly.com"))return;let v=!1;if(r&&r.data){let l=r.data;if(typeof l=="string")try{l=JSON.parse(l)}catch{}typeof l=="object"&&l&&l.event==="calendly.event_scheduled"&&(v=!0)}if(v){const l=document.getElementById("strat-booking-modal"),h=document.getElementById("booking-modal");l&&l.classList.contains("active")?(g("bookedcall_strategy"),typeof window.fbq=="function"&&sessionStorage.getItem("came_from_meta")&&!sessionStorage.getItem("fbq_schedule_fired")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1")),l&&l.classList.remove("active")):(g("bookedcall"),h&&h.classList.remove("active")),document.body.style.overflow="",W("booked")}}),ie(window.location.pathname)){if(!sessionStorage.getItem("static_route_reload")){sessionStorage.setItem("static_route_reload","1"),window.location.reload();return}}else sessionStorage.removeItem("static_route_reload");const o=V(window.location.pathname);W(o,!1),window.addEventListener("popstate",()=>{const r=V(window.location.pathname);W(r,!1)})});
