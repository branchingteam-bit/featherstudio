(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const me={ogImage:"/og-image.png"},J={site:me},K=(t,e=document)=>e.querySelector(t),Q=(t,e=document)=>[...e.querySelectorAll(t)],X="atlanticbear_analytics_8d24";function R(){if(sessionStorage.getItem("notrack"))return!0;try{if(new URLSearchParams(window.location.search).get("preview")==="true")return!0}catch{}return!1}function E(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${X}/${t}`).catch(()=>{});try{const s=fe();fetch(`https://abacus.jasoncameron.dev/hit/${X}/${s}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}const se=window.RECAPTCHA_SITE_KEY||"6Ldfp-gqAAAAABpP_placeholder_key";function oe(){const t=window.RECAPTCHA_SITE_KEY||se;if(document.getElementById("recaptcha-v3-script"))return;const e=document.createElement("script");e.id="recaptcha-v3-script",e.src=`https://www.google.com/recaptcha/api.js?render=${encodeURIComponent(t)}`,e.async=!0,e.defer=!0,document.head.appendChild(e)}async function ie(t){const e=window.RECAPTCHA_SITE_KEY||se;return oe(),new Promise(a=>{const s=setTimeout(()=>{console.warn(`reCAPTCHA [${t}] timed out. Continuing submission.`),a(null)},2500),o=window.grecaptcha;if(o&&typeof o.ready=="function")try{o.ready(()=>{o.execute(e,{action:t}).then(n=>{clearTimeout(s),a(n)}).catch(n=>{clearTimeout(s),console.warn(`reCAPTCHA [${t}] execution error:`,n),a(null)})})}catch(n){clearTimeout(s),console.warn(`reCAPTCHA [${t}] error:`,n),a(null)}else clearTimeout(s),a(null)})}let V={};function ve(){ne();const t=e=>{V[`t${e}`]=window.setTimeout(()=>{E(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function ne(){Object.values(V).forEach(clearTimeout),V={}}let q={moved:!1,calendar:!1,testimonials:!1},N=null;function ge(){re(),q={moved:!1,video:!1,calendar:!1,testimonials:!1},N=()=>{window.scrollY>50&&!q.moved&&(q.moved=!0,E("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!q.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(q.calendar=!0,E("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!q.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(q.testimonials=!0,E("scroll_testimonials"))},window.addEventListener("scroll",N,{passive:!0})}function re(){N&&(window.removeEventListener("scroll",N),N=null)}function fe(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}const h={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function ye(){return`
  <nav class="nav" id="main-nav">
    ...
    <div class="nav-actions">
      <a href="/booking" class="btn btn-primary btn-sm btn-pulse" data-link="booking" id="nav-book-cta">Book a Call ${h.arrow}</a>
    </div>
  </nav>`}function be(){return`
  ...
  <section class="cc-section">
    <div class="container">
      <div class="cc-grid">
        ...
        <div class="cc-copy reveal">
          <span class="cc-badge">${h.code} How we build</span>
  ...
  </section>`}const Y={quote:"We approached Alexi at Atlantic Bear, who was absolutely fantastic at putting together our ideas and bringing them across on the website in a way that really engaged our target market.",name:"Sonder Training Group",role:"Training Provider, UAE",avatar:0},O=[{quote:"Five days from the first call to a live site. I had budgeted two months, and half of that for arguing about revisions.",name:"Tom Whitfield",role:"Founder, Dental Clinic",avatar:1},{quote:"We now come up first for our category in Dubai. Enquiries through the site have roughly tripled since launch.",name:"Priya Nair",role:"Director, Facilities Services",avatar:2},{quote:"They asked good questions, then just built it. I approved two rounds of small tweaks and that was the whole process.",name:"Marcus Oyelaran",role:"Manager, Hospitality Group",avatar:3},{quote:"Most of our customers are on their phones and the old site was unusable there. The new one loads instantly.",name:"Yasmin Farouk",role:"Owner, Fitness Studio",avatar:4},{quote:"Handover was clean. Domain, hosting, files, all in our name from day one, exactly as they promised.",name:"Lena Vasquez",role:"Founder, E-commerce",avatar:5}],ke=[[Y,O[0],O[1]],[O[2],Y,O[3]],[O[4],Y,O[0]]],Z=[{bg:"#3b69ff",fg:"#dfe8ff"},{bg:"#1e46c7",fg:"#d5e0ff"},{bg:"#6391ff",fg:"#eef3ff"},{bg:"#2a50e0",fg:"#dbe5ff"},{bg:"#142d80",fg:"#ccd9ff"},{bg:"#4a80ff",fg:"#e7eeff"},{bg:"#27418f",fg:"#d2ddff"},{bg:"#5b7cff",fg:"#e9efff"},{bg:"#1a3fb5",fg:"#d8e2ff"}];function Ee(t,e){const a=Z[e%Z.length],s=7.2+e%3*.5,o=14.5+e%4*.8,n=19.5-e%3*.3;return`
    <span class="review-avatar-wrap">
      <svg class="review-avatar" viewBox="0 0 48 48" role="img" aria-label="Avatar for ${t}">
        ...
        <circle cx="24" cy="${n}" r="${s}" fill="${a.fg}" />
    ...
    </article>`}function Ae(){const t=ke.map((e,a)=>{const s=e.map(xe).join("");return`
    ...
    <div class="container">
      ...
      <div class="reveal" style="text-align: center; margin-top: 48px;">
        <a href="/booking" class="btn btn-primary btn-large btn-pulse" data-link="booking">
          Get Started with Market Leader ${h.arrow}
        </a>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="feature-grid">
        ...
        <div class="feature-item reveal" style="display:flex; flex-direction:column; justify-content:center; background:var(--surface);">
          ...
          <a href="/booking" class="btn btn-primary btn-sm" data-link="booking" style="align-self:flex-start;">Book a Call ${h.arrow}</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="feature-grid" style="grid-template-columns: repeat(2, 1fr); max-width: 900px; margin: 0 auto;">
        <div class="feature-item reveal" style="border-right: 1px solid var(--border); border-bottom: 1px solid var(--border);">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${h.zap}</div>
        ...
        <div class="feature-item reveal" style="border-right: none; border-bottom: 1px solid var(--border);">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${h.star}</div>
        ...
        <div class="feature-item reveal" style="border-right: 1px solid var(--border); border-bottom: none;">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${h.phone}</div>
        ...
        <div class="feature-item reveal" style="border-right: none; border-bottom: none;">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${h.rocket}</div>
    ...
    <div class="container">
      ...
      <div class="case-study reveal" style="transition-delay:0.12s;">
        ...
        <aside class="case-study-side">
          ...
          <a href="https://sondertraininggroup.com/" target="_blank" rel="noopener" class="btn btn-secondary btn-sm case-study-link">Visit the live site ${h.arrow}</a>
        </aside>
      </div>
            ...
            <div class="contact-methods">
              <a href="tel:+971502446531" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${h.phone}</svg>
                </div>
                <div>
  ...
  </div>`}function le(t,e,a){const s=a.map(o=>`
    <section class="legal-block reveal">
      <h2>${o.h}</h2>
      ${o.p.map(n=>`<p>${n}</p>`).join("")}
    </section>`).join("");return`
  <div class="page-header" style="border-bottom:1px solid var(--border);">
    <div class="container">
  ...
  </section>`}function de(t){const e=t==="launch",a=e?"AED 3,500":"AED 6,500",s="AED 300",o=e?"AED 1,750":"AED 3,250",n=e?"Launch Plan":"Growth Plan",c=e?"What's Included in the Launch Plan":"What's Included in the Growth Plan",v=e?["Up to 5 pages","Custom design, no templates","WhatsApp button, click-to-call","Mobile responsive"]:["Up to 15 pages","Photos and video","Custom design, no templates","Contact form","Mobile responsive"],p=e?["Written to rank on Google","Page titles and meta descriptions","SEO-ready structure"]:["Written to rank on Google","Targeting your service keywords","Blog SEO structure"],m=["Fully managed","Daily backups"],T=e?"1":"2",C=e?"One revision session per month. Book time with us, tell us what to change, we handle it.":"Two revision sessions per month. Book time with us, tell us what to change, we handle it.";function y(u){return u.map(k=>`<span class="sp-pill">${k}</span>`).join("")}return`
  <div class="sp-wrap">
    <!-- HEADER -->
    <div class="sp-header">
      ...
      <p class="sp-label">Atlantic Bear, ${n}</p>
      <h1 class="sp-title">${c}</h1>
    ...
    <div class="sp-pillars">
      ...
      <div class="sp-pillar">
        ...
        <div class="sp-pillar-content">
          ...
          <p class="sp-pillar-desc">${C}</p>
          <div class="sp-pills"><span class="sp-pill sp-pill-accent">${T} session revision${e?"":"s"}/month</span></div>
        </div>
      </div>
  ...
  </div>`}function Ue(){return de("launch")}function Oe(){return de("growth")}const ue={home:Se,pricing:Le,contact:De,testimonials:Ie,booking:$e,booked:Me,"meta-ads":Te,terms:We,privacy:Pe,blog:Be,launch:Ue,growth:Oe},ee={home:{title:"Website Design Agency in Dubai, UAE | Atlantic Bear",desc:"Atlantic Bear is a custom website design agency in Dubai, UAE. We build premium websites for small businesses — live in 5 days, fully managed, no templates."},pricing:{title:"Website Design Pricing in Dubai & UAE | Atlantic Bear",desc:"Transparent pricing for custom website design in Dubai and the UAE. Fully managed, no contracts, live in 5 days. Plans from AED 3,500 setup + AED 300/mo."},contact:{title:"Contact a Dubai Website Design Agency | Atlantic Bear",desc:"Get in touch with Atlantic Bear — a custom website design agency based in Dubai. Fast response, usually within a few hours. Start your UAE website project today."},testimonials:{title:"Client Reviews & Website Transformations | Atlantic Bear Dubai",desc:"See real client results from Atlantic Bear. Before and after website case studies for businesses in the UAE and UK. Watch client video testimonials."},booking:{title:"Book a Free Call — Website Agency Dubai | Atlantic Bear",desc:"Book a free 30-minute strategy call with Atlantic Bear, a website design agency in Dubai. Watch our overview video and schedule your slot."},booked:{title:"Call Confirmed | Atlantic Bear",desc:"Your call is locked in. Add the event to your calendar and watch the pre-call video before our session."},"meta-ads":{title:"Facebook & Instagram Ads Dubai, UAE | Atlantic Bear",desc:"Run targeted Facebook and Instagram ad campaigns in Dubai and the UAE with Atlantic Bear. Local targeting, ad creatives, and direct WhatsApp leads. AED 2,500/mo."},terms:{title:"Terms & Conditions | Atlantic Bear Website Agency Dubai",desc:"The terms covering Atlantic Bear website design, development, hosting, and maintenance services for businesses in Dubai and the UAE."},privacy:{title:"Privacy Policy | Atlantic Bear Website Agency Dubai",desc:"How Atlantic Bear collects, uses, stores, and protects the personal information you share through our website."},blog:{title:"Blog — Website Design & SEO Tips for UAE Businesses | Atlantic Bear",desc:"Expert articles on website design, SEO, and digital marketing for small businesses in Dubai and the UAE. Written by the Atlantic Bear team."},launch:{title:"The Launch Plan | Atlantic Bear",desc:"Atlantic Bear Launch Plan — internal sales presentation."},growth:{title:"The Growth Plan | Atlantic Bear",desc:"Atlantic Bear Growth Plan — internal sales presentation."}};function Re(t){const e=document.getElementById("faq-schema");if(e&&e.remove(),t!=="contact")return;const a=document.createElement("script");a.type="application/ld+json",a.id="faq-schema",a.textContent=JSON.stringify({"@context":"https://schema.org","@type":"FAQPage",mainEntity:ce.map(s=>({"@type":"Question",name:s.q,acceptedAnswer:{"@type":"Answer",text:s.a}}))}),document.head.appendChild(a)}function Fe(t){const e=ee[t]||ee.home;document.title=e.title,Re(t);let a=document.querySelector('meta[name="description"]');a||(a=document.createElement("meta"),a.setAttribute("name","description"),document.head.appendChild(a)),a.setAttribute("content",e.desc);let s=document.querySelector('link[rel="canonical"]');s||(s=document.createElement("link"),s.setAttribute("rel","canonical"),document.head.appendChild(s));const o=`${window.location.origin}${t==="home"?"":"/"+t}`;s.setAttribute("href",o);const n={"og:title":e.title,"og:description":e.desc,"og:url":o,"og:type":"website","og:image":`${window.location.origin}${J.site.ogImage}`};for(const[v,p]of Object.entries(n)){let m=document.querySelector(`meta[property="${v}"]`);m||(m=document.createElement("meta"),m.setAttribute("property",v),document.head.appendChild(m)),m.setAttribute("content",p)}const c={"twitter:card":"summary_large_image","twitter:title":e.title,"twitter:description":e.desc,"twitter:image":`${window.location.origin}${J.site.ogImage}`};for(const[v,p]of Object.entries(c)){let m=document.querySelector(`meta[name="${v}"]`);m||(m=document.createElement("meta"),m.setAttribute("name",v),document.head.appendChild(m)),m.setAttribute("content",p)}}function te(t){const e=t.replace(/^\/|\/$/g,"");return e==="pricing"||e==="work"||e==="contact"||e==="testimonials"||e==="booking"||e==="booking-new"||e==="meta-ads"||e==="booked"||e==="terms"||e==="privacy"||e==="blog"||e==="launch"||e==="growth"?e:"home"}function ze(t){Q("#main-nav [data-link]").forEach(a=>a.classList.remove("active"));const e=K(`#main-nav [data-link="${t}"].nav-link`);e&&e.classList.add("active")}const Ne=[".section-title",".section-sub",".facts-headline",".fact-hero-block",".facts-stat-block",".basic-system-card",".step",".feature-item",".teaser-card",".tier-card",".level-one-card",".pricing-plan-card",".guarantee-card",".pricing-bonus-block",".problem-card",".contact-method",".contact-form-card",".cc-copy",".cc-visual",".reviews-head",".competitor-banner-text",".meta-ads-teaser-box"].join(",");function je(){Array.from(document.querySelectorAll(Ne)).forEach(e=>{if(e.classList.contains("reveal")||e.classList.contains("revealed"))return;e.classList.add("reveal");const a=e.parentElement;if(!a)return;const o=Array.from(a.children).filter(n=>n.classList.contains("reveal")).indexOf(e);o>0&&!e.style.transitionDelay&&(e.style.transitionDelay=`${Math.min(o*.07,.35)}s`)})}function _e(){const t=Q(".reveal"),e=new IntersectionObserver(a=>{a.forEach(s=>{s.isIntersecting&&(s.target.classList.add("revealed"),e.unobserve(s.target))})},{threshold:.07,rootMargin:"0px 0px -30px 0px"});t.forEach(a=>e.observe(a))}function He(t){const e=t.innerHTML,a=(t.textContent||"").trim();if(!a)return;t.textContent="",t.classList.add("is-typing");let s=0;const o=()=>{s+=1,t.textContent=a.slice(0,s),s<a.length?window.setTimeout(o,105):(t.innerHTML=e,t.classList.remove("is-typing"))};window.setTimeout(o,90)}function Ye(){const t=Q(".fact-hero-num, .facts-stat-num");if(!t.length||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;t.forEach(a=>{a.style.minHeight=`${a.getBoundingClientRect().height}px`});const e=new IntersectionObserver(a=>{a.forEach((s,o)=>{if(!s.isIntersecting)return;const n=s.target;e.unobserve(n),window.setTimeout(()=>He(n),o*150)})},{threshold:.4});t.forEach(a=>e.observe(a))}function Ge(){const t=document.getElementById("contact-form");if(!t)return;const e=document.createElement("script");e.src="https://unpkg.com/@formspree/ajax@1",e.defer=!0,document.head.appendChild(e),e.onload=()=>{window.formspree&&window.formspree("initForm",{formElement:"#contact-form",formId:"mykanvrr"})},t.addEventListener("submit",async a=>{a.preventDefault();const s=document.getElementById("form-submit-btn"),o=document.querySelector("[data-fs-success]"),n=document.querySelector('[data-fs-error]:not([data-fs-error="name"]):not([data-fs-error="email"]):not([data-fs-error="message"])');s&&(s.disabled=!0,s.textContent="Sending...");try{const c=await ie("contact_submit"),v=new FormData(t);if(c&&v.append("g-recaptcha-response",c),(await fetch("https://formspree.io/f/mykanvrr",{method:"POST",body:v,headers:{Accept:"application/json"}})).ok)t.style.display="none",o&&(o.style.display="block",o.style.textAlign="center",o.style.padding="18px",o.style.background="rgba(62,207,142,.07)",o.style.borderRadius="10px",o.style.border="1px solid rgba(62,207,142,.20)");else throw new Error("Server error")}catch{n&&(n.textContent="Something went wrong. Please try again or email officialatlanticbear@gmail.com.",n.style.color="var(--red)",n.style.fontSize="0.85rem",n.style.marginTop="8px"),s&&(s.disabled=!1,s.textContent="Try again")}})}function pe(t){window.getComputedStyle(t).position==="static"&&(t.style.position="relative");const a=document.createElement("div");a.className="calendly-spinner-wrap",a.style.display="flex",a.style.justifyContent="center",a.style.alignItems="center",a.style.position="absolute",a.style.top="50%",a.style.left="50%",a.style.transform="translate(-50%, -50%)",a.style.pointerEvents="none",a.style.zIndex="1",a.innerHTML=`
  ...
  `,t.appendChild(a);const s=new MutationObserver(()=>{const o=t.querySelector("iframe");o&&(o.style.position="relative",o.style.zIndex="2",o.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),s.disconnect())});s.observe(t,{childList:!0})}function Ve(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),s=e.querySelector("video");a&&s&&a.addEventListener("click",o=>{o.stopPropagation(),s.muted=!1,s.currentTime=0,s.controls=!0,a.style.display="none",s.play().catch(n=>{console.error("Play failed:",n)})})})}function Ke(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",pe(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const s=document.createElement("script");s.id="calendly-sdk",s.src="https://assets.calendly.com/assets/external/widget.js",s.async=!0,s.addEventListener("load",e,{once:!0}),document.head.appendChild(s)}}function Qe(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),s=document.getElementById("bv-play-btn"),o=document.getElementById("bv-controls"),n=document.getElementById("bv-playpause"),c=document.getElementById("bv-progress-fill"),v=document.getElementById("bv-progress-thumb"),p=document.getElementById("bv-progress-wrap"),m=document.getElementById("bv-time"),T=document.getElementById("bv-mute"),C=document.getElementById("bv-volume"),y=document.getElementById("bv-fullscreen"),u=document.getElementById("custom-video-wrap");if(!e||!a||!s||!o||!n)return;e.volume=.9;let k=null,B=null;const S=()=>{try{const i=window.AudioContext||window.webkitAudioContext;if(!i)return;if(!k){k=new i;const r=k.createMediaElementSource(e);B=k.createGain(),B.gain.value=2,r.connect(B),B.connect(k.destination)}k.state==="suspended"&&k.resume()}catch(i){console.warn("AudioContext boost failed:",i)}},I=e.getAttribute("data-src"),$=()=>{I&&!e.getAttribute("src")&&(e.setAttribute("src",I),e.load())};let b=!0;const M=5,U=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{b&&e.currentTime>=M&&(e.currentTime=0)}),setTimeout(U,800);const D=i=>{const r=Math.floor(i/60),d=Math.floor(i%60);return`${r}:${d.toString().padStart(2,"0")}`},x=90,L=60,F=(i,r)=>!t||r<=x?i/r*100:i<=x?i/x*L:L+(i-x)/(r-x)*(100-L),H=(i,r)=>!t||r<=x?i/100*r:i<=L?i/L*x:x+(i-L)/(100-L)*(r-x),z=()=>{if(!e.duration)return;const i=F(e.currentTime,e.duration);c&&(c.style.width=i+"%"),v&&(v.style.left=i+"%"),m&&(m.textContent=`${D(e.currentTime)} / ${D(e.duration)}`)},W=i=>{const r=n==null?void 0:n.querySelector(".icon-play"),d=n==null?void 0:n.querySelector(".icon-pause");r&&(r.style.display=i&&!b?"none":"block"),d&&(d.style.display=i&&!b?"block":"none"),a&&(a.style.display=i&&!b?"none":"flex"),u&&(i&&!b?u.classList.add("playing"):u.classList.remove("playing"))};a.addEventListener("click",()=>{if(b){b=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0}$(),S(),W(!0),e.play()}),e.addEventListener("click",()=>{if(b){b=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0,S(),W(!0),e.play();return}$(),S(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>W(!0)),e.addEventListener("pause",()=>W(!1)),e.addEventListener("ended",()=>W(!1)),e.addEventListener("timeupdate",z),e.addEventListener("loadedmetadata",z);let P=!1,_=!1;const l={m25:!1,m50:!1,m75:!1,m95:!1,m100:!1},g={};if(e.addEventListener("play",()=>{!_&&!b&&(_=!0,typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","VSL_Play"))}),e.addEventListener("timeupdate",()=>{const i=e.duration;if(!i)return;const r=e.currentTime,d=r/i*100;if(!P&&r>.5&&!b&&(P=!0,E("videoplay")),b)return;d>=25&&!l.m25&&(l.m25=!0,E("videowatch_25pct"),typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","VSL_25")),d>=50&&!l.m50&&(l.m50=!0,E("videowatch_50pct"),typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","VSL_50")),d>=75&&!l.m75&&(l.m75=!0,E("videowatch_75pct"),typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","VSL_75")),d>=95&&!l.m95&&(l.m95=!0,typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","VSL_95")),d>=98&&!l.m100&&(l.m100=!0,E("videowatch_complete"));const A=[10,30],w=Math.floor(r);A.forEach(f=>{w>=f&&!g[f]&&(g[f]=!0,E(`videowatch_${f}s`))})}),n.addEventListener("click",()=>{$(),S(),e.paused?e.play():e.pause()}),p){const i=d=>{const A=p.getBoundingClientRect(),w=d instanceof MouseEvent?d.clientX:d.touches[0].clientX,f=Math.max(0,Math.min(100,(w-A.left)/A.width*100));e.currentTime=H(f,e.duration),z()};let r=!1;p.addEventListener("mousedown",d=>{r=!0,i(d)}),window.addEventListener("mousemove",d=>{r&&i(d)}),window.addEventListener("mouseup",()=>{r=!1}),p.addEventListener("touchstart",d=>i(d),{passive:!0}),p.addEventListener("touchmove",d=>i(d),{passive:!0})}if(C&&C.addEventListener("input",()=>{e.volume=parseFloat(C.value),e.muted=e.volume===0}),T&&T.addEventListener("click",()=>{e.muted=!e.muted,C&&(C.value=e.muted?"0":String(e.volume||1))}),y&&u&&y.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():u.requestFullscreen?u.requestFullscreen():u.webkitRequestFullscreen?u.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),u){let i;const r=()=>{o.style.opacity="1",clearTimeout(i),i=window.setTimeout(()=>{e.paused||(o.style.opacity="0")},2500)};u.addEventListener("mousemove",r),u.addEventListener("mouseenter",r),u.addEventListener("mouseleave",()=>{e.paused||(o.style.opacity="0")}),e.addEventListener("play",()=>{i=window.setTimeout(()=>{o.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{o.style.opacity="1",clearTimeout(i)})}}let he=!0;function Je(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn"),a=document.getElementById("strat-modal-step-1"),s=document.getElementById("strat-modal-step-2"),o=document.getElementById("strat-modal-step-3"),n=document.getElementById("strat-modal-step-4"),c=document.getElementById("strat-modal-step-num"),v=document.getElementById("strat-modal-step-title"),p=document.getElementById("strat-modal-step-badge"),m=document.getElementById("strat-modal-progress-bar"),T=document.getElementById("strat-modal-step1-form"),C=document.getElementById("strat-modal-step2-form"),y=document.getElementById("strat-input-name"),u=document.getElementById("strat-input-phone"),k=document.getElementById("strat-input-business"),B=document.getElementById("strat-select-revenue"),S=document.getElementById("strat-modal-step1-error"),I=document.getElementById("strat-modal-step2-error"),$=document.getElementById("strat-modal-confirm-pricing-link");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);let b="",M="",U="",D="";const x={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},L=document.getElementById("strat-phone-flag-prefix"),F=()=>{if(!L||!u)return;const l=u.value.trim();let g="🇦🇪";for(const[i,r]of Object.entries(x))if(l.startsWith(i)){g=r;break}L.textContent=g},H=()=>{if(!u)return;let l=u.value,g="";for(const w of Object.keys(x))if(l.startsWith(w)){g=w+" ";break}if(!g&&l.startsWith("+")){const w=l.indexOf(" ");if(w>0)g=l.substring(0,w+1);else{const f=l.match(/^\+\d+/);f&&(g=f[0]+" ")}}const r=l.substring(g.length).replace(/\D/g,"").substring(0,9);let d="";r.length>0&&(r.length<=2?d=r:r.length<=5?d=`${r.substring(0,2)} ${r.substring(2)}`:d=`${r.substring(0,2)} ${r.substring(2,5)} ${r.substring(5)}`);const A=g+d;u.value!==A&&(u.value=A)};u&&(u.addEventListener("input",l=>{const g=l;if(g.inputType&&g.inputType.startsWith("delete")){F();return}H(),F()}),F());const z=()=>{y&&(y.value=""),u&&(u.value="+971 "),k&&(k.value=""),B&&(B.value=""),S&&(S.style.display="none"),I&&(I.style.display="none"),P(1),t.classList.add("active"),document.body.style.overflow="hidden"},W=()=>{t.classList.remove("active"),document.body.style.overflow=""},P=l=>{!a||!s||!o||!n||!c||!v||!p||!m||(l===1?(a.style.display="block",s.style.display="none",o.style.display="none",n.style.display="none",p.style.display="inline",c.textContent="1",v.textContent="Tell us about yourself",m.style.width="33%"):l===2?(a.style.display="none",s.style.display="block",o.style.display="none",n.style.display="none",p.style.display="inline",c.textContent="2",v.textContent="Your business details",m.style.width="66%"):l===3?(a.style.display="none",s.style.display="none",o.style.display="block",n.style.display="none",p.style.display="inline",c.textContent="3",v.textContent="Schedule your strategy call",m.style.width="100%",_()):l===4&&(a.style.display="none",s.style.display="none",o.style.display="none",n.style.display="block",p.style.display="none",v.textContent="Call Scheduled!",m.style.width="100%"))},_=()=>{const l=document.getElementById("strat-modal-calendly-container");if(!l)return;const g=D==="Under AED 5k/month"||D==="Under $5k"||D==="$0 - $5k";he=!g;const i=g?"https://calendly.com/officialatlanticbear/intro-call?hide_gdpr_banner=1&primary_color=3b69ff":"https://calendly.com/officialatlanticbear/strategy-call?hide_gdpr_banner=1&primary_color=3b69ff",r=D.replace(/–/g,"-").trim(),d=`${i}&name=${encodeURIComponent(b)}&a1=${encodeURIComponent(M)}&a2=${encodeURIComponent(U)}&a3=${encodeURIComponent(r)}&a4=${encodeURIComponent(r)}`;l.innerHTML="",pe(l);const A={url:d,parentElement:l,prefill:{name:b,customAnswers:{a1:M,a2:U,a3:r,a4:r,a5:r}}},w=()=>window.Calendly.initInlineWidget(A);if(window.Calendly)w();else{const f=document.getElementById("calendly-sdk");f&&f.addEventListener("load",w,{once:!0})}};T&&T.addEventListener("submit",l=>{l.preventDefault();const g=(y==null?void 0:y.value.trim())||"",i=(u==null?void 0:u.value.trim())||"";let r="";for(const f of Object.keys(x))if(i.startsWith(f)){r=f;break}if(!r&&i.startsWith("+")){const f=i.match(/^\+\d+/);f&&(r=f[0])}const d=i.substring(r.length).replace(/\D/g,""),A=i.replace(/\D/g,""),w=r?d.length>=6:A.length>=7;if(!g||!w){S&&(S.style.display="block");return}S&&(S.style.display="none"),b=g,M=i.replace(/\s+/g,""),P(2)}),C&&C.addEventListener("submit",async l=>{l.preventDefault();const g=(k==null?void 0:k.value.trim())||"",i=(B==null?void 0:B.value)||"";if(!g||!i){I&&(I.style.display="block");return}if(I&&(I.style.display="none"),U=g,D=i,!(i==="Under AED 5k/month"||i==="Under $5k"||i==="$0 - $5k")){const d=document.getElementById("strat-modal-step2-submit-btn");d&&(d.disabled=!0,d.textContent="Verifying...");const A=await ie("booking_submit");fetch("https://script.google.com/macros/s/AKfycbxhmc6G4n4zpk0SGvjzP81_Cd9ipLxM3Wx5MZNWzF02tBqqUMD0JCAuDnH1OojQfv7vJQ/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({action:"form_submit",name:b,phone:M,business:U,revenue:D,source:"strategy_call",recaptchaToken:A||""})}).catch(w=>console.error("Google Sheet submission failed:",w)),d&&(d.disabled=!1,d.textContent="Continue to Calendar →")}P(3)}),e.addEventListener("click",W),window.addEventListener("keydown",l=>{l.key==="Escape"&&t.classList.contains("active")&&W()}),$&&$.addEventListener("click",l=>{l.preventDefault(),W(),j("pricing",!0)}),window.goToStratBookingStep=P,window.openStratBookingModal=z}const ae=["home","pricing","testimonials","meta-ads","contact","booking","booked"];let G=null;function j(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const s=document.getElementById("strat-booking-modal");s&&s.remove(),document.body.style.overflow="",ne(),re();const o=document.getElementById("main-nav"),n=document.querySelector(".site-footer");t==="booking"?(o&&(o.style.display="none"),n&&(n.style.display="none")):(o&&(o.style.display=""),n&&(n.style.display=""));const c=K("#main-content"),v=G?ae.indexOf(G):-1,p=ae.indexOf(t),m=v===-1||p>=v,T=m?"-8%":"8%",C=m?"8%":"-8%";G=t;const y=window.matchMedia("(prefers-reduced-motion: reduce)").matches;c.style.transition=y?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",c.style.opacity="0",y||(c.style.transform=`translateX(${T})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),c.style.transition="none",y||(c.style.transform=`translateX(${C})`),c.innerHTML=ue[t](),ze(t),requestAnimationFrame(()=>{c.style.transition=y?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",c.style.opacity="1",c.style.transform="translateX(0)"}),je(),_e(),Ye(),t==="contact"&&Ge(),(t==="booking"||t==="booked")&&(E("pageload",2e3),ve(),ge(),Ke(),Qe(t==="booking"),t==="booking"&&(Je(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(u=>{u.addEventListener("click",()=>{typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","BookButtonClick"),window.openStratBookingModal&&window.openStratBookingModal()})}))),Fe(t),Ve(),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&window.fbq("track","PageView"),e){const u=t==="home"?"/":`/${t}`;window.location.pathname!==u&&history.pushState(null,"",u)}},260)}function Xe(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const s=a.getAttribute("data-link");s&&ue[s]&&j(s)})}function Ze(){const t=K("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{const t=new URLSearchParams(window.location.search);(t.get("notrack")==="1"||t.get("preview")==="true")&&sessionStorage.setItem("notrack","1");const e=t.get("fbclid"),a=(t.get("utm_source")||"").toLowerCase();(!!e||["facebook","instagram","fb","meta"].some(c=>a.includes(c)))&&sessionStorage.setItem("came_from_meta","1");const o=document.getElementById("app");o.innerHTML=`
    ${ye()}
  ...
  `,Xe(o),Ze(),oe(),window.addEventListener("message",c=>{if(!c.origin||!c.origin.includes("calendly.com"))return;let v=!1;if(c&&c.data){let p=c.data;if(typeof p=="string")try{p=JSON.parse(p)}catch{}typeof p=="object"&&p&&p.event==="calendly.event_scheduled"&&(v=!0)}if(v){const p=document.getElementById("strat-booking-modal"),m=document.getElementById("booking-modal");p&&p.classList.contains("active")?(he?(E("bookedcall_strategy"),typeof window.fbq=="function"&&sessionStorage.getItem("came_from_meta")&&!sessionStorage.getItem("fbq_schedule_fired")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1"))):E("bookedcall_intro"),p&&p.classList.remove("active")):(E("bookedcall"),m&&m.classList.remove("active")),document.body.style.overflow="",j("booked")}});const n=te(window.location.pathname);j(n,!1),window.addEventListener("popstate",()=>{const c=te(window.location.pathname);j(c,!1)})});
