(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const pe={ogImage:"/og-image.png"},Q={site:pe},V=(t,e=document)=>e.querySelector(t),K=(t,e=document)=>[...e.querySelectorAll(t)],J="atlanticbear_analytics_8d24";function b(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${J}/${t}`).catch(()=>{});try{const s=ve();fetch(`https://abacus.jasoncameron.dev/hit/${J}/${s}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}const ae=window.RECAPTCHA_SITE_KEY||"6Ldfp-gqAAAAABpP_placeholder_key";function se(){const t=window.RECAPTCHA_SITE_KEY||ae;if(document.getElementById("recaptcha-v3-script"))return;const e=document.createElement("script");e.id="recaptcha-v3-script",e.src=`https://www.google.com/recaptcha/api.js?render=${encodeURIComponent(t)}`,e.async=!0,e.defer=!0,document.head.appendChild(e)}async function oe(t){const e=window.RECAPTCHA_SITE_KEY||ae;return se(),new Promise(a=>{const s=setTimeout(()=>{console.warn(`reCAPTCHA [${t}] timed out. Continuing submission.`),a(null)},2500),o=window.grecaptcha;if(o&&typeof o.ready=="function")try{o.ready(()=>{o.execute(e,{action:t}).then(n=>{clearTimeout(s),a(n)}).catch(n=>{clearTimeout(s),console.warn(`reCAPTCHA [${t}] execution error:`,n),a(null)})})}catch(n){clearTimeout(s),console.warn(`reCAPTCHA [${t}] error:`,n),a(null)}else clearTimeout(s),a(null)})}let G={};function me(){ie();const t=e=>{G[`t${e}`]=window.setTimeout(()=>{b(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function ie(){Object.values(G).forEach(clearTimeout),G={}}let M={moved:!1,calendar:!1,testimonials:!1},j=null;function he(){ne(),M={moved:!1,video:!1,calendar:!1,testimonials:!1},j=()=>{window.scrollY>50&&!M.moved&&(M.moved=!0,b("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!M.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(M.calendar=!0,b("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!M.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(M.testimonials=!0,b("scroll_testimonials"))},window.addEventListener("scroll",j,{passive:!0})}function ne(){j&&(window.removeEventListener("scroll",j),j=null)}function ve(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}const m={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function ge(){return`
  ...
  <section class="cc-section">
  ...
  </section>`}const Y={quote:"We approached Alexi at Atlantic Bear, who was absolutely fantastic at putting together our ideas and bringing them across on the website in a way that really engaged our target market.",name:"Sonder Training Group",role:"Training Provider, UAE",avatar:0},O=[{quote:"Five days from the first call to a live site. I had budgeted two months, and half of that for arguing about revisions.",name:"Tom Whitfield",role:"Founder, Dental Clinic",avatar:1},{quote:"We now come up first for our category in Dubai. Enquiries through the site have roughly tripled since launch.",name:"Priya Nair",role:"Director, Facilities Services",avatar:2},{quote:"They asked good questions, then just built it. I approved two rounds of small tweaks and that was the whole process.",name:"Marcus Oyelaran",role:"Manager, Hospitality Group",avatar:3},{quote:"Most of our customers are on their phones and the old site was unusable there. The new one loads instantly.",name:"Yasmin Farouk",role:"Owner, Fitness Studio",avatar:4},{quote:"Handover was clean. Domain, hosting, files, all in our name from day one, exactly as they promised.",name:"Lena Vasquez",role:"Founder, E-commerce",avatar:5}],be=[[Y,O[0],O[1]],[O[2],Y,O[3]],[O[4],Y,O[0]]],X=[{bg:"#3b69ff",fg:"#dfe8ff"},{bg:"#1e46c7",fg:"#d5e0ff"},{bg:"#6391ff",fg:"#eef3ff"},{bg:"#2a50e0",fg:"#dbe5ff"},{bg:"#142d80",fg:"#ccd9ff"},{bg:"#4a80ff",fg:"#e7eeff"},{bg:"#27418f",fg:"#d2ddff"},{bg:"#5b7cff",fg:"#e9efff"},{bg:"#1a3fb5",fg:"#d8e2ff"}];function we(t,e){const a=X[e%X.length],s=7.2+e%3*.5,o=14.5+e%4*.8,n=19.5-e%3*.3;return`
    ...
    </article>`}function Ee(){const t=be.map((e,a)=>{const s=e.map(ke).join("");return`
  ...
  <section class="reviews-wall">
    <div class="container">
      <div class="reviews-head">
        <span class="reviews-badge">${m.star} Reviews</span>
  ...
  </section>`}const ce={home:Ae,pricing:Te,contact:Ie,testimonials:Be,booking:Pe,booked:Me,"meta-ads":Ce,terms:Le,privacy:De,blog:Se},Z={home:{title:"Website Design Agency in Dubai, UAE | Atlantic Bear",desc:"Atlantic Bear is a custom website design agency in Dubai, UAE. We build premium websites for small businesses — live in 5 days, fully managed, no templates."},pricing:{title:"Website Design Pricing in Dubai & UAE | Atlantic Bear",desc:"Transparent pricing for custom website design in Dubai and the UAE. Fully managed, no contracts, live in 5 days. Plans from AED 3,500 setup + AED 300/mo."},contact:{title:"Contact a Dubai Website Design Agency | Atlantic Bear",desc:"Get in touch with Atlantic Bear — a custom website design agency based in Dubai. Fast response, usually within a few hours. Start your UAE website project today."},testimonials:{title:"Client Reviews & Website Transformations | Atlantic Bear Dubai",desc:"See real client results from Atlantic Bear. Before and after website case studies for businesses in the UAE and UK. Watch client video testimonials."},booking:{title:"Book a Free Call — Website Agency Dubai | Atlantic Bear",desc:"Book a free 30-minute strategy call with Atlantic Bear, a website design agency in Dubai. Watch our overview video and schedule your slot."},booked:{title:"Call Confirmed | Atlantic Bear",desc:"Your call is locked in. Add the event to your calendar and watch the pre-call video before our session."},"meta-ads":{title:"Facebook & Instagram Ads Dubai, UAE | Atlantic Bear",desc:"Run targeted Facebook and Instagram ad campaigns in Dubai and the UAE with Atlantic Bear. Local targeting, ad creatives, and direct WhatsApp leads. AED 2,500/mo."},terms:{title:"Terms & Conditions | Atlantic Bear Website Agency Dubai",desc:"The terms covering Atlantic Bear website design, development, hosting, and maintenance services for businesses in Dubai and the UAE."},privacy:{title:"Privacy Policy | Atlantic Bear Website Agency Dubai",desc:"How Atlantic Bear collects, uses, stores, and protects the personal information you share through our website."},blog:{title:"Blog — Website Design & SEO Tips for UAE Businesses | Atlantic Bear",desc:"Expert articles on website design, SEO, and digital marketing for small businesses in Dubai and the UAE. Written by the Atlantic Bear team."}};function qe(t){const e=document.getElementById("faq-schema");if(e&&e.remove(),t!=="contact")return;const a=document.createElement("script");a.type="application/ld+json",a.id="faq-schema",a.textContent=JSON.stringify({"@context":"https://schema.org","@type":"FAQPage",mainEntity:le.map(s=>({"@type":"Question",name:s.q,acceptedAnswer:{"@type":"Answer",text:s.a}}))}),document.head.appendChild(a)}function $e(t){const e=Z[t]||Z.home;document.title=e.title,qe(t);let a=document.querySelector('meta[name="description"]');a||(a=document.createElement("meta"),a.setAttribute("name","description"),document.head.appendChild(a)),a.setAttribute("content",e.desc);let s=document.querySelector('link[rel="canonical"]');s||(s=document.createElement("link"),s.setAttribute("rel","canonical"),document.head.appendChild(s));const o=`${window.location.origin}${t==="home"?"":"/"+t}`;s.setAttribute("href",o);const n={"og:title":e.title,"og:description":e.desc,"og:url":o,"og:type":"website","og:image":`${window.location.origin}${Q.site.ogImage}`};for(const[v,p]of Object.entries(n)){let h=document.querySelector(`meta[property="${v}"]`);h||(h=document.createElement("meta"),h.setAttribute("property",v),document.head.appendChild(h)),h.setAttribute("content",p)}const c={"twitter:card":"summary_large_image","twitter:title":e.title,"twitter:description":e.desc,"twitter:image":`${window.location.origin}${Q.site.ogImage}`};for(const[v,p]of Object.entries(c)){let h=document.querySelector(`meta[name="${v}"]`);h||(h=document.createElement("meta"),h.setAttribute("name",v),document.head.appendChild(h)),h.setAttribute("content",p)}}function ee(t){const e=t.replace(/^\/|\/$/g,"");return e==="pricing"||e==="work"||e==="contact"||e==="testimonials"||e==="booking"||e==="booking-new"||e==="meta-ads"||e==="booked"||e==="terms"||e==="privacy"||e==="blog"?e:"home"}function Ue(t){K("#main-nav [data-link]").forEach(a=>a.classList.remove("active"));const e=V(`#main-nav [data-link="${t}"].nav-link`);e&&e.classList.add("active")}const Oe=[".section-title",".section-sub",".facts-headline",".fact-hero-block",".facts-stat-block",".basic-system-card",".step",".feature-item",".teaser-card",".tier-card",".level-one-card",".pricing-plan-card",".guarantee-card",".pricing-bonus-block",".problem-card",".contact-method",".contact-form-card",".cc-copy",".cc-visual",".reviews-head",".competitor-banner-text",".meta-ads-teaser-box"].join(",");function Re(){Array.from(document.querySelectorAll(Oe)).forEach(e=>{if(e.classList.contains("reveal")||e.classList.contains("revealed"))return;e.classList.add("reveal");const a=e.parentElement;if(!a)return;const o=Array.from(a.children).filter(n=>n.classList.contains("reveal")).indexOf(e);o>0&&!e.style.transitionDelay&&(e.style.transitionDelay=`${Math.min(o*.07,.35)}s`)})}function Fe(){const t=K(".reveal"),e=new IntersectionObserver(a=>{a.forEach(s=>{s.isIntersecting&&(s.target.classList.add("revealed"),e.unobserve(s.target))})},{threshold:.07,rootMargin:"0px 0px -30px 0px"});t.forEach(a=>e.observe(a))}function ze(t){const e=t.innerHTML,a=(t.textContent||"").trim();if(!a)return;t.textContent="",t.classList.add("is-typing");let s=0;const o=()=>{s+=1,t.textContent=a.slice(0,s),s<a.length?window.setTimeout(o,105):(t.innerHTML=e,t.classList.remove("is-typing"))};window.setTimeout(o,90)}function je(){const t=K(".fact-hero-num, .facts-stat-num");if(!t.length||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;t.forEach(a=>{a.style.minHeight=`${a.getBoundingClientRect().height}px`});const e=new IntersectionObserver(a=>{a.forEach((s,o)=>{if(!s.isIntersecting)return;const n=s.target;e.unobserve(n),window.setTimeout(()=>ze(n),o*150)})},{threshold:.4});t.forEach(a=>e.observe(a))}function Ne(){const t=document.getElementById("contact-form");if(!t)return;const e=document.createElement("script");e.src="https://unpkg.com/@formspree/ajax@1",e.defer=!0,document.head.appendChild(e),e.onload=()=>{window.formspree&&window.formspree("initForm",{formElement:"#contact-form",formId:"mykanvrr"})},t.addEventListener("submit",async a=>{a.preventDefault();const s=document.getElementById("form-submit-btn"),o=document.querySelector("[data-fs-success]"),n=document.querySelector('[data-fs-error]:not([data-fs-error="name"]):not([data-fs-error="email"]):not([data-fs-error="message"])');s&&(s.disabled=!0,s.textContent="Sending...");try{const c=await oe("contact_submit"),v=new FormData(t);if(c&&v.append("g-recaptcha-response",c),(await fetch("https://formspree.io/f/mykanvrr",{method:"POST",body:v,headers:{Accept:"application/json"}})).ok)t.style.display="none",o&&(o.style.display="block",o.style.textAlign="center",o.style.padding="18px",o.style.background="rgba(62,207,142,.07)",o.style.borderRadius="10px",o.style.border="1px solid rgba(62,207,142,.20)");else throw new Error("Server error")}catch{n&&(n.textContent="Something went wrong. Please try again or email officialatlanticbear@gmail.com.",n.style.color="var(--red)",n.style.fontSize="0.85rem",n.style.marginTop="8px"),s&&(s.disabled=!1,s.textContent="Try again")}})}function de(t){window.getComputedStyle(t).position==="static"&&(t.style.position="relative");const a=document.createElement("div");a.className="calendly-spinner-wrap",a.style.display="flex",a.style.justifyContent="center",a.style.alignItems="center",a.style.position="absolute",a.style.top="50%",a.style.left="50%",a.style.transform="translate(-50%, -50%)",a.style.pointerEvents="none",a.style.zIndex="1",a.innerHTML=`
  ...
  `,t.appendChild(a);const s=new MutationObserver(()=>{const o=t.querySelector("iframe");o&&(o.style.position="relative",o.style.zIndex="2",o.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),s.disconnect())});s.observe(t,{childList:!0})}function _e(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),s=e.querySelector("video");a&&s&&a.addEventListener("click",o=>{o.stopPropagation(),s.muted=!1,s.currentTime=0,s.controls=!0,a.style.display="none",s.play().catch(n=>{console.error("Play failed:",n)})})})}function Ye(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",de(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const s=document.createElement("script");s.id="calendly-sdk",s.src="https://assets.calendly.com/assets/external/widget.js",s.async=!0,s.addEventListener("load",e,{once:!0}),document.head.appendChild(s)}}function He(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),s=document.getElementById("bv-play-btn"),o=document.getElementById("bv-controls"),n=document.getElementById("bv-playpause"),c=document.getElementById("bv-progress-fill"),v=document.getElementById("bv-progress-thumb"),p=document.getElementById("bv-progress-wrap"),h=document.getElementById("bv-time"),W=document.getElementById("bv-mute"),A=document.getElementById("bv-volume"),w=document.getElementById("bv-fullscreen"),d=document.getElementById("custom-video-wrap");if(!e||!a||!s||!o||!n)return;e.volume=.9;let k=null,C=null;const x=()=>{try{const i=window.AudioContext||window.webkitAudioContext;if(!i)return;if(!k){k=new i;const r=k.createMediaElementSource(e);C=k.createGain(),C.gain.value=2,r.connect(C),C.connect(k.destination)}k.state==="suspended"&&k.resume()}catch(i){console.warn("AudioContext boost failed:",i)}},I=e.getAttribute("data-src"),q=()=>{I&&!e.getAttribute("src")&&(e.setAttribute("src",I),e.load())};let y=!0;const $=5,U=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{y&&e.currentTime>=$&&(e.currentTime=0)}),setTimeout(U,800);const L=i=>{const r=Math.floor(i/60),l=Math.floor(i%60);return`${r}:${l.toString().padStart(2,"0")}`},E=90,S=60,R=(i,r)=>!t||r<=E?i/r*100:i<=E?i/E*S:S+(i-E)/(r-E)*(100-S),_=(i,r)=>!t||r<=E?i/100*r:i<=S?i/S*E:E+(i-S)/(100-S)*(r-E),F=()=>{if(!e.duration)return;const i=R(e.currentTime,e.duration);c&&(c.style.width=i+"%"),v&&(v.style.left=i+"%"),h&&(h.textContent=`${L(e.currentTime)} / ${L(e.duration)}`)},D=i=>{const r=n==null?void 0:n.querySelector(".icon-play"),l=n==null?void 0:n.querySelector(".icon-pause");r&&(r.style.display=i&&!y?"none":"block"),l&&(l.style.display=i&&!y?"block":"none"),a&&(a.style.display=i&&!y?"none":"flex"),d&&(i&&!y?d.classList.add("playing"):d.classList.remove("playing"))};a.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0}q(),x(),D(!0),e.play()}),e.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0,x(),D(!0),e.play();return}q(),x(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>D(!0)),e.addEventListener("pause",()=>D(!1)),e.addEventListener("ended",()=>D(!1)),e.addEventListener("timeupdate",F),e.addEventListener("loadedmetadata",F);let P=!1;const T={m25:!1,m50:!1,m75:!1,m100:!1},u={};if(e.addEventListener("timeupdate",()=>{const i=e.duration;if(!i)return;const r=e.currentTime,l=r/i*100;!P&&r>.5&&(P=!0,b("videoplay")),l>=25&&!T.m25&&(T.m25=!0,b("videowatch_25pct")),l>=50&&!T.m50&&(T.m50=!0,b("videowatch_50pct")),l>=75&&!T.m75&&(T.m75=!0,b("videowatch_75pct")),l>=98&&!T.m100&&(T.m100=!0,b("videowatch_complete"));const g=[10,30],B=Math.floor(r);g.forEach(f=>{B>=f&&!u[f]&&(u[f]=!0,b(`videowatch_${f}s`))})}),n.addEventListener("click",()=>{q(),x(),e.paused?e.play():e.pause()}),p){const i=l=>{const g=p.getBoundingClientRect(),B=l instanceof MouseEvent?l.clientX:l.touches[0].clientX,f=Math.max(0,Math.min(100,(B-g.left)/g.width*100));e.currentTime=_(f,e.duration),F()};let r=!1;p.addEventListener("mousedown",l=>{r=!0,i(l)}),window.addEventListener("mousemove",l=>{r&&i(l)}),window.addEventListener("mouseup",()=>{r=!1}),p.addEventListener("touchstart",l=>i(l),{passive:!0}),p.addEventListener("touchmove",l=>i(l),{passive:!0})}if(A&&A.addEventListener("input",()=>{e.volume=parseFloat(A.value),e.muted=e.volume===0}),W&&W.addEventListener("click",()=>{e.muted=!e.muted,A&&(A.value=e.muted?"0":String(e.volume||1))}),w&&d&&w.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():d.requestFullscreen?d.requestFullscreen():d.webkitRequestFullscreen?d.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),d){let i;const r=()=>{o.style.opacity="1",clearTimeout(i),i=window.setTimeout(()=>{e.paused||(o.style.opacity="0")},2500)};d.addEventListener("mousemove",r),d.addEventListener("mouseenter",r),d.addEventListener("mouseleave",()=>{e.paused||(o.style.opacity="0")}),e.addEventListener("play",()=>{i=window.setTimeout(()=>{o.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{o.style.opacity="1",clearTimeout(i)})}}let ue=!0;function Ge(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn"),a=document.getElementById("strat-modal-step-1"),s=document.getElementById("strat-modal-step-2"),o=document.getElementById("strat-modal-step-3"),n=document.getElementById("strat-modal-step-4"),c=document.getElementById("strat-modal-step-num"),v=document.getElementById("strat-modal-step-title"),p=document.getElementById("strat-modal-step-badge"),h=document.getElementById("strat-modal-progress-bar"),W=document.getElementById("strat-modal-step1-form"),A=document.getElementById("strat-modal-step2-form"),w=document.getElementById("strat-input-name"),d=document.getElementById("strat-input-phone"),k=document.getElementById("strat-input-business"),C=document.getElementById("strat-select-revenue"),x=document.getElementById("strat-modal-step1-error"),I=document.getElementById("strat-modal-step2-error"),q=document.getElementById("strat-modal-confirm-pricing-link");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);let y="",$="",U="",L="";const E={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},S=document.getElementById("strat-phone-flag-prefix"),R=()=>{if(!S||!d)return;const u=d.value.trim();let i="🇦🇪";for(const[r,l]of Object.entries(E))if(u.startsWith(r)){i=l;break}S.textContent=i},_=()=>{if(!d)return;let u=d.value,i="";for(const f of Object.keys(E))if(u.startsWith(f)){i=f+" ";break}if(!i&&u.startsWith("+")){const f=u.indexOf(" ");if(f>0)i=u.substring(0,f+1);else{const z=u.match(/^\+\d+/);z&&(i=z[0]+" ")}}const l=u.substring(i.length).replace(/\D/g,"").substring(0,9);let g="";l.length>0&&(l.length<=2?g=l:l.length<=5?g=`${l.substring(0,2)} ${l.substring(2)}`:g=`${l.substring(0,2)} ${l.substring(2,5)} ${l.substring(5)}`);const B=i+g;d.value!==B&&(d.value=B)};d&&(d.addEventListener("input",u=>{const i=u;if(i.inputType&&i.inputType.startsWith("delete")){R();return}_(),R()}),R());const F=()=>{w&&(w.value=""),d&&(d.value="+971 "),k&&(k.value=""),C&&(C.value=""),x&&(x.style.display="none"),I&&(I.style.display="none"),P(1),t.classList.add("active"),document.body.style.overflow="hidden"},D=()=>{t.classList.remove("active"),document.body.style.overflow=""},P=u=>{!a||!s||!o||!n||!c||!v||!p||!h||(u===1?(a.style.display="block",s.style.display="none",o.style.display="none",n.style.display="none",p.style.display="inline",c.textContent="1",v.textContent="Tell us about yourself",h.style.width="33%"):u===2?(a.style.display="none",s.style.display="block",o.style.display="none",n.style.display="none",p.style.display="inline",c.textContent="2",v.textContent="Your business details",h.style.width="66%"):u===3?(a.style.display="none",s.style.display="none",o.style.display="block",n.style.display="none",p.style.display="inline",c.textContent="3",v.textContent="Schedule your strategy call",h.style.width="100%",T()):u===4&&(a.style.display="none",s.style.display="none",o.style.display="none",n.style.display="block",p.style.display="none",v.textContent="Call Scheduled!",h.style.width="100%"))},T=()=>{const u=document.getElementById("strat-modal-calendly-container");if(!u)return;const i=L==="Under AED 5k/month"||L==="Under $5k"||L==="$0 - $5k";ue=!i;const r=i?"https://calendly.com/officialatlanticbear/intro-call?hide_gdpr_banner=1&primary_color=3b69ff":"https://calendly.com/officialatlanticbear/strategy-call?hide_gdpr_banner=1&primary_color=3b69ff",l=L.replace(/–/g,"-").trim(),g=`${r}&name=${encodeURIComponent(y)}&a1=${encodeURIComponent($)}&a2=${encodeURIComponent(U)}&a3=${encodeURIComponent(l)}&a4=${encodeURIComponent(l)}`;u.innerHTML="",de(u);const B={url:g,parentElement:u,prefill:{name:y,customAnswers:{a1:$,a2:U,a3:l,a4:l,a5:l}}},f=()=>window.Calendly.initInlineWidget(B);if(window.Calendly)f();else{const z=document.getElementById("calendly-sdk");z&&z.addEventListener("load",f,{once:!0})}};W&&W.addEventListener("submit",u=>{u.preventDefault();const i=(w==null?void 0:w.value.trim())||"",r=(d==null?void 0:d.value.trim())||"";if(!i||!r){x&&(x.style.display="block");return}x&&(x.style.display="none"),y=i,$=r.replace(/\s+/g,""),P(2)}),A&&A.addEventListener("submit",async u=>{u.preventDefault();const i=(k==null?void 0:k.value.trim())||"",r=(C==null?void 0:C.value)||"";if(!i||!r){I&&(I.style.display="block");return}if(I&&(I.style.display="none"),U=i,L=r,!(r==="Under AED 5k/month"||r==="Under $5k"||r==="$0 - $5k")){const g=document.getElementById("strat-modal-step2-submit-btn");g&&(g.disabled=!0,g.textContent="Verifying...");const B=await oe("booking_submit");fetch("https://script.google.com/macros/s/AKfycbxhmc6G4n4zpk0SGvjzP81_Cd9ipLxM3Wx5MZNWzF02tBqqUMD0JCAuDnH1OojQfv7vJQ/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({action:"form_submit",name:y,phone:$,business:U,revenue:L,source:"strategy_call",recaptchaToken:B||""})}).catch(f=>console.error("Google Sheet submission failed:",f)),g&&(g.disabled=!1,g.textContent="Continue to Calendar →")}P(3)}),e.addEventListener("click",D),window.addEventListener("keydown",u=>{u.key==="Escape"&&t.classList.contains("active")&&D()}),q&&q.addEventListener("click",u=>{u.preventDefault(),D(),N("pricing",!0)}),window.goToStratBookingStep=P,window.openStratBookingModal=F}const te=["home","pricing","testimonials","meta-ads","contact","booking","booked"];let H=null;function N(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const s=document.getElementById("strat-booking-modal");s&&s.remove(),document.body.style.overflow="",ie(),ne();const o=document.getElementById("main-nav"),n=document.querySelector(".site-footer");t==="booking"?(o&&(o.style.display="none"),n&&(n.style.display="none")):(o&&(o.style.display=""),n&&(n.style.display=""));const c=V("#main-content"),v=H?te.indexOf(H):-1,p=te.indexOf(t),h=v===-1||p>=v,W=h?"-8%":"8%",A=h?"8%":"-8%";H=t;const w=window.matchMedia("(prefers-reduced-motion: reduce)").matches;c.style.transition=w?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",c.style.opacity="0",w||(c.style.transform=`translateX(${W})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),c.style.transition="none",w||(c.style.transform=`translateX(${A})`),c.innerHTML=ce[t](),Ue(t),requestAnimationFrame(()=>{c.style.transition=w?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",c.style.opacity="1",c.style.transform="translateX(0)"}),Re(),Fe(),je(),t==="contact"&&Ne(),(t==="booking"||t==="booked")&&(b("pageload",2e3),me(),he(),Ye(),He(t==="booking"),t==="booking"&&(Ge(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(d=>{d.addEventListener("click",()=>{window.openStratBookingModal&&window.openStratBookingModal()})}))),$e(t),_e(),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&window.fbq("track","PageView"),e){const d=t==="home"?"/":`/${t}`;window.location.pathname!==d&&history.pushState(null,"",d)}},260)}function Ve(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const s=a.getAttribute("data-link");s&&ce[s]&&N(s)})}function Ke(){const t=V("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{const t=new URLSearchParams(window.location.search);t.get("notrack")==="1"&&sessionStorage.setItem("notrack","1");const e=t.get("fbclid"),a=(t.get("utm_source")||"").toLowerCase();(!!e||["facebook","instagram","fb","meta"].some(c=>a.includes(c)))&&sessionStorage.setItem("came_from_meta","1");const o=document.getElementById("app");o.innerHTML=`
    ${ge()}
  ...
  `,Ve(o),Ke(),se(),window.addEventListener("message",c=>{if(!c.origin||!c.origin.includes("calendly.com"))return;let v=!1;if(c&&c.data){let p=c.data;if(typeof p=="string")try{p=JSON.parse(p)}catch{}typeof p=="object"&&p&&p.event==="calendly.event_scheduled"&&(v=!0)}if(v){const p=document.getElementById("strat-booking-modal"),h=document.getElementById("booking-modal");p&&p.classList.contains("active")?(ue?(b("bookedcall_strategy"),typeof window.fbq=="function"&&sessionStorage.getItem("came_from_meta")&&!sessionStorage.getItem("fbq_schedule_fired")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1"))):b("bookedcall_intro"),p&&p.classList.remove("active")):(b("bookedcall"),h&&h.classList.remove("active")),document.body.style.overflow="",N("booked")}});const n=ee(window.location.pathname);N(n,!1),window.addEventListener("popstate",()=>{const c=ee(window.location.pathname);N(c,!1)})});
