(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function a(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(o){if(o.ep)return;o.ep=!0;const i=a(o);fetch(o.href,i)}})();const me={ogImage:"/og-image.png"},J={site:me},K=(t,e=document)=>e.querySelector(t),Q=(t,e=document)=>[...e.querySelectorAll(t)],X="atlanticbear_analytics_8d24";function R(){if(sessionStorage.getItem("notrack"))return!0;try{if(new URLSearchParams(window.location.search).get("preview")==="true")return!0}catch{}return!1}function k(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${X}/${t}`).catch(()=>{});try{const s=fe();fetch(`https://abacus.jasoncameron.dev/hit/${X}/${s}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}const se=window.RECAPTCHA_SITE_KEY||"6Ldfp-gqAAAAABpP_placeholder_key";function oe(){const t=window.RECAPTCHA_SITE_KEY||se;if(document.getElementById("recaptcha-v3-script"))return;const e=document.createElement("script");e.id="recaptcha-v3-script",e.src=`https://www.google.com/recaptcha/api.js?render=${encodeURIComponent(t)}`,e.async=!0,e.defer=!0,document.head.appendChild(e)}async function ie(t){const e=window.RECAPTCHA_SITE_KEY||se;return oe(),new Promise(a=>{const s=setTimeout(()=>{console.warn(`reCAPTCHA [${t}] timed out. Continuing submission.`),a(null)},2500),o=window.grecaptcha;if(o&&typeof o.ready=="function")try{o.ready(()=>{o.execute(e,{action:t}).then(i=>{clearTimeout(s),a(i)}).catch(i=>{clearTimeout(s),console.warn(`reCAPTCHA [${t}] execution error:`,i),a(null)})})}catch(i){clearTimeout(s),console.warn(`reCAPTCHA [${t}] error:`,i),a(null)}else clearTimeout(s),a(null)})}let V={};function ve(){ne();const t=e=>{V[`t${e}`]=window.setTimeout(()=>{k(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function ne(){Object.values(V).forEach(clearTimeout),V={}}let q={moved:!1,calendar:!1,testimonials:!1},N=null;function ge(){re(),q={moved:!1,video:!1,calendar:!1,testimonials:!1},N=()=>{window.scrollY>50&&!q.moved&&(q.moved=!0,k("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!q.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(q.calendar=!0,k("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!q.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(q.testimonials=!0,k("scroll_testimonials"))},window.addEventListener("scroll",N,{passive:!0})}function re(){N&&(window.removeEventListener("scroll",N),N=null)}function fe(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}const h={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function ye(){return`
  ...
  </section>`}function de(t){const e=t==="launch",a=e?"AED 3,500":"AED 6,500",s="AED 300",o=e?"AED 1,750":"AED 3,250",i=e?"Launch Plan":"Growth Plan",c=e?"What's Included in the Launch Plan":"What's Included in the Growth Plan",v=e?["Up to 5 pages","Custom design, no templates","WhatsApp button, click-to-call","Mobile responsive"]:["Up to 15 pages","Photos and video","Custom design, no templates","Contact form","Mobile responsive"],p=e?["Written to rank on Google","Page titles and meta descriptions","SEO-ready structure"]:["Written to rank on Google","Targeting your service keywords","Blog SEO structure"],m=["Fully managed","Daily backups"],T=e?"1":"2",E=e?"One revision session per month. Book time with us, tell us what to change, we handle it.":"Two revision sessions per month. Book time with us, tell us what to change, we handle it.";function f(u){return u.map(b=>`<span class="sp-pill">${b}</span>`).join("")}return`
  <div class="sp-wrap">
    <!-- HEADER -->
    <div class="sp-header">
      ...
      <p class="sp-label">Atlantic Bear, ${i}</p>
  ...
  `,t.appendChild(a);const s=new MutationObserver(()=>{const o=t.querySelector("iframe");o&&(o.style.position="relative",o.style.zIndex="2",o.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),s.disconnect())});s.observe(t,{childList:!0})}function Ve(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),s=e.querySelector("video");a&&s&&a.addEventListener("click",o=>{o.stopPropagation(),s.muted=!1,s.currentTime=0,s.controls=!0,a.style.display="none",s.play().catch(i=>{console.error("Play failed:",i)})})})}function Ke(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",pe(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const s=document.createElement("script");s.id="calendly-sdk",s.src="https://assets.calendly.com/assets/external/widget.js",s.async=!0,s.addEventListener("load",e,{once:!0}),document.head.appendChild(s)}}function Qe(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),s=document.getElementById("bv-play-btn"),o=document.getElementById("bv-controls"),i=document.getElementById("bv-playpause"),c=document.getElementById("bv-progress-fill"),v=document.getElementById("bv-progress-thumb"),p=document.getElementById("bv-progress-wrap"),m=document.getElementById("bv-time"),T=document.getElementById("bv-mute"),E=document.getElementById("bv-volume"),f=document.getElementById("bv-fullscreen"),u=document.getElementById("custom-video-wrap");if(!e||!a||!s||!o||!i)return;e.volume=.9;let b=null,B=null;const C=()=>{try{const n=window.AudioContext||window.webkitAudioContext;if(!n)return;if(!b){b=new n;const r=b.createMediaElementSource(e);B=b.createGain(),B.gain.value=2,r.connect(B),B.connect(b.destination)}b.state==="suspended"&&b.resume()}catch(n){console.warn("AudioContext boost failed:",n)}},I=e.getAttribute("data-src"),$=()=>{I&&!e.getAttribute("src")&&(e.setAttribute("src",I),e.load())};let y=!0;const M=5,U=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{y&&e.currentTime>=M&&(e.currentTime=0)}),setTimeout(U,800);const D=n=>{const r=Math.floor(n/60),d=Math.floor(n%60);return`${r}:${d.toString().padStart(2,"0")}`},x=90,L=60,F=(n,r)=>!t||r<=x?n/r*100:n<=x?n/x*L:L+(n-x)/(r-x)*(100-L),H=(n,r)=>!t||r<=x?n/100*r:n<=L?n/L*x:x+(n-L)/(100-L)*(r-x),z=()=>{if(!e.duration)return;const n=F(e.currentTime,e.duration);c&&(c.style.width=n+"%"),v&&(v.style.left=n+"%"),m&&(m.textContent=`${D(e.currentTime)} / ${D(e.duration)}`)},W=n=>{const r=i==null?void 0:i.querySelector(".icon-play"),d=i==null?void 0:i.querySelector(".icon-pause");r&&(r.style.display=n&&!y?"none":"block"),d&&(d.style.display=n&&!y?"block":"none"),a&&(a.style.display=n&&!y?"none":"flex"),u&&(n&&!y?u.classList.add("playing"):u.classList.remove("playing"))};a.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const n=e.src.split("#")[0];e.src!==n&&(e.src=n,e.load()),e.currentTime=0}$(),C(),W(!0),e.play()}),e.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const n=e.src.split("#")[0];e.src!==n&&(e.src=n,e.load()),e.currentTime=0,C(),W(!0),e.play();return}$(),C(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>W(!0)),e.addEventListener("pause",()=>W(!1)),e.addEventListener("ended",()=>W(!1)),e.addEventListener("timeupdate",z),e.addEventListener("loadedmetadata",z);let P=!1,j=!1;const l={m25:!1,m50:!1,m75:!1,m95:!1,m100:!1},g={};if(e.addEventListener("play",()=>{!j&&!y&&(j=!0,typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","VSL_Play"))}),e.addEventListener("timeupdate",()=>{const n=e.duration;if(!n)return;const r=e.currentTime,d=r/n*100;if(!P&&r>.5&&!y&&(P=!0,k("videoplay")),y)return;d>=25&&!l.m25&&(l.m25=!0,k("videowatch_25pct"),typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","VSL_25")),d>=50&&!l.m50&&(l.m50=!0,k("videowatch_50pct"),typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","VSL_50")),d>=75&&!l.m75&&(l.m75=!0,k("videowatch_75pct"),typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","VSL_75")),d>=95&&!l.m95&&(l.m95=!0,typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","VSL_95")),d>=98&&!l.m100&&(l.m100=!0,k("videowatch_complete"));const S=[10,30],w=Math.floor(r);S.forEach(A=>{w>=A&&!g[A]&&(g[A]=!0,k(`videowatch_${A}s`))})}),i.addEventListener("click",()=>{$(),C(),e.paused?e.play():e.pause()}),p){const n=d=>{const S=p.getBoundingClientRect(),w=d instanceof MouseEvent?d.clientX:d.touches[0].clientX,A=Math.max(0,Math.min(100,(w-S.left)/S.width*100));e.currentTime=H(A,e.duration),z()};let r=!1;p.addEventListener("mousedown",d=>{r=!0,n(d)}),window.addEventListener("mousemove",d=>{r&&n(d)}),window.addEventListener("mouseup",()=>{r=!1}),p.addEventListener("touchstart",d=>n(d),{passive:!0}),p.addEventListener("touchmove",d=>n(d),{passive:!0})}if(E&&E.addEventListener("input",()=>{e.volume=parseFloat(E.value),e.muted=e.volume===0}),T&&T.addEventListener("click",()=>{e.muted=!e.muted,E&&(E.value=e.muted?"0":String(e.volume||1))}),f&&u&&f.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():u.requestFullscreen?u.requestFullscreen():u.webkitRequestFullscreen?u.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),u){let n;const r=()=>{o.style.opacity="1",clearTimeout(n),n=window.setTimeout(()=>{e.paused||(o.style.opacity="0")},2500)};u.addEventListener("mousemove",r),u.addEventListener("mouseenter",r),u.addEventListener("mouseleave",()=>{e.paused||(o.style.opacity="0")}),e.addEventListener("play",()=>{n=window.setTimeout(()=>{o.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{o.style.opacity="1",clearTimeout(n)})}}let he=!0;function Je(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn"),a=document.getElementById("strat-modal-step-1"),s=document.getElementById("strat-modal-step-2"),o=document.getElementById("strat-modal-step-3"),i=document.getElementById("strat-modal-step-4"),c=document.getElementById("strat-modal-step-num"),v=document.getElementById("strat-modal-step-title"),p=document.getElementById("strat-modal-step-badge"),m=document.getElementById("strat-modal-progress-bar"),T=document.getElementById("strat-modal-step1-form"),E=document.getElementById("strat-modal-step2-form"),f=document.getElementById("strat-input-name"),u=document.getElementById("strat-input-phone"),b=document.getElementById("strat-input-business"),B=document.getElementById("strat-select-revenue"),C=document.getElementById("strat-modal-step1-error"),I=document.getElementById("strat-modal-step2-error"),$=document.getElementById("strat-modal-confirm-pricing-link");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);let y="",M="",U="",D="";const x={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},L=document.getElementById("strat-phone-flag-prefix"),F=()=>{if(!L||!u)return;const l=u.value.trim();let g="🇦🇪";for(const[n,r]of Object.entries(x))if(l.startsWith(n)){g=r;break}L.textContent=g},H=()=>{if(!u)return;let l=u.value,g="";for(const w of Object.keys(x))if(l.startsWith(w)){g=w+" ";break}if(!g&&l.startsWith("+")){const w=l.indexOf(" ");if(w>0)g=l.substring(0,w+1);else{const A=l.match(/^\+\d+/);A&&(g=A[0]+" ")}}const r=l.substring(g.length).replace(/\D/g,"").substring(0,9);let d="";r.length>0&&(r.length<=2?d=r:r.length<=5?d=`${r.substring(0,2)} ${r.substring(2)}`:d=`${r.substring(0,2)} ${r.substring(2,5)} ${r.substring(5)}`);const S=g+d;u.value!==S&&(u.value=S)};u&&(u.addEventListener("input",l=>{const g=l;if(g.inputType&&g.inputType.startsWith("delete")){F();return}H(),F()}),F());const z=()=>{f&&(f.value=""),u&&(u.value="+971 "),b&&(b.value=""),B&&(B.value=""),C&&(C.style.display="none"),I&&(I.style.display="none"),P(1),t.classList.add("active"),document.body.style.overflow="hidden"},W=()=>{t.classList.remove("active"),document.body.style.overflow=""},P=l=>{!a||!s||!o||!i||!c||!v||!p||!m||(l===1?(a.style.display="block",s.style.display="none",o.style.display="none",i.style.display="none",p.style.display="inline",c.textContent="1",v.textContent="Tell us about yourself",m.style.width="33%"):l===2?(a.style.display="none",s.style.display="block",o.style.display="none",i.style.display="none",p.style.display="inline",c.textContent="2",v.textContent="Your business details",m.style.width="66%"):l===3?(a.style.display="none",s.style.display="none",o.style.display="block",i.style.display="none",p.style.display="inline",c.textContent="3",v.textContent="Schedule your strategy call",m.style.width="100%",j()):l===4&&(a.style.display="none",s.style.display="none",o.style.display="none",i.style.display="block",p.style.display="none",v.textContent="Call Scheduled!",m.style.width="100%"))},j=()=>{const l=document.getElementById("strat-modal-calendly-container");if(!l)return;const g=D==="Under AED 5k/month"||D==="Under $5k"||D==="$0 - $5k";he=!g;const n=g?"https://calendly.com/officialatlanticbear/intro-call?hide_gdpr_banner=1&primary_color=3b69ff":"https://calendly.com/officialatlanticbear/strategy-call?hide_gdpr_banner=1&primary_color=3b69ff",r=D.replace(/–/g,"-").trim(),d=`${n}&name=${encodeURIComponent(y)}&a1=${encodeURIComponent(M)}&a2=${encodeURIComponent(U)}&a3=${encodeURIComponent(r)}&a4=${encodeURIComponent(r)}`;l.innerHTML="",pe(l);const S={url:d,parentElement:l,prefill:{name:y,customAnswers:{a1:M,a2:U,a3:r,a4:r,a5:r}}},w=()=>window.Calendly.initInlineWidget(S);if(window.Calendly)w();else{const A=document.getElementById("calendly-sdk");A&&A.addEventListener("load",w,{once:!0})}};T&&T.addEventListener("submit",l=>{l.preventDefault();const g=(f==null?void 0:f.value.trim())||"",n=(u==null?void 0:u.value.trim())||"";if(!g||!n){C&&(C.style.display="block");return}C&&(C.style.display="none"),y=g,M=n.replace(/\s+/g,""),P(2)}),E&&E.addEventListener("submit",async l=>{l.preventDefault();const g=(b==null?void 0:b.value.trim())||"",n=(B==null?void 0:B.value)||"";if(!g||!n){I&&(I.style.display="block");return}if(I&&(I.style.display="none"),U=g,D=n,!(n==="Under AED 5k/month"||n==="Under $5k"||n==="$0 - $5k")){const d=document.getElementById("strat-modal-step2-submit-btn");d&&(d.disabled=!0,d.textContent="Verifying...");const S=await ie("booking_submit");fetch("https://script.google.com/macros/s/AKfycbxhmc6G4n4zpk0SGvjzP81_Cd9ipLxM3Wx5MZNWzF02tBqqUMD0JCAuDnH1OojQfv7vJQ/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({action:"form_submit",name:y,phone:M,business:U,revenue:D,source:"strategy_call",recaptchaToken:S||""})}).catch(w=>console.error("Google Sheet submission failed:",w)),d&&(d.disabled=!1,d.textContent="Continue to Calendar →")}P(3)}),e.addEventListener("click",W),window.addEventListener("keydown",l=>{l.key==="Escape"&&t.classList.contains("active")&&W()}),$&&$.addEventListener("click",l=>{l.preventDefault(),W(),_("pricing",!0)}),window.goToStratBookingStep=P,window.openStratBookingModal=z}const ae=["home","pricing","testimonials","meta-ads","contact","booking","booked"];let G=null;function _(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const s=document.getElementById("strat-booking-modal");s&&s.remove(),document.body.style.overflow="",ne(),re();const o=document.getElementById("main-nav"),i=document.querySelector(".site-footer");t==="booking"?(o&&(o.style.display="none"),i&&(i.style.display="none")):(o&&(o.style.display=""),i&&(i.style.display=""));const c=K("#main-content"),v=G?ae.indexOf(G):-1,p=ae.indexOf(t),m=v===-1||p>=v,T=m?"-8%":"8%",E=m?"8%":"-8%";G=t;const f=window.matchMedia("(prefers-reduced-motion: reduce)").matches;c.style.transition=f?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",c.style.opacity="0",f||(c.style.transform=`translateX(${T})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),c.style.transition="none",f||(c.style.transform=`translateX(${E})`),c.innerHTML=ue[t](),ze(t),requestAnimationFrame(()=>{c.style.transition=f?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",c.style.opacity="1",c.style.transform="translateX(0)"}),_e(),je(),Ye(),t==="contact"&&Ge(),(t==="booking"||t==="booked")&&(k("pageload",2e3),ve(),ge(),Ke(),Qe(t==="booking"),t==="booking"&&(Je(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(u=>{u.addEventListener("click",()=>{typeof window.fbq=="function"&&!R()&&window.fbq("trackCustom","BookButtonClick"),window.openStratBookingModal&&window.openStratBookingModal()})}))),Fe(t),Ve(),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&window.fbq("track","PageView"),e){const u=t==="home"?"/":`/${t}`;window.location.pathname!==u&&history.pushState(null,"",u)}},260)}function Xe(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const s=a.getAttribute("data-link");s&&ue[s]&&_(s)})}function Ze(){const t=K("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{const t=new URLSearchParams(window.location.search);(t.get("notrack")==="1"||t.get("preview")==="true")&&sessionStorage.setItem("notrack","1");const e=t.get("fbclid"),a=(t.get("utm_source")||"").toLowerCase();(!!e||["facebook","instagram","fb","meta"].some(c=>a.includes(c)))&&sessionStorage.setItem("came_from_meta","1");const o=document.getElementById("app");o.innerHTML=`
    ${ye()}
  ...
  `,Xe(o),Ze(),oe(),window.addEventListener("message",c=>{if(!c.origin||!c.origin.includes("calendly.com"))return;let v=!1;if(c&&c.data){let p=c.data;if(typeof p=="string")try{p=JSON.parse(p)}catch{}typeof p=="object"&&p&&p.event==="calendly.event_scheduled"&&(v=!0)}if(v){const p=document.getElementById("strat-booking-modal"),m=document.getElementById("booking-modal");p&&p.classList.contains("active")?(he?(k("bookedcall_strategy"),typeof window.fbq=="function"&&sessionStorage.getItem("came_from_meta")&&!sessionStorage.getItem("fbq_schedule_fired")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1"))):k("bookedcall_intro"),p&&p.classList.remove("active")):(k("bookedcall"),m&&m.classList.remove("active")),document.body.style.overflow="",_("booked")}});const i=te(window.location.pathname);_(i,!1),window.addEventListener("popstate",()=>{const c=te(window.location.pathname);_(c,!1)})});
