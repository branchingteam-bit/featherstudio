(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const h of n.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&o(h)}).observe(document,{childList:!0,subtree:!0});function a(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(s){if(s.ep)return;s.ep=!0;const n=a(s);fetch(s.href,n)}})();const pe={ogImage:"/og-image.png"},me={home:{path:"/",title:"Atlantic Bear | Custom Website Design Agency in the UAE",desc:"Atlantic Bear is a leading website agency in the UAE. We build custom, premium websites for businesses, live in five days and fully managed.",priority:"1.0"},pricing:{path:"/pricing",title:"Website Pricing for UAE Businesses | Atlantic Bear",desc:"Transparent website pricing for UAE businesses. The Launch Plan from AED 3,500 and the Growth Plan from AED 6,500, both fully managed with hosting, updates and support included.",priority:"0.9"},testimonials:{path:"/testimonials",title:"Client Work & Testimonials | Atlantic Bear",desc:"See real website transformations by Atlantic Bear. Before and after case studies showing how we help businesses across the UAE look professional online.",priority:"0.8"},contact:{path:"/contact",title:"Contact Atlantic Bear | UAE Web Design Agency",desc:"Get in touch with Atlantic Bear in Dubai. Call +971-50-244-6531, email us, or read answers to the questions we are asked most about building a website in the UAE.",priority:"0.8"},"meta-ads":{path:"/meta-ads",title:"Meta Ads for UAE Small Businesses | Atlantic Bear",desc:"Drive local client leads via Facebook and Instagram ads for small businesses in the UAE. AED 2,500 per month retainer, fully managed.",priority:"0.7"},booking:{path:"/booking",title:"Book a Strategy Call | Atlantic Bear",desc:"Schedule a 30-minute strategy call with Atlantic Bear and start your UAE website project today.",priority:"0.7"},terms:{path:"/terms",title:"Terms & Conditions | Atlantic Bear",desc:"The terms covering Atlantic Bear website design, development, hosting, and maintenance services for businesses in the UAE.",priority:"0.3"},privacy:{path:"/privacy",title:"Privacy Policy | Atlantic Bear",desc:"How Atlantic Bear collects, uses, stores, and protects the personal information you share through our website.",priority:"0.3"}},z={site:pe,pages:me},K=(t,e=document)=>e.querySelector(t),Q=(t,e=document)=>[...e.querySelectorAll(t)],X="atlanticbear_analytics_8d24";function B(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${X}/${t}`).catch(()=>{});try{const o=ge();fetch(`https://abacus.jasoncameron.dev/hit/${X}/${o}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}const se=window.RECAPTCHA_SITE_KEY||"6Ldfp-gqAAAAABpP_placeholder_key";function oe(){const t=window.RECAPTCHA_SITE_KEY||se;if(document.getElementById("recaptcha-v3-script"))return;const e=document.createElement("script");e.id="recaptcha-v3-script",e.src=`https://www.google.com/recaptcha/api.js?render=${encodeURIComponent(t)}`,e.async=!0,e.defer=!0,document.head.appendChild(e)}async function ie(t){const e=window.RECAPTCHA_SITE_KEY||se;return oe(),new Promise(a=>{const o=setTimeout(()=>{console.warn(`reCAPTCHA [${t}] timed out. Continuing submission.`),a(null)},2500),s=window.grecaptcha;if(s&&typeof s.ready=="function")try{s.ready(()=>{s.execute(e,{action:t}).then(n=>{clearTimeout(o),a(n)}).catch(n=>{clearTimeout(o),console.warn(`reCAPTCHA [${t}] execution error:`,n),a(null)})})}catch(n){clearTimeout(o),console.warn(`reCAPTCHA [${t}] error:`,n),a(null)}else clearTimeout(o),a(null)})}let G={};function he(){ne();const t=e=>{G[`t${e}`]=window.setTimeout(()=>{B(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function ne(){Object.values(G).forEach(clearTimeout),G={}}let F={moved:!1,calendar:!1,testimonials:!1},H=null;function ve(){re(),F={moved:!1,video:!1,calendar:!1,testimonials:!1},H=()=>{window.scrollY>50&&!F.moved&&(F.moved=!0,B("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!F.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(F.calendar=!0,B("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!F.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(F.testimonials=!0,B("scroll_testimonials"))},window.addEventListener("scroll",H,{passive:!0})}function re(){H&&(window.removeEventListener("scroll",H),H=null)}function ge(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${a}-${o}-${s}`}const g={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function fe(){return`
  ...
  <section class="cc-section">
    <div class="container">
      <div class="cc-grid">
        ...
        <div class="cc-copy reveal">
          <span class="cc-badge">${g.code} How we build</span>
  ...
  </section>`}const Y={quote:"We approached Alexi at Atlantic Bear, who was absolutely fantastic at putting together our ideas and bringing them across on the website in a way that really engaged our target market.",name:"Sonder Training Group",role:"Training Provider, UAE",avatar:0},_=[{quote:"Five days from the first call to a live site. I had budgeted two months, and half of that for arguing about revisions.",name:"Tom Whitfield",role:"Founder, Dental Clinic",avatar:1},{quote:"We now come up first for our category in Dubai. Enquiries through the site have roughly tripled since launch.",name:"Priya Nair",role:"Director, Facilities Services",avatar:2},{quote:"They asked good questions, then just built it. I approved two rounds of small tweaks and that was the whole process.",name:"Marcus Oyelaran",role:"Manager, Hospitality Group",avatar:3},{quote:"Most of our customers are on their phones and the old site was unusable there. The new one loads instantly.",name:"Yasmin Farouk",role:"Owner, Fitness Studio",avatar:4},{quote:"Handover was clean. Domain, hosting, files, all in our name from day one, exactly as they promised.",name:"Lena Vasquez",role:"Founder, E-commerce",avatar:5}],we=[[Y,_[0],_[1]],[_[2],Y,_[3]],[_[4],Y,_[0]]],Z=[{bg:"#3b69ff",fg:"#dfe8ff"},{bg:"#1e46c7",fg:"#d5e0ff"},{bg:"#6391ff",fg:"#eef3ff"},{bg:"#2a50e0",fg:"#dbe5ff"},{bg:"#142d80",fg:"#ccd9ff"},{bg:"#4a80ff",fg:"#e7eeff"},{bg:"#27418f",fg:"#d2ddff"},{bg:"#5b7cff",fg:"#e9efff"},{bg:"#1a3fb5",fg:"#d8e2ff"}];function ke(t,e){const a=Z[e%Z.length],o=7.2+e%3*.5,s=14.5+e%4*.8,n=19.5-e%3*.3;return`
    ...
    </article>`}function Ae(){const t=we.map((e,a)=>{const o=e.map(Ee).join("");return`
    ...
    <div class="container">
      ...
      <div class="case-study reveal" style="transition-delay:0.1s;">
        ...
        <aside class="case-study-side">
          ...
          <a href="https://sondertraininggroup.com/" target="_blank" rel="noopener" class="btn btn-secondary btn-sm case-study-link">Visit the live site ${g.arrow}</a>
        </aside>
      </div>
            ...
            <div class="contact-methods">
              <a href="tel:+971502446531" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${g.phone}</svg>
                </div>
                <div>
  ...
  </div>`}function le(t,e,a){const o=a.map(s=>`
  ...
  <section class="faq-section">
    ...
    <div class="faq-list reveal">${ce.map(e=>`
  ...
  `}const de={home:Ce,pricing:Se,work:Be,contact:Le,testimonials:Ie,booking:$e,booked:Pe,"booking-new":qe,"meta-ads":Te,terms:Me,privacy:De},ee={...z.pages,work:{title:"Our Work | Atlantic Bear Portfolio",desc:"Explore custom websites designed and developed for UAE businesses. Professional layouts, mobile optimization, and fast load times."},booked:{title:"Call Confirmed | Atlantic Bear",desc:"Your call is locked in. Add the event to your calendar and watch the pre-call video before our session."},"booking-new":{title:"Book a Call | Atlantic Bear Discovery Session",desc:"Tell us about your business and schedule a 30-minute discovery call. Start your UAE website project today."}};function Ue(t){const e=document.getElementById("faq-schema");if(e&&e.remove(),t!=="contact")return;const a=document.createElement("script");a.type="application/ld+json",a.id="faq-schema",a.textContent=JSON.stringify({"@context":"https://schema.org","@type":"FAQPage",mainEntity:ce.map(o=>({"@type":"Question",name:o.q,acceptedAnswer:{"@type":"Answer",text:o.a}}))}),document.head.appendChild(a)}function Oe(t){const e=ee[t]||ee.home;document.title=e.title,Ue(t);let a=document.querySelector('meta[name="description"]');a||(a=document.createElement("meta"),a.setAttribute("name","description"),document.head.appendChild(a)),a.setAttribute("content",e.desc);let o=document.querySelector('link[rel="canonical"]');o||(o=document.createElement("link"),o.setAttribute("rel","canonical"),document.head.appendChild(o));const s=`${window.location.origin}${t==="home"?"":"/"+t}`;o.setAttribute("href",s);const n={"og:title":e.title,"og:description":e.desc,"og:url":s,"og:type":"website","og:image":`${window.location.origin}${z.site.ogImage}`};for(const[f,w]of Object.entries(n)){let v=document.querySelector(`meta[property="${f}"]`);v||(v=document.createElement("meta"),v.setAttribute("property",f),document.head.appendChild(v)),v.setAttribute("content",w)}const h={"twitter:card":"summary_large_image","twitter:title":e.title,"twitter:description":e.desc,"twitter:image":`${window.location.origin}${z.site.ogImage}`};for(const[f,w]of Object.entries(h)){let v=document.querySelector(`meta[name="${f}"]`);v||(v=document.createElement("meta"),v.setAttribute("name",f),document.head.appendChild(v)),v.setAttribute("content",w)}}function te(t){const e=t.replace(/^\/|\/$/g,"");return e==="pricing"||e==="work"||e==="contact"||e==="testimonials"||e==="booking"||e==="booking-new"||e==="meta-ads"||e==="booked"||e==="terms"||e==="privacy"?e:"home"}function Re(t){Q("#main-nav [data-link]").forEach(a=>a.classList.remove("active"));const e=K(`#main-nav [data-link="${t}"].nav-link`);e&&e.classList.add("active")}const Fe=[".section-title",".section-sub",".facts-headline",".fact-hero-block",".facts-stat-block",".basic-system-card",".step",".feature-item",".teaser-card",".tier-card",".level-one-card",".pricing-plan-card",".guarantee-card",".pricing-bonus-block",".problem-card",".contact-method",".contact-form-card",".cc-copy",".cc-visual",".reviews-head",".competitor-banner-text",".meta-ads-teaser-box"].join(",");function _e(){Array.from(document.querySelectorAll(Fe)).forEach(e=>{if(e.classList.contains("reveal")||e.classList.contains("revealed"))return;e.classList.add("reveal");const a=e.parentElement;if(!a)return;const s=Array.from(a.children).filter(n=>n.classList.contains("reveal")).indexOf(e);s>0&&!e.style.transitionDelay&&(e.style.transitionDelay=`${Math.min(s*.07,.35)}s`)})}function je(){const t=Q(".reveal"),e=new IntersectionObserver(a=>{a.forEach(o=>{o.isIntersecting&&(o.target.classList.add("revealed"),e.unobserve(o.target))})},{threshold:.07,rootMargin:"0px 0px -30px 0px"});t.forEach(a=>e.observe(a))}function Ne(t){const e=t.innerHTML,a=(t.textContent||"").trim();if(!a)return;t.textContent="",t.classList.add("is-typing");let o=0;const s=()=>{o+=1,t.textContent=a.slice(0,o),o<a.length?window.setTimeout(s,105):(t.innerHTML=e,t.classList.remove("is-typing"))};window.setTimeout(s,90)}function He(){const t=Q(".fact-hero-num, .facts-stat-num");if(!t.length||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;t.forEach(a=>{a.style.minHeight=`${a.getBoundingClientRect().height}px`});const e=new IntersectionObserver(a=>{a.forEach((o,s)=>{if(!o.isIntersecting)return;const n=o.target;e.unobserve(n),window.setTimeout(()=>Ne(n),s*150)})},{threshold:.4});t.forEach(a=>e.observe(a))}function Ye(){const t=document.getElementById("contact-form");if(!t)return;const e=document.createElement("script");e.src="https://unpkg.com/@formspree/ajax@1",e.defer=!0,document.head.appendChild(e),e.onload=()=>{window.formspree&&window.formspree("initForm",{formElement:"#contact-form",formId:"mykanvrr"})},t.addEventListener("submit",async a=>{a.preventDefault();const o=document.getElementById("form-submit-btn"),s=document.querySelector("[data-fs-success]"),n=document.querySelector('[data-fs-error]:not([data-fs-error="name"]):not([data-fs-error="email"]):not([data-fs-error="message"])');o&&(o.disabled=!0,o.textContent="Sending...");try{const h=await ie("contact_submit"),f=new FormData(t);if(h&&f.append("g-recaptcha-response",h),(await fetch("https://formspree.io/f/mykanvrr",{method:"POST",body:f,headers:{Accept:"application/json"}})).ok)t.style.display="none",s&&(s.style.display="block",s.style.textAlign="center",s.style.padding="18px",s.style.background="rgba(62,207,142,.07)",s.style.borderRadius="10px",s.style.border="1px solid rgba(62,207,142,.20)");else throw new Error("Server error")}catch{n&&(n.textContent="Something went wrong. Please try again or email officialatlanticbear@gmail.com.",n.style.color="var(--red)",n.style.fontSize="0.85rem",n.style.marginTop="8px"),o&&(o.disabled=!1,o.textContent="Try again")}})}function J(t){window.getComputedStyle(t).position==="static"&&(t.style.position="relative");const a=document.createElement("div");a.className="calendly-spinner-wrap",a.style.display="flex",a.style.justifyContent="center",a.style.alignItems="center",a.style.position="absolute",a.style.top="50%",a.style.left="50%",a.style.transform="translate(-50%, -50%)",a.style.pointerEvents="none",a.style.zIndex="1",a.innerHTML=`
  ...
  `,t.appendChild(a);const o=new MutationObserver(()=>{const s=t.querySelector("iframe");s&&(s.style.position="relative",s.style.zIndex="2",s.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),o.disconnect())});o.observe(t,{childList:!0})}function Ve(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),o=e.querySelector("video");a&&o&&a.addEventListener("click",s=>{s.stopPropagation(),o.muted=!1,o.currentTime=0,o.controls=!0,a.style.display="none",o.play().catch(n=>{console.error("Play failed:",n)})})})}function ze(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",J(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const o=document.createElement("script");o.id="calendly-sdk",o.src="https://assets.calendly.com/assets/external/widget.js",o.async=!0,o.addEventListener("load",e,{once:!0}),document.head.appendChild(o)}}function Ge(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),o=document.getElementById("bv-play-btn"),s=document.getElementById("bv-controls"),n=document.getElementById("bv-playpause"),h=document.getElementById("bv-progress-fill"),f=document.getElementById("bv-progress-thumb"),w=document.getElementById("bv-progress-wrap"),v=document.getElementById("bv-time"),W=document.getElementById("bv-mute"),y=document.getElementById("bv-volume"),c=document.getElementById("bv-fullscreen"),d=document.getElementById("custom-video-wrap");if(!e||!a||!o||!s||!n)return;e.volume=.9;let C=null,E=null;const k=()=>{try{const i=window.AudioContext||window.webkitAudioContext;if(!i)return;if(!C){C=new i;const r=C.createMediaElementSource(e);E=C.createGain(),E.gain.value=2,r.connect(E),E.connect(C.destination)}C.state==="suspended"&&C.resume()}catch(i){console.warn("AudioContext boost failed:",i)}},I=e.getAttribute("data-src"),P=()=>{I&&!e.getAttribute("src")&&(e.setAttribute("src",I),e.load())};let A=!0;const $=5,q=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{A&&e.currentTime>=$&&(e.currentTime=0)}),setTimeout(q,800);const M=i=>{const r=Math.floor(i/60),l=Math.floor(i%60);return`${r}:${l.toString().padStart(2,"0")}`},T=90,S=60,U=(i,r)=>!t||r<=T?i/r*100:i<=T?i/T*S:S+(i-T)/(r-T)*(100-S),O=(i,r)=>!t||r<=T?i/100*r:i<=S?i/S*T:T+(i-S)/(100-S)*(r-T),R=()=>{if(!e.duration)return;const i=U(e.currentTime,e.duration);h&&(h.style.width=i+"%"),f&&(f.style.left=i+"%"),v&&(v.textContent=`${M(e.currentTime)} / ${M(e.duration)}`)},D=i=>{const r=n==null?void 0:n.querySelector(".icon-play"),l=n==null?void 0:n.querySelector(".icon-pause");r&&(r.style.display=i&&!A?"none":"block"),l&&(l.style.display=i&&!A?"block":"none"),a&&(a.style.display=i&&!A?"none":"flex"),d&&(i&&!A?d.classList.add("playing"):d.classList.remove("playing"))};a.addEventListener("click",()=>{if(A){A=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0}P(),k(),D(!0),e.play()}),e.addEventListener("click",()=>{if(A){A=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0,k(),D(!0),e.play();return}P(),k(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>D(!0)),e.addEventListener("pause",()=>D(!1)),e.addEventListener("ended",()=>D(!1)),e.addEventListener("timeupdate",R),e.addEventListener("loadedmetadata",R);let p=!1;const m={m25:!1,m50:!1,m75:!1,m100:!1},u={};if(e.addEventListener("timeupdate",()=>{const i=e.duration;if(!i)return;const r=e.currentTime,l=r/i*100;!p&&r>.5&&(p=!0,B("videoplay")),l>=25&&!m.m25&&(m.m25=!0,B("videowatch_25pct")),l>=50&&!m.m50&&(m.m50=!0,B("videowatch_50pct")),l>=75&&!m.m75&&(m.m75=!0,B("videowatch_75pct")),l>=98&&!m.m100&&(m.m100=!0,B("videowatch_complete"));const b=[10,30],L=Math.floor(r);b.forEach(x=>{L>=x&&!u[x]&&(u[x]=!0,B(`videowatch_${x}s`))})}),n.addEventListener("click",()=>{P(),k(),e.paused?e.play():e.pause()}),w){const i=l=>{const b=w.getBoundingClientRect(),L=l instanceof MouseEvent?l.clientX:l.touches[0].clientX,x=Math.max(0,Math.min(100,(L-b.left)/b.width*100));e.currentTime=O(x,e.duration),R()};let r=!1;w.addEventListener("mousedown",l=>{r=!0,i(l)}),window.addEventListener("mousemove",l=>{r&&i(l)}),window.addEventListener("mouseup",()=>{r=!1}),w.addEventListener("touchstart",l=>i(l),{passive:!0}),w.addEventListener("touchmove",l=>i(l),{passive:!0})}if(y&&y.addEventListener("input",()=>{e.volume=parseFloat(y.value),e.muted=e.volume===0}),W&&W.addEventListener("click",()=>{e.muted=!e.muted,y&&(y.value=e.muted?"0":String(e.volume||1))}),c&&d&&c.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():d.requestFullscreen?d.requestFullscreen():d.webkitRequestFullscreen?d.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),d){let i;const r=()=>{s.style.opacity="1",clearTimeout(i),i=window.setTimeout(()=>{e.paused||(s.style.opacity="0")},2500)};d.addEventListener("mousemove",r),d.addEventListener("mouseenter",r),d.addEventListener("mouseleave",()=>{e.paused||(s.style.opacity="0")}),e.addEventListener("play",()=>{i=window.setTimeout(()=>{s.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{s.style.opacity="1",clearTimeout(i)})}}function Ke(){const t=document.getElementById("booking-modal"),e=document.getElementById("book-demo-btn-v2"),a=document.getElementById("booking-modal-close-btn"),o=document.getElementById("modal-step-1"),s=document.getElementById("modal-step-2"),n=document.getElementById("modal-step-3"),h=document.getElementById("modal-step-num"),f=document.getElementById("modal-step-title"),w=document.getElementById("modal-step-badge"),v=document.getElementById("modal-progress-bar"),W=document.getElementById("modal-step1-form"),y=document.getElementById("modal-input-name"),c=document.getElementById("modal-input-phone"),d=document.getElementById("modal-step1-error"),C=document.getElementById("modal-confirm-pricing-link");if(!t||!a)return;t.parentElement!==document.body&&document.body.appendChild(t);let E="",k="",I="";y&&localStorage.getItem("feather_booking_name")&&(y.value=localStorage.getItem("feather_booking_name")||""),c&&localStorage.getItem("feather_booking_phone")&&(c.value=localStorage.getItem("feather_booking_phone")||"");const P=document.getElementById("phone-flag-prefix"),A={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},$=()=>{if(!P||!c)return;const p=c.value.trim();let m="🇦🇪";for(const[u,i]of Object.entries(A))if(p.startsWith(u)){m=i;break}P.textContent=m},q=()=>{if(!c)return;let p=c.value,m="";for(const b of Object.keys(A))if(p.startsWith(b)){m=b+" ";break}if(!m&&p.startsWith("+")){const b=p.indexOf(" ");if(b>0)m=p.substring(0,b+1);else{const L=p.match(/^\+\d+/);L&&(m=L[0]+" ")}}const i=p.substring(m.length).replace(/\D/g,"").substring(0,9);let r="";i.length>0&&(i.length<=2?r=i:i.length<=5?r=`${i.substring(0,2)} ${i.substring(2)}`:r=`${i.substring(0,2)} ${i.substring(2,5)} ${i.substring(5)}`);const l=m+r;c.value!==l&&(c.value=l)};c&&((!c.value||c.value.trim()===""||c.value.trim()==="+971")&&(c.value="+971 "),c.addEventListener("input",p=>{const m=p;if(m.inputType&&m.inputType.startsWith("delete")){$();return}q(),$()}),$());const M=()=>{if(!E||!k)return;const p=`${E}|${k}`;if(I===p)return;I=p;const m=document.getElementById("modal-calendly-container");if(!m)return;m.innerHTML="",J(m);const r={url:`https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff&name=${encodeURIComponent(E)}&a1=${encodeURIComponent(k)}`,parentElement:m,prefill:{name:E,customAnswers:{a1:k}}},l=()=>window.Calendly.initInlineWidget(r);if(window.Calendly)l();else{const b=document.getElementById("calendly-sdk");b&&b.addEventListener("load",l,{once:!0})}},T=()=>{const p=(y==null?void 0:y.value.trim())||"",m=(c==null?void 0:c.value.trim())||"";p.length>=3&&m.length>=5&&(E=p,k=m,M())};y==null||y.addEventListener("input",T),c==null||c.addEventListener("input",T),T();const S=p=>{p===1?(o&&(o.style.display="block"),s&&(s.style.display="none"),n&&(n.style.display="none"),h&&(h.textContent="1"),f&&(f.textContent="Tell us about yourself"),w&&(w.style.display="inline"),v&&(v.style.width="50%")):p===2?(o&&(o.style.display="none"),s&&(s.style.display="block"),n&&(n.style.display="none"),h&&(h.textContent="2"),f&&(f.textContent="Schedule your demo call"),w&&(w.style.display="inline"),v&&(v.style.width="100%"),E=(y==null?void 0:y.value.trim())||"",k=(c==null?void 0:c.value.trim())||"",M()):p===3&&(o&&(o.style.display="none"),s&&(s.style.display="none"),n&&(n.style.display="block"),f&&(f.textContent="Call Confirmed!"),w&&(w.style.display="none"),v&&(v.style.width="100%"))},U=()=>{t.classList.add("active"),document.body.style.overflow="hidden",d&&(d.style.display="none"),I="",y&&localStorage.getItem("feather_booking_name")&&(y.value=localStorage.getItem("feather_booking_name")||""),c&&localStorage.getItem("feather_booking_phone")&&(c.value=localStorage.getItem("feather_booking_phone")||""),S(1)},O=()=>{t.classList.remove("active"),document.body.style.overflow=""},R=p=>{p&&p.preventDefault();const m=(y==null?void 0:y.value.trim())||"",u=(c==null?void 0:c.value.trim())||"";if(!m||!u){d&&(d.style.display="block");return}const i=m.split(" ").map(r=>r.charAt(0).toUpperCase()+r.slice(1)).join(" ");d&&(d.style.display="none"),E=i,k=u,S(2)};W&&W.addEventListener("submit",R),e&&e.addEventListener("click",U),a.addEventListener("click",O),t.addEventListener("click",p=>{p.target===t&&O()});const D=p=>{p.key==="Escape"&&t.classList.contains("active")&&O()};window.addEventListener("keydown",D),C&&C.addEventListener("click",p=>{p.preventDefault(),O(),j("pricing",!0)}),window.goToBookingStep=S,window.openBookingModal=U}let ue=!0;function Qe(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn"),a=document.getElementById("strat-modal-step-1"),o=document.getElementById("strat-modal-step-2"),s=document.getElementById("strat-modal-step-3"),n=document.getElementById("strat-modal-step-4"),h=document.getElementById("strat-modal-step-num"),f=document.getElementById("strat-modal-step-title"),w=document.getElementById("strat-modal-step-badge"),v=document.getElementById("strat-modal-progress-bar"),W=document.getElementById("strat-modal-step1-form"),y=document.getElementById("strat-modal-step2-form"),c=document.getElementById("strat-input-name"),d=document.getElementById("strat-input-phone"),C=document.getElementById("strat-input-business"),E=document.getElementById("strat-select-revenue"),k=document.getElementById("strat-modal-step1-error"),I=document.getElementById("strat-modal-step2-error"),P=document.getElementById("strat-modal-confirm-pricing-link");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);let A="",$="",q="",M="";const T={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},S=document.getElementById("strat-phone-flag-prefix"),U=()=>{if(!S||!d)return;const u=d.value.trim();let i="🇦🇪";for(const[r,l]of Object.entries(T))if(u.startsWith(r)){i=l;break}S.textContent=i},O=()=>{if(!d)return;let u=d.value,i="";for(const x of Object.keys(T))if(u.startsWith(x)){i=x+" ";break}if(!i&&u.startsWith("+")){const x=u.indexOf(" ");if(x>0)i=u.substring(0,x+1);else{const N=u.match(/^\+\d+/);N&&(i=N[0]+" ")}}const l=u.substring(i.length).replace(/\D/g,"").substring(0,9);let b="";l.length>0&&(l.length<=2?b=l:l.length<=5?b=`${l.substring(0,2)} ${l.substring(2)}`:b=`${l.substring(0,2)} ${l.substring(2,5)} ${l.substring(5)}`);const L=i+b;d.value!==L&&(d.value=L)};d&&(d.addEventListener("input",u=>{const i=u;if(i.inputType&&i.inputType.startsWith("delete")){U();return}O(),U()}),U());const R=()=>{c&&(c.value=""),d&&(d.value="+971 "),C&&(C.value=""),E&&(E.value=""),k&&(k.style.display="none"),I&&(I.style.display="none"),p(1),t.classList.add("active"),document.body.style.overflow="hidden"},D=()=>{t.classList.remove("active"),document.body.style.overflow=""},p=u=>{!a||!o||!s||!n||!h||!f||!w||!v||(u===1?(a.style.display="block",o.style.display="none",s.style.display="none",n.style.display="none",w.style.display="inline",h.textContent="1",f.textContent="Tell us about yourself",v.style.width="33%"):u===2?(a.style.display="none",o.style.display="block",s.style.display="none",n.style.display="none",w.style.display="inline",h.textContent="2",f.textContent="Your business details",v.style.width="66%"):u===3?(a.style.display="none",o.style.display="none",s.style.display="block",n.style.display="none",w.style.display="inline",h.textContent="3",f.textContent="Schedule your strategy call",v.style.width="100%",m()):u===4&&(a.style.display="none",o.style.display="none",s.style.display="none",n.style.display="block",w.style.display="none",f.textContent="Call Scheduled!",v.style.width="100%"))},m=()=>{const u=document.getElementById("strat-modal-calendly-container");if(!u)return;const i=M==="Under AED 5k/month"||M==="Under $5k"||M==="$0 - $5k";ue=!i;const r=i?"https://calendly.com/officialatlanticbear/intro-call?hide_gdpr_banner=1&primary_color=3b69ff":"https://calendly.com/officialatlanticbear/strategy-call?hide_gdpr_banner=1&primary_color=3b69ff",l=M.replace(/–/g,"-").trim(),b=`${r}&name=${encodeURIComponent(A)}&a1=${encodeURIComponent($)}&a2=${encodeURIComponent(q)}&a3=${encodeURIComponent(l)}&a4=${encodeURIComponent(l)}`;u.innerHTML="",J(u);const L={url:b,parentElement:u,prefill:{name:A,customAnswers:{a1:$,a2:q,a3:l,a4:l,a5:l}}},x=()=>window.Calendly.initInlineWidget(L);if(window.Calendly)x();else{const N=document.getElementById("calendly-sdk");N&&N.addEventListener("load",x,{once:!0})}};W&&W.addEventListener("submit",u=>{u.preventDefault();const i=(c==null?void 0:c.value.trim())||"",r=(d==null?void 0:d.value.trim())||"";if(!i||!r){k&&(k.style.display="block");return}k&&(k.style.display="none"),A=i,$=r.replace(/\s+/g,""),p(2)}),y&&y.addEventListener("submit",async u=>{u.preventDefault();const i=(C==null?void 0:C.value.trim())||"",r=(E==null?void 0:E.value)||"";if(!i||!r){I&&(I.style.display="block");return}if(I&&(I.style.display="none"),q=i,M=r,!(r==="Under AED 5k/month"||r==="Under $5k"||r==="$0 - $5k")){const b=document.getElementById("strat-modal-step2-submit-btn");b&&(b.disabled=!0,b.textContent="Verifying...");const L=await ie("booking_submit");fetch("https://script.google.com/macros/s/AKfycbxhmc6G4n4zpk0SGvjzP81_Cd9ipLxM3Wx5MZNWzF02tBqqUMD0JCAuDnH1OojQfv7vJQ/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({action:"form_submit",name:A,phone:$,business:q,revenue:M,source:"strategy_call",recaptchaToken:L||""})}).catch(x=>console.error("Google Sheet submission failed:",x)),b&&(b.disabled=!1,b.textContent="Continue to Calendar →")}p(3)}),e.addEventListener("click",D),window.addEventListener("keydown",u=>{u.key==="Escape"&&t.classList.contains("active")&&D()}),P&&P.addEventListener("click",u=>{u.preventDefault(),D(),j("pricing",!0)}),window.goToStratBookingStep=p,window.openStratBookingModal=R}const ae=["home","pricing","work","testimonials","meta-ads","contact","booking","booking-new","booked"];let V=null;function j(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const o=document.getElementById("strat-booking-modal");o&&o.remove(),document.body.style.overflow="",ne(),re();const s=document.getElementById("main-nav"),n=document.querySelector(".site-footer");t==="booking"||t==="booked"?(s&&(s.style.display="none"),n&&(n.style.display="none")):(s&&(s.style.display=""),n&&(n.style.display=""));const h=K("#main-content"),f=V?ae.indexOf(V):-1,w=ae.indexOf(t),v=f===-1||w>=f,W=v?"-8%":"8%",y=v?"8%":"-8%";V=t;const c=window.matchMedia("(prefers-reduced-motion: reduce)").matches;h.style.transition=c?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",h.style.opacity="0",c||(h.style.transform=`translateX(${W})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),h.style.transition="none",c||(h.style.transform=`translateX(${y})`),h.innerHTML=de[t](),Re(t),requestAnimationFrame(()=>{h.style.transition=c?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",h.style.opacity="1",h.style.transform="translateX(0)"}),_e(),je(),He(),t==="contact"&&Ye(),(t==="booking"||t==="booked"||t==="booking-new")&&(B("pageload",2e3),he(),ve(),ze(),Ge(t==="booking"||t==="booked"),t==="booking-new"?(Ke(),document.querySelectorAll(".funnel-cta-btn").forEach(d=>{d.addEventListener("click",()=>{window.openBookingModal&&window.openBookingModal()})})):t==="booking"&&(Qe(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(d=>{d.addEventListener("click",()=>{window.openStratBookingModal&&window.openStratBookingModal()})}))),Oe(t),Ve(),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&window.fbq("track","PageView"),e){const d=t==="home"?"/":`/${t}`;window.location.pathname!==d&&history.pushState(null,"",d)}},260)}function Je(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const o=a.getAttribute("data-link");o&&de[o]&&j(o)})}function Xe(){const t=K("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{new URLSearchParams(window.location.search).get("notrack")==="1"&&sessionStorage.setItem("notrack","1");const t=document.getElementById("app");t.innerHTML=`
    ${fe()}
  ...
  `,Je(t),Xe(),oe(),window.addEventListener("message",a=>{if(!a.origin||!a.origin.includes("calendly.com"))return;let o=!1;if(a&&a.data){let s=a.data;if(typeof s=="string")try{s=JSON.parse(s)}catch{}typeof s=="object"&&s&&s.event==="calendly.event_scheduled"&&(o=!0)}if(o){const s=document.getElementById("strat-booking-modal"),n=document.getElementById("booking-modal");s&&s.classList.contains("active")?(ue?(B("bookedcall_strategy"),typeof window.fbq=="function"&&!sessionStorage.getItem("fbq_schedule_fired")&&!sessionStorage.getItem("notrack")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1"))):B("bookedcall_intro"),s&&s.classList.remove("active")):(B("bookedcall"),n&&n.classList.remove("active")),document.body.style.overflow="",j("booked")}});const e=te(window.location.pathname);j(e,!1),window.addEventListener("popstate",()=>{const a=te(window.location.pathname);j(a,!1)})});
