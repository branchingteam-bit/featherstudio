(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(o){if(o.ep)return;o.ep=!0;const i=a(o);fetch(o.href,i)}})();const re={ogImage:"/og-image.png"},H={site:re},$=(t,e=document)=>e.querySelector(t),F=(t,e=document)=>[...e.querySelectorAll(t)],G="atlanticbear_analytics_8d24";function S(){if(sessionStorage.getItem("notrack"))return!0;try{if(new URLSearchParams(window.location.search).get("preview")==="true")return!0}catch{}return!1}function g(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${G}/${t}`).catch(()=>{});try{const s=de();fetch(`https://abacus.jasoncameron.dev/hit/${G}/${s}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}let U={};function le(){Q();const t=e=>{U[`t${e}`]=window.setTimeout(()=>{g(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function Q(){Object.values(U).forEach(clearTimeout),U={}}let A={moved:!1,calendar:!1,testimonials:!1},B=null;function ce(){X(),A={moved:!1,video:!1,calendar:!1,testimonials:!1},B=()=>{window.scrollY>50&&!A.moved&&(A.moved=!0,g("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!A.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(A.calendar=!0,g("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!A.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(A.testimonials=!0,g("scroll_testimonials"))},window.addEventListener("scroll",B,{passive:!0})}function X(){B&&(window.removeEventListener("scroll",B),B=null)}function de(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}const c={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function ue(){return`
  <nav class="nav" id="main-nav">
    ...
    <div class="nav-actions">
      <a href="/booking" class="btn btn-primary btn-sm btn-pulse" data-link="booking" id="nav-book-cta">Book a Call ${c.arrow}</a>
    </div>
    ...
    <div class="container">
      <div class="cc-grid">
        ...
        <div class="cc-copy reveal">
          <span class="cc-badge">${c.code} How we build</span>
    ...
    <div class="container">
      ...
      <div class="reveal" style="text-align: center; margin-top: 48px;">
        <a href="/booking" class="btn btn-primary btn-large btn-pulse" data-link="booking">
          Get Started with Market Leader ${c.arrow}
        </a>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="feature-grid">
        <div class="feature-item reveal">
          <div class="feature-icon-wrap">${c.globe}</div>
        ...
        <div class="feature-item reveal">
          <div class="feature-icon-wrap">${c.star}</div>
        ...
        <div class="feature-item reveal">
          <div class="feature-icon-wrap">${c.shield}</div>
        ...
        <div class="feature-item reveal">
          <div class="feature-icon-wrap">${c.phone}</div>
        ...
        <div class="feature-item reveal">
          <div class="feature-icon-wrap">${c.rocket}</div>
        ...
        <div class="feature-item reveal" style="display:flex; flex-direction:column; justify-content:center; background:var(--surface);">
          ...
          <a href="/booking" class="btn btn-primary btn-sm" data-link="booking" style="align-self:flex-start;">Book a Call ${c.arrow}</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="feature-grid" style="grid-template-columns: repeat(2, 1fr); max-width: 900px; margin: 0 auto;">
        <div class="feature-item reveal" style="border-right: 1px solid var(--border); border-bottom: 1px solid var(--border);">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${c.zap}</div>
        ...
        <div class="feature-item reveal" style="border-right: none; border-bottom: 1px solid var(--border);">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${c.star}</div>
        ...
        <div class="feature-item reveal" style="border-right: 1px solid var(--border); border-bottom: none;">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${c.phone}</div>
        ...
        <div class="feature-item reveal" style="border-right: none; border-bottom: none;">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${c.rocket}</div>
    ...
    <div class="container">
      ...
      <div class="case-study reveal" style="transition-delay:0.12s;">
        ...
        <aside class="case-study-side">
          ...
          <a href="https://sondertraininggroup.com/" target="_blank" rel="noopener" class="btn btn-secondary btn-sm case-study-link">Visit the live site ${c.arrow}</a>
        </aside>
      </div>
            ...
            <div class="contact-methods">
              <a href="tel:+971502446531" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${c.phone}</svg>
                </div>
                <div>
              ...
              <a href="mailto:officialatlanticbear@gmail.com" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${c.mail}</svg>
                </div>
                <div>
              ...
              <a href="https://www.instagram.com/officialatlanticbear/" target="_blank" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${c.instagram}</svg>
                </div>
                <div>
              ...
              <div class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${c.map}</svg>
                </div>
                <div>
  ...
  </div>`}function J(t,e,a){const s=a.map(o=>`
  ...
  `,t.appendChild(a);const s=new MutationObserver(()=>{const o=t.querySelector("iframe");o&&(o.style.position="relative",o.style.zIndex="2",o.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),s.disconnect())});s.observe(t,{childList:!0})}function Re(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),s=e.querySelector("video");a&&s&&a.addEventListener("click",o=>{o.stopPropagation(),s.muted=!1,s.currentTime=0,s.controls=!0,a.style.display="none",s.play().catch(i=>{console.error("Play failed:",i)})})})}function Ne(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",ae(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const s=document.createElement("script");s.id="calendly-sdk",s.src="https://assets.calendly.com/assets/external/widget.js",s.async=!0,s.addEventListener("load",e,{once:!0}),document.head.appendChild(s)}}function Ye(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),s=document.getElementById("bv-play-btn"),o=document.getElementById("bv-controls"),i=document.getElementById("bv-playpause"),r=document.getElementById("bv-progress-fill"),p=document.getElementById("bv-progress-thumb"),l=document.getElementById("bv-progress-wrap"),m=document.getElementById("bv-time"),h=document.getElementById("bv-mute"),w=document.getElementById("bv-volume"),f=document.getElementById("bv-fullscreen"),v=document.getElementById("custom-video-wrap");if(!e||!a||!s||!o||!i)return;e.volume=.9;let k=null,L=null;const I=()=>{try{const n=window.AudioContext||window.webkitAudioContext;if(!n)return;if(!k){k=new n;const d=k.createMediaElementSource(e);L=k.createGain(),L.gain.value=2,d.connect(L),L.connect(k.destination)}k.state==="suspended"&&k.resume()}catch(n){console.warn("AudioContext boost failed:",n)}},z=e.getAttribute("data-src"),P=()=>{z&&!e.getAttribute("src")&&(e.setAttribute("src",z),e.load())};let y=!0;const se=5,oe=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{y&&e.currentTime>=se&&(e.currentTime=0)}),setTimeout(oe,800);const R=n=>{const d=Math.floor(n/60),u=Math.floor(n%60);return`${d}:${u.toString().padStart(2,"0")}`},x=90,E=60,ie=(n,d)=>!t||d<=x?n/d*100:n<=x?n/x*E:E+(n-x)/(d-x)*(100-E),ne=(n,d)=>!t||d<=x?n/100*d:n<=E?n/E*x:x+(n-E)/(100-E)*(d-x),M=()=>{if(!e.duration)return;const n=ie(e.currentTime,e.duration);r&&(r.style.width=n+"%"),p&&(p.style.left=n+"%"),m&&(m.textContent=`${R(e.currentTime)} / ${R(e.duration)}`)},T=n=>{const d=i==null?void 0:i.querySelector(".icon-play"),u=i==null?void 0:i.querySelector(".icon-pause");d&&(d.style.display=n&&!y?"none":"block"),u&&(u.style.display=n&&!y?"block":"none"),a&&(a.style.display=n&&!y?"none":"flex"),v&&(n&&!y?v.classList.add("playing"):v.classList.remove("playing"))};a.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const n=e.src.split("#")[0];e.src!==n&&(e.src=n,e.load()),e.currentTime=0}P(),I(),T(!0),e.play()}),e.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const n=e.src.split("#")[0];e.src!==n&&(e.src=n,e.load()),e.currentTime=0,I(),T(!0),e.play();return}P(),I(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>T(!0)),e.addEventListener("pause",()=>T(!1)),e.addEventListener("ended",()=>T(!1)),e.addEventListener("timeupdate",M),e.addEventListener("loadedmetadata",M);let N=!1,Y=!1;const b={m25:!1,m50:!1,m75:!1,m95:!1,m100:!1},j={};if(e.addEventListener("play",()=>{!Y&&!y&&(Y=!0,typeof window.fbq=="function"&&!S()&&window.fbq("trackCustom","VSL_Play"))}),e.addEventListener("timeupdate",()=>{const n=e.duration;if(!n)return;const d=e.currentTime,u=d/n*100;if(!N&&d>.5&&!y&&(N=!0,g("videoplay")),y)return;u>=25&&!b.m25&&(b.m25=!0,g("videowatch_25pct"),typeof window.fbq=="function"&&!S()&&window.fbq("trackCustom","VSL_25")),u>=50&&!b.m50&&(b.m50=!0,g("videowatch_50pct"),typeof window.fbq=="function"&&!S()&&window.fbq("trackCustom","VSL_50")),u>=75&&!b.m75&&(b.m75=!0,g("videowatch_75pct"),typeof window.fbq=="function"&&!S()&&window.fbq("trackCustom","VSL_75")),u>=95&&!b.m95&&(b.m95=!0,typeof window.fbq=="function"&&!S()&&window.fbq("trackCustom","VSL_95")),u>=98&&!b.m100&&(b.m100=!0,g("videowatch_complete"));const W=[10,30],q=Math.floor(d);W.forEach(C=>{q>=C&&!j[C]&&(j[C]=!0,g(`videowatch_${C}s`))})}),i.addEventListener("click",()=>{P(),I(),e.paused?e.play():e.pause()}),l){const n=u=>{const W=l.getBoundingClientRect(),q=u instanceof MouseEvent?u.clientX:u.touches[0].clientX,C=Math.max(0,Math.min(100,(q-W.left)/W.width*100));e.currentTime=ne(C,e.duration),M()};let d=!1;l.addEventListener("mousedown",u=>{d=!0,n(u)}),window.addEventListener("mousemove",u=>{d&&n(u)}),window.addEventListener("mouseup",()=>{d=!1}),l.addEventListener("touchstart",u=>n(u),{passive:!0}),l.addEventListener("touchmove",u=>n(u),{passive:!0})}if(w&&w.addEventListener("input",()=>{e.volume=parseFloat(w.value),e.muted=e.volume===0}),h&&h.addEventListener("click",()=>{e.muted=!e.muted,w&&(w.value=e.muted?"0":String(e.volume||1))}),f&&v&&f.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():v.requestFullscreen?v.requestFullscreen():v.webkitRequestFullscreen?v.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),v){let n;const d=()=>{o.style.opacity="1",clearTimeout(n),n=window.setTimeout(()=>{e.paused||(o.style.opacity="0")},2500)};v.addEventListener("mousemove",d),v.addEventListener("mouseenter",d),v.addEventListener("mouseleave",()=>{e.paused||(o.style.opacity="0")}),e.addEventListener("play",()=>{n=window.setTimeout(()=>{o.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{o.style.opacity="1",clearTimeout(n)})}}function je(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);const a=()=>{const i=document.getElementById("strat-modal-calendly-container");if(!i)return;const r="https://calendly.com/officialatlanticbear/strategy-call?hide_gdpr_banner=1&primary_color=3b69ff";i.innerHTML="",ae(i);const p=()=>window.Calendly.initInlineWidget({url:r,parentElement:i});if(window.Calendly)p();else{const l=document.getElementById("calendly-sdk");l&&l.addEventListener("load",p,{once:!0})}},s=()=>{t.classList.add("active"),document.body.style.overflow="hidden",a()},o=()=>{t.classList.remove("active"),document.body.style.overflow=""};e.addEventListener("click",o),window.addEventListener("keydown",i=>{i.key==="Escape"&&t.classList.contains("active")&&o()}),window.openStratBookingModal=s}const K=["home","pricing","testimonials","meta-ads","contact","booking","booked"];let O=null;function D(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const s=document.getElementById("strat-booking-modal");s&&s.remove(),document.body.style.overflow="",Q(),X();const o=document.getElementById("main-nav"),i=document.querySelector(".site-footer");t==="booking"?(o&&(o.style.display="none"),i&&(i.style.display="none")):(o&&(o.style.display=""),i&&(i.style.display=""));const r=$("#main-content"),p=O?K.indexOf(O):-1,l=K.indexOf(t),m=p===-1||l>=p,h=m?"-8%":"8%",w=m?"8%":"-8%";O=t;const f=window.matchMedia("(prefers-reduced-motion: reduce)").matches;r.style.transition=f?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",r.style.opacity="0",f||(r.style.transform=`translateX(${h})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),r.style.transition="none",f||(r.style.transform=`translateX(${w})`),r.innerHTML=te[t](),Me(t),requestAnimationFrame(()=>{r.style.transition=f?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",r.style.opacity="1",r.style.transform="translateX(0)"}),Oe(),Ue(),Fe(),t==="meta-ads-shazay"&&ze(),(t==="booking"||t==="booked")&&(g("pageload",2e3),le(),ce(),Ne(),Ye(t==="booking"),t==="booking"&&(je(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(v=>{v.addEventListener("click",()=>{typeof window.fbq=="function"&&!S()&&window.fbq("trackCustom","BookButtonClick"),window.openStratBookingModal&&window.openStratBookingModal()})}))),Pe(t),Re(),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&window.fbq("track","PageView"),e){const v=t==="home"?"/":`/${t}`;window.location.pathname!==v&&history.pushState(null,"",v)}},260)}function He(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const s=a.getAttribute("data-link");s&&te[s]&&D(s)})}function Ge(){const t=$("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}document.addEventListener("DOMContentLoaded",()=>{const t=new URLSearchParams(window.location.search);(t.get("notrack")==="1"||t.get("preview")==="true")&&sessionStorage.setItem("notrack","1");const e=t.get("fbclid"),a=(t.get("utm_source")||"").toLowerCase();(!!e||["facebook","instagram","fb","meta"].some(r=>a.includes(r)))&&sessionStorage.setItem("came_from_meta","1");const o=document.getElementById("app");o.innerHTML=`
    ${ue()}
