(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const he={ogImage:"/og-image.png"},Q={site:he},V=(t,e=document)=>e.querySelector(t),K=(t,e=document)=>[...e.querySelectorAll(t)],J="atlanticbear_analytics_8d24";function k(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${J}/${t}`).catch(()=>{});try{const s=ge();fetch(`https://abacus.jasoncameron.dev/hit/${J}/${s}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}const ae=window.RECAPTCHA_SITE_KEY||"6Ldfp-gqAAAAABpP_placeholder_key";function se(){const t=window.RECAPTCHA_SITE_KEY||ae;if(document.getElementById("recaptcha-v3-script"))return;const e=document.createElement("script");e.id="recaptcha-v3-script",e.src=`https://www.google.com/recaptcha/api.js?render=${encodeURIComponent(t)}`,e.async=!0,e.defer=!0,document.head.appendChild(e)}async function oe(t){const e=window.RECAPTCHA_SITE_KEY||ae;return se(),new Promise(a=>{const s=setTimeout(()=>{console.warn(`reCAPTCHA [${t}] timed out. Continuing submission.`),a(null)},2500),o=window.grecaptcha;if(o&&typeof o.ready=="function")try{o.ready(()=>{o.execute(e,{action:t}).then(n=>{clearTimeout(s),a(n)}).catch(n=>{clearTimeout(s),console.warn(`reCAPTCHA [${t}] execution error:`,n),a(null)})})}catch(n){clearTimeout(s),console.warn(`reCAPTCHA [${t}] error:`,n),a(null)}else clearTimeout(s),a(null)})}let _={};function me(){ie();const t=e=>{_[`t${e}`]=window.setTimeout(()=>{k(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function ie(){Object.values(_).forEach(clearTimeout),_={}}let $={moved:!1,calendar:!1,testimonials:!1},N=null;function ve(){ne(),$={moved:!1,video:!1,calendar:!1,testimonials:!1},N=()=>{window.scrollY>50&&!$.moved&&($.moved=!0,k("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!$.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&($.calendar=!0,k("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!$.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&($.testimonials=!0,k("scroll_testimonials"))},window.addEventListener("scroll",N,{passive:!0})}function ne(){N&&(window.removeEventListener("scroll",N),N=null)}function ge(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}const h={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function fe(){return`
  ...
  <section class="cc-section">
  ...
  </section>`}const G={quote:"We approached Alexi at Atlantic Bear, who was absolutely fantastic at putting together our ideas and bringing them across on the website in a way that really engaged our target market.",name:"Sonder Training Group",role:"Training Provider, UAE",avatar:0},O=[{quote:"Five days from the first call to a live site. I had budgeted two months, and half of that for arguing about revisions.",name:"Tom Whitfield",role:"Founder, Dental Clinic",avatar:1},{quote:"We now come up first for our category in Dubai. Enquiries through the site have roughly tripled since launch.",name:"Priya Nair",role:"Director, Facilities Services",avatar:2},{quote:"They asked good questions, then just built it. I approved two rounds of small tweaks and that was the whole process.",name:"Marcus Oyelaran",role:"Manager, Hospitality Group",avatar:3},{quote:"Most of our customers are on their phones and the old site was unusable there. The new one loads instantly.",name:"Yasmin Farouk",role:"Owner, Fitness Studio",avatar:4},{quote:"Handover was clean. Domain, hosting, files, all in our name from day one, exactly as they promised.",name:"Lena Vasquez",role:"Founder, E-commerce",avatar:5}],we=[[G,O[0],O[1]],[O[2],G,O[3]],[O[4],G,O[0]]],X=[{bg:"#3b69ff",fg:"#dfe8ff"},{bg:"#1e46c7",fg:"#d5e0ff"},{bg:"#6391ff",fg:"#eef3ff"},{bg:"#2a50e0",fg:"#dbe5ff"},{bg:"#142d80",fg:"#ccd9ff"},{bg:"#4a80ff",fg:"#e7eeff"},{bg:"#27418f",fg:"#d2ddff"},{bg:"#5b7cff",fg:"#e9efff"},{bg:"#1a3fb5",fg:"#d8e2ff"}];function ke(t,e){const a=X[e%X.length],s=7.2+e%3*.5,o=14.5+e%4*.8,n=19.5-e%3*.3;return`
    ...
    </article>`}function xe(){const t=we.map((e,a)=>{const s=e.map(Ee).join("");return`
  ...
  </div>`}function re(t,e,a){const s=a.map(o=>`
  ...
  </section>`}function ce(t){const e=t==="launch",a=e?"AED 3,500":"AED 6,500",s="AED 300",o=e?"AED 1,750":"AED 3,250",n=e?"Launch Plan":"Growth Plan",c=e?"What's Included in the Launch Plan":"What's Included in the Growth Plan",v=e?["Up to 5 pages","Custom design — no templates","WhatsApp button + click-to-call","Mobile responsive"]:["Up to 15 pages","Photos & video support","Custom design — no templates","WhatsApp button + contact form","Mobile responsive","Blog included"],u=e?["Written to rank on Google","Page titles & meta descriptions","SEO-ready structure"]:["Written to rank on Google","Targeting your service keywords","Page titles & meta descriptions","Blog SEO structure"],m=e?["Fully managed","Daily backups"]:["Fully managed","Daily backups"],C=e?"1":"2",E=e?"One revision session per month — book time with us, tell us what to change, we handle it.":"Two revision sessions per month — book time with us, tell us what to change, we handle it.";function f(d){return d.map(b=>`<span class="sp-pill">${b}</span>`).join("")}return`
  <div class="sp-wrap">
    <!-- HEADER -->
    <div class="sp-header">
    ...
    <div class="sp-pillars">
      ...
      <div class="sp-pillar">
        ...
        <div class="sp-pillar-content">
          ...
          <div class="sp-pills"><span class="sp-pill sp-pill-accent">${C} session revision${e?"":"s"}/month</span></div>
        </div>
      </div>
  ...
  `,t.appendChild(a);const s=new MutationObserver(()=>{const o=t.querySelector("iframe");o&&(o.style.position="relative",o.style.zIndex="2",o.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),s.disconnect())});s.observe(t,{childList:!0})}function _e(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),s=e.querySelector("video");a&&s&&a.addEventListener("click",o=>{o.stopPropagation(),s.muted=!1,s.currentTime=0,s.controls=!0,a.style.display="none",s.play().catch(n=>{console.error("Play failed:",n)})})})}function Ve(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",ue(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const s=document.createElement("script");s.id="calendly-sdk",s.src="https://assets.calendly.com/assets/external/widget.js",s.async=!0,s.addEventListener("load",e,{once:!0}),document.head.appendChild(s)}}function Ke(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),s=document.getElementById("bv-play-btn"),o=document.getElementById("bv-controls"),n=document.getElementById("bv-playpause"),c=document.getElementById("bv-progress-fill"),v=document.getElementById("bv-progress-thumb"),u=document.getElementById("bv-progress-wrap"),m=document.getElementById("bv-time"),C=document.getElementById("bv-mute"),E=document.getElementById("bv-volume"),f=document.getElementById("bv-fullscreen"),d=document.getElementById("custom-video-wrap");if(!e||!a||!s||!o||!n)return;e.volume=.9;let b=null,S=null;const A=()=>{try{const i=window.AudioContext||window.webkitAudioContext;if(!i)return;if(!b){b=new i;const r=b.createMediaElementSource(e);S=b.createGain(),S.gain.value=2,r.connect(S),S.connect(b.destination)}b.state==="suspended"&&b.resume()}catch(i){console.warn("AudioContext boost failed:",i)}},L=e.getAttribute("data-src"),M=()=>{L&&!e.getAttribute("src")&&(e.setAttribute("src",L),e.load())};let w=!0;const q=5,U=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{w&&e.currentTime>=q&&(e.currentTime=0)}),setTimeout(U,800);const D=i=>{const r=Math.floor(i/60),l=Math.floor(i%60);return`${r}:${l.toString().padStart(2,"0")}`},x=90,T=60,R=(i,r)=>!t||r<=x?i/r*100:i<=x?i/x*T:T+(i-x)/(r-x)*(100-T),H=(i,r)=>!t||r<=x?i/100*r:i<=T?i/T*x:x+(i-T)/(100-T)*(r-x),F=()=>{if(!e.duration)return;const i=R(e.currentTime,e.duration);c&&(c.style.width=i+"%"),v&&(v.style.left=i+"%"),m&&(m.textContent=`${D(e.currentTime)} / ${D(e.duration)}`)},W=i=>{const r=n==null?void 0:n.querySelector(".icon-play"),l=n==null?void 0:n.querySelector(".icon-pause");r&&(r.style.display=i&&!w?"none":"block"),l&&(l.style.display=i&&!w?"block":"none"),a&&(a.style.display=i&&!w?"none":"flex"),d&&(i&&!w?d.classList.add("playing"):d.classList.remove("playing"))};a.addEventListener("click",()=>{if(w){w=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0}M(),A(),W(!0),e.play()}),e.addEventListener("click",()=>{if(w){w=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0,A(),W(!0),e.play();return}M(),A(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>W(!0)),e.addEventListener("pause",()=>W(!1)),e.addEventListener("ended",()=>W(!1)),e.addEventListener("timeupdate",F),e.addEventListener("loadedmetadata",F);let P=!1;const B={m25:!1,m50:!1,m75:!1,m100:!1},p={};if(e.addEventListener("timeupdate",()=>{const i=e.duration;if(!i)return;const r=e.currentTime,l=r/i*100;!P&&r>.5&&(P=!0,k("videoplay")),l>=25&&!B.m25&&(B.m25=!0,k("videowatch_25pct")),l>=50&&!B.m50&&(B.m50=!0,k("videowatch_50pct")),l>=75&&!B.m75&&(B.m75=!0,k("videowatch_75pct")),l>=98&&!B.m100&&(B.m100=!0,k("videowatch_complete"));const g=[10,30],I=Math.floor(r);g.forEach(y=>{I>=y&&!p[y]&&(p[y]=!0,k(`videowatch_${y}s`))})}),n.addEventListener("click",()=>{M(),A(),e.paused?e.play():e.pause()}),u){const i=l=>{const g=u.getBoundingClientRect(),I=l instanceof MouseEvent?l.clientX:l.touches[0].clientX,y=Math.max(0,Math.min(100,(I-g.left)/g.width*100));e.currentTime=H(y,e.duration),F()};let r=!1;u.addEventListener("mousedown",l=>{r=!0,i(l)}),window.addEventListener("mousemove",l=>{r&&i(l)}),window.addEventListener("mouseup",()=>{r=!1}),u.addEventListener("touchstart",l=>i(l),{passive:!0}),u.addEventListener("touchmove",l=>i(l),{passive:!0})}if(E&&E.addEventListener("input",()=>{e.volume=parseFloat(E.value),e.muted=e.volume===0}),C&&C.addEventListener("click",()=>{e.muted=!e.muted,E&&(E.value=e.muted?"0":String(e.volume||1))}),f&&d&&f.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():d.requestFullscreen?d.requestFullscreen():d.webkitRequestFullscreen?d.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),d){let i;const r=()=>{o.style.opacity="1",clearTimeout(i),i=window.setTimeout(()=>{e.paused||(o.style.opacity="0")},2500)};d.addEventListener("mousemove",r),d.addEventListener("mouseenter",r),d.addEventListener("mouseleave",()=>{e.paused||(o.style.opacity="0")}),e.addEventListener("play",()=>{i=window.setTimeout(()=>{o.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{o.style.opacity="1",clearTimeout(i)})}}let pe=!0;function Qe(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn"),a=document.getElementById("strat-modal-step-1"),s=document.getElementById("strat-modal-step-2"),o=document.getElementById("strat-modal-step-3"),n=document.getElementById("strat-modal-step-4"),c=document.getElementById("strat-modal-step-num"),v=document.getElementById("strat-modal-step-title"),u=document.getElementById("strat-modal-step-badge"),m=document.getElementById("strat-modal-progress-bar"),C=document.getElementById("strat-modal-step1-form"),E=document.getElementById("strat-modal-step2-form"),f=document.getElementById("strat-input-name"),d=document.getElementById("strat-input-phone"),b=document.getElementById("strat-input-business"),S=document.getElementById("strat-select-revenue"),A=document.getElementById("strat-modal-step1-error"),L=document.getElementById("strat-modal-step2-error"),M=document.getElementById("strat-modal-confirm-pricing-link");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);let w="",q="",U="",D="";const x={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},T=document.getElementById("strat-phone-flag-prefix"),R=()=>{if(!T||!d)return;const p=d.value.trim();let i="🇦🇪";for(const[r,l]of Object.entries(x))if(p.startsWith(r)){i=l;break}T.textContent=i},H=()=>{if(!d)return;let p=d.value,i="";for(const y of Object.keys(x))if(p.startsWith(y)){i=y+" ";break}if(!i&&p.startsWith("+")){const y=p.indexOf(" ");if(y>0)i=p.substring(0,y+1);else{const z=p.match(/^\+\d+/);z&&(i=z[0]+" ")}}const l=p.substring(i.length).replace(/\D/g,"").substring(0,9);let g="";l.length>0&&(l.length<=2?g=l:l.length<=5?g=`${l.substring(0,2)} ${l.substring(2)}`:g=`${l.substring(0,2)} ${l.substring(2,5)} ${l.substring(5)}`);const I=i+g;d.value!==I&&(d.value=I)};d&&(d.addEventListener("input",p=>{const i=p;if(i.inputType&&i.inputType.startsWith("delete")){R();return}H(),R()}),R());const F=()=>{f&&(f.value=""),d&&(d.value="+971 "),b&&(b.value=""),S&&(S.value=""),A&&(A.style.display="none"),L&&(L.style.display="none"),P(1),t.classList.add("active"),document.body.style.overflow="hidden"},W=()=>{t.classList.remove("active"),document.body.style.overflow=""},P=p=>{!a||!s||!o||!n||!c||!v||!u||!m||(p===1?(a.style.display="block",s.style.display="none",o.style.display="none",n.style.display="none",u.style.display="inline",c.textContent="1",v.textContent="Tell us about yourself",m.style.width="33%"):p===2?(a.style.display="none",s.style.display="block",o.style.display="none",n.style.display="none",u.style.display="inline",c.textContent="2",v.textContent="Your business details",m.style.width="66%"):p===3?(a.style.display="none",s.style.display="none",o.style.display="block",n.style.display="none",u.style.display="inline",c.textContent="3",v.textContent="Schedule your strategy call",m.style.width="100%",B()):p===4&&(a.style.display="none",s.style.display="none",o.style.display="none",n.style.display="block",u.style.display="none",v.textContent="Call Scheduled!",m.style.width="100%"))},B=()=>{const p=document.getElementById("strat-modal-calendly-container");if(!p)return;const i=D==="Under AED 5k/month"||D==="Under $5k"||D==="$0 - $5k";pe=!i;const r=i?"https://calendly.com/officialatlanticbear/intro-call?hide_gdpr_banner=1&primary_color=3b69ff":"https://calendly.com/officialatlanticbear/strategy-call?hide_gdpr_banner=1&primary_color=3b69ff",l=D.replace(/–/g,"-").trim(),g=`${r}&name=${encodeURIComponent(w)}&a1=${encodeURIComponent(q)}&a2=${encodeURIComponent(U)}&a3=${encodeURIComponent(l)}&a4=${encodeURIComponent(l)}`;p.innerHTML="",ue(p);const I={url:g,parentElement:p,prefill:{name:w,customAnswers:{a1:q,a2:U,a3:l,a4:l,a5:l}}},y=()=>window.Calendly.initInlineWidget(I);if(window.Calendly)y();else{const z=document.getElementById("calendly-sdk");z&&z.addEventListener("load",y,{once:!0})}};C&&C.addEventListener("submit",p=>{p.preventDefault();const i=(f==null?void 0:f.value.trim())||"",r=(d==null?void 0:d.value.trim())||"";if(!i||!r){A&&(A.style.display="block");return}A&&(A.style.display="none"),w=i,q=r.replace(/\s+/g,""),P(2)}),E&&E.addEventListener("submit",async p=>{p.preventDefault();const i=(b==null?void 0:b.value.trim())||"",r=(S==null?void 0:S.value)||"";if(!i||!r){L&&(L.style.display="block");return}if(L&&(L.style.display="none"),U=i,D=r,!(r==="Under AED 5k/month"||r==="Under $5k"||r==="$0 - $5k")){const g=document.getElementById("strat-modal-step2-submit-btn");g&&(g.disabled=!0,g.textContent="Verifying...");const I=await oe("booking_submit");fetch("https://script.google.com/macros/s/AKfycbxhmc6G4n4zpk0SGvjzP81_Cd9ipLxM3Wx5MZNWzF02tBqqUMD0JCAuDnH1OojQfv7vJQ/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({action:"form_submit",name:w,phone:q,business:U,revenue:D,source:"strategy_call",recaptchaToken:I||""})}).catch(y=>console.error("Google Sheet submission failed:",y)),g&&(g.disabled=!1,g.textContent="Continue to Calendar →")}P(3)}),e.addEventListener("click",W),window.addEventListener("keydown",p=>{p.key==="Escape"&&t.classList.contains("active")&&W()}),M&&M.addEventListener("click",p=>{p.preventDefault(),W(),j("pricing",!0)}),window.goToStratBookingStep=P,window.openStratBookingModal=F}const te=["home","pricing","testimonials","meta-ads","contact","booking","booked"];let Y=null;function j(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const s=document.getElementById("strat-booking-modal");s&&s.remove(),document.body.style.overflow="",ie(),ne();const o=document.getElementById("main-nav"),n=document.querySelector(".site-footer");t==="booking"?(o&&(o.style.display="none"),n&&(n.style.display="none")):(o&&(o.style.display=""),n&&(n.style.display=""));const c=V("#main-content"),v=Y?te.indexOf(Y):-1,u=te.indexOf(t),m=v===-1||u>=v,C=m?"-8%":"8%",E=m?"8%":"-8%";Y=t;const f=window.matchMedia("(prefers-reduced-motion: reduce)").matches;c.style.transition=f?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",c.style.opacity="0",f||(c.style.transform=`translateX(${C})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),c.style.transition="none",f||(c.style.transform=`translateX(${E})`),c.innerHTML=de[t](),Fe(t),requestAnimationFrame(()=>{c.style.transition=f?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",c.style.opacity="1",c.style.transform="translateX(0)"}),Ne(),je(),Ge(),t==="contact"&&Ye(),(t==="booking"||t==="booked")&&(k("pageload",2e3),me(),ve(),Ve(),Ke(t==="booking"),t==="booking"&&(Qe(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(d=>{d.addEventListener("click",()=>{window.openStratBookingModal&&window.openStratBookingModal()})}))),Re(t),_e(),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&window.fbq("track","PageView"),e){const d=t==="home"?"/":`/${t}`;window.location.pathname!==d&&history.pushState(null,"",d)}},260)}function Je(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const s=a.getAttribute("data-link");s&&de[s]&&j(s)})}function Xe(){const t=V("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{const t=new URLSearchParams(window.location.search);t.get("notrack")==="1"&&sessionStorage.setItem("notrack","1");const e=t.get("fbclid"),a=(t.get("utm_source")||"").toLowerCase();(!!e||["facebook","instagram","fb","meta"].some(c=>a.includes(c)))&&sessionStorage.setItem("came_from_meta","1");const o=document.getElementById("app");o.innerHTML=`
    ${fe()}
  ...
  `,Je(o),Xe(),se(),window.addEventListener("message",c=>{if(!c.origin||!c.origin.includes("calendly.com"))return;let v=!1;if(c&&c.data){let u=c.data;if(typeof u=="string")try{u=JSON.parse(u)}catch{}typeof u=="object"&&u&&u.event==="calendly.event_scheduled"&&(v=!0)}if(v){const u=document.getElementById("strat-booking-modal"),m=document.getElementById("booking-modal");u&&u.classList.contains("active")?(pe?(k("bookedcall_strategy"),typeof window.fbq=="function"&&sessionStorage.getItem("came_from_meta")&&!sessionStorage.getItem("fbq_schedule_fired")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1"))):k("bookedcall_intro"),u&&u.classList.remove("active")):(k("bookedcall"),m&&m.classList.remove("active")),document.body.style.overflow="",j("booked")}});const n=ee(window.location.pathname);j(n,!1),window.addEventListener("popstate",()=>{const c=ee(window.location.pathname);j(c,!1)})});
