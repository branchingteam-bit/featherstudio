(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const p of n.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&o(p)}).observe(document,{childList:!0,subtree:!0});function a(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(s){if(s.ep)return;s.ep=!0;const n=a(s);fetch(s.href,n)}})();const pe={ogImage:"/og-image.png"},Q={site:pe},_=(t,e=document)=>e.querySelector(t),K=(t,e=document)=>[...e.querySelectorAll(t)],J="atlanticbear_analytics_8d24";function b(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${J}/${t}`).catch(()=>{});try{const o=ve();fetch(`https://abacus.jasoncameron.dev/hit/${J}/${o}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}const ae=window.RECAPTCHA_SITE_KEY||"6Ldfp-gqAAAAABpP_placeholder_key";function se(){const t=window.RECAPTCHA_SITE_KEY||ae;if(document.getElementById("recaptcha-v3-script"))return;const e=document.createElement("script");e.id="recaptcha-v3-script",e.src=`https://www.google.com/recaptcha/api.js?render=${encodeURIComponent(t)}`,e.async=!0,e.defer=!0,document.head.appendChild(e)}async function oe(t){const e=window.RECAPTCHA_SITE_KEY||ae;return se(),new Promise(a=>{const o=setTimeout(()=>{console.warn(`reCAPTCHA [${t}] timed out. Continuing submission.`),a(null)},2500),s=window.grecaptcha;if(s&&typeof s.ready=="function")try{s.ready(()=>{s.execute(e,{action:t}).then(n=>{clearTimeout(o),a(n)}).catch(n=>{clearTimeout(o),console.warn(`reCAPTCHA [${t}] execution error:`,n),a(null)})})}catch(n){clearTimeout(o),console.warn(`reCAPTCHA [${t}] error:`,n),a(null)}else clearTimeout(o),a(null)})}let V={};function me(){ie();const t=e=>{V[`t${e}`]=window.setTimeout(()=>{b(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function ie(){Object.values(V).forEach(clearTimeout),V={}}let M={moved:!1,calendar:!1,testimonials:!1},j=null;function he(){ne(),M={moved:!1,video:!1,calendar:!1,testimonials:!1},j=()=>{window.scrollY>50&&!M.moved&&(M.moved=!0,b("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!M.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(M.calendar=!0,b("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!M.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(M.testimonials=!0,b("scroll_testimonials"))},window.addEventListener("scroll",j,{passive:!0})}function ne(){j&&(window.removeEventListener("scroll",j),j=null)}function ve(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${a}-${o}-${s}`}const u={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function ge(){return`
  <nav class="nav" id="main-nav">
    ...
    <div class="nav-actions">
      <a href="/booking" class="btn btn-primary btn-sm btn-pulse" data-link="booking" id="nav-book-cta">Book a Call ${u.arrow}</a>
    </div>
  ...
  <section class="cc-section">
    <div class="container">
      <div class="cc-grid">
        ...
        <div class="cc-copy reveal">
          <span class="cc-badge">${u.code} How we build</span>
  ...
  </section>`}const H={quote:"We approached Alexi at Atlantic Bear, who was absolutely fantastic at putting together our ideas and bringing them across on the website in a way that really engaged our target market.",name:"Sonder Training Group",role:"Training Provider, UAE",avatar:0},O=[{quote:"Five days from the first call to a live site. I had budgeted two months, and half of that for arguing about revisions.",name:"Tom Whitfield",role:"Founder, Dental Clinic",avatar:1},{quote:"We now come up first for our category in Dubai. Enquiries through the site have roughly tripled since launch.",name:"Priya Nair",role:"Director, Facilities Services",avatar:2},{quote:"They asked good questions, then just built it. I approved two rounds of small tweaks and that was the whole process.",name:"Marcus Oyelaran",role:"Manager, Hospitality Group",avatar:3},{quote:"Most of our customers are on their phones and the old site was unusable there. The new one loads instantly.",name:"Yasmin Farouk",role:"Owner, Fitness Studio",avatar:4},{quote:"Handover was clean. Domain, hosting, files, all in our name from day one, exactly as they promised.",name:"Lena Vasquez",role:"Founder, E-commerce",avatar:5}],be=[[H,O[0],O[1]],[O[2],H,O[3]],[O[4],H,O[0]]],X=[{bg:"#3b69ff",fg:"#dfe8ff"},{bg:"#1e46c7",fg:"#d5e0ff"},{bg:"#6391ff",fg:"#eef3ff"},{bg:"#2a50e0",fg:"#dbe5ff"},{bg:"#142d80",fg:"#ccd9ff"},{bg:"#4a80ff",fg:"#e7eeff"},{bg:"#27418f",fg:"#d2ddff"},{bg:"#5b7cff",fg:"#e9efff"},{bg:"#1a3fb5",fg:"#d8e2ff"}];function we(t,e){const a=X[e%X.length],o=7.2+e%3*.5,s=14.5+e%4*.8,n=19.5-e%3*.3;return`
    ...
    </article>`}function Ee(){const t=be.map((e,a)=>{const o=e.map(ke).join("");return`
  ...
  <section class="reviews-wall">
    <div class="container">
      <div class="reviews-head">
        <span class="reviews-badge">${u.star} Reviews</span>
    ...
    <div class="container">
      ...
      <div class="reveal" style="text-align: center; margin-top: 48px;">
        <a href="/booking" class="btn btn-primary btn-large btn-pulse" data-link="booking">
          Get Started with Market Leader ${u.arrow}
        </a>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="feature-grid">
        <div class="feature-item reveal">
          <div class="feature-icon-wrap">${u.globe}</div>
        ...
        <div class="feature-item reveal">
          <div class="feature-icon-wrap">${u.star}</div>
        ...
        <div class="feature-item reveal">
          <div class="feature-icon-wrap">${u.shield}</div>
        ...
        <div class="feature-item reveal">
          <div class="feature-icon-wrap">${u.phone}</div>
        ...
        <div class="feature-item reveal">
          <div class="feature-icon-wrap">${u.rocket}</div>
        ...
        <div class="feature-item reveal" style="display:flex; flex-direction:column; justify-content:center; background:var(--surface);">
          ...
          <a href="/booking" class="btn btn-primary btn-sm" data-link="booking" style="align-self:flex-start;">Book a Call ${u.arrow}</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="feature-grid" style="grid-template-columns: repeat(2, 1fr); max-width: 900px; margin: 0 auto;">
        <div class="feature-item reveal" style="border-right: 1px solid var(--border); border-bottom: 1px solid var(--border);">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${u.zap}</div>
        ...
        <div class="feature-item reveal" style="border-right: none; border-bottom: 1px solid var(--border);">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${u.star}</div>
        ...
        <div class="feature-item reveal" style="border-right: 1px solid var(--border); border-bottom: none;">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${u.phone}</div>
        ...
        <div class="feature-item reveal" style="border-right: none; border-bottom: none;">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${u.rocket}</div>
    ...
    <div class="container">
      ...
      <div class="case-study reveal" style="transition-delay:0.1s;">
        ...
        <aside class="case-study-side">
          ...
          <a href="https://sondertraininggroup.com/" target="_blank" rel="noopener" class="btn btn-secondary btn-sm case-study-link">Visit the live site ${u.arrow}</a>
        </aside>
      </div>
            ...
            <div class="contact-methods">
              <a href="tel:+971502446531" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${u.phone}</svg>
                </div>
                <div>
              ...
              <a href="mailto:officialatlanticbear@gmail.com" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${u.mail}</svg>
                </div>
                <div>
              ...
              <a href="https://www.instagram.com/officialatlanticbear/" target="_blank" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${u.instagram}</svg>
                </div>
                <div>
              ...
              <div class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${u.map}</svg>
                </div>
                <div>
  ...
  `,t.appendChild(a);const o=new MutationObserver(()=>{const s=t.querySelector("iframe");s&&(s.style.position="relative",s.style.zIndex="2",s.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),o.disconnect())});o.observe(t,{childList:!0})}function Ye(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),o=e.querySelector("video");a&&o&&a.addEventListener("click",s=>{s.stopPropagation(),o.muted=!1,o.currentTime=0,o.controls=!0,a.style.display="none",o.play().catch(n=>{console.error("Play failed:",n)})})})}function He(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",de(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const o=document.createElement("script");o.id="calendly-sdk",o.src="https://assets.calendly.com/assets/external/widget.js",o.async=!0,o.addEventListener("load",e,{once:!0}),document.head.appendChild(o)}}function Ge(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),o=document.getElementById("bv-play-btn"),s=document.getElementById("bv-controls"),n=document.getElementById("bv-playpause"),p=document.getElementById("bv-progress-fill"),h=document.getElementById("bv-progress-thumb"),v=document.getElementById("bv-progress-wrap"),m=document.getElementById("bv-time"),W=document.getElementById("bv-mute"),A=document.getElementById("bv-volume"),w=document.getElementById("bv-fullscreen"),c=document.getElementById("custom-video-wrap");if(!e||!a||!o||!s||!n)return;e.volume=.9;let k=null,C=null;const x=()=>{try{const i=window.AudioContext||window.webkitAudioContext;if(!i)return;if(!k){k=new i;const r=k.createMediaElementSource(e);C=k.createGain(),C.gain.value=2,r.connect(C),C.connect(k.destination)}k.state==="suspended"&&k.resume()}catch(i){console.warn("AudioContext boost failed:",i)}},I=e.getAttribute("data-src"),q=()=>{I&&!e.getAttribute("src")&&(e.setAttribute("src",I),e.load())};let y=!0;const $=5,U=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{y&&e.currentTime>=$&&(e.currentTime=0)}),setTimeout(U,800);const L=i=>{const r=Math.floor(i/60),l=Math.floor(i%60);return`${r}:${l.toString().padStart(2,"0")}`},E=90,S=60,R=(i,r)=>!t||r<=E?i/r*100:i<=E?i/E*S:S+(i-E)/(r-E)*(100-S),Y=(i,r)=>!t||r<=E?i/100*r:i<=S?i/S*E:E+(i-S)/(100-S)*(r-E),F=()=>{if(!e.duration)return;const i=R(e.currentTime,e.duration);p&&(p.style.width=i+"%"),h&&(h.style.left=i+"%"),m&&(m.textContent=`${L(e.currentTime)} / ${L(e.duration)}`)},D=i=>{const r=n==null?void 0:n.querySelector(".icon-play"),l=n==null?void 0:n.querySelector(".icon-pause");r&&(r.style.display=i&&!y?"none":"block"),l&&(l.style.display=i&&!y?"block":"none"),a&&(a.style.display=i&&!y?"none":"flex"),c&&(i&&!y?c.classList.add("playing"):c.classList.remove("playing"))};a.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0}q(),x(),D(!0),e.play()}),e.addEventListener("click",()=>{if(y){y=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0,x(),D(!0),e.play();return}q(),x(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>D(!0)),e.addEventListener("pause",()=>D(!1)),e.addEventListener("ended",()=>D(!1)),e.addEventListener("timeupdate",F),e.addEventListener("loadedmetadata",F);let P=!1;const T={m25:!1,m50:!1,m75:!1,m100:!1},d={};if(e.addEventListener("timeupdate",()=>{const i=e.duration;if(!i)return;const r=e.currentTime,l=r/i*100;!P&&r>.5&&(P=!0,b("videoplay")),l>=25&&!T.m25&&(T.m25=!0,b("videowatch_25pct")),l>=50&&!T.m50&&(T.m50=!0,b("videowatch_50pct")),l>=75&&!T.m75&&(T.m75=!0,b("videowatch_75pct")),l>=98&&!T.m100&&(T.m100=!0,b("videowatch_complete"));const g=[10,30],B=Math.floor(r);g.forEach(f=>{B>=f&&!d[f]&&(d[f]=!0,b(`videowatch_${f}s`))})}),n.addEventListener("click",()=>{q(),x(),e.paused?e.play():e.pause()}),v){const i=l=>{const g=v.getBoundingClientRect(),B=l instanceof MouseEvent?l.clientX:l.touches[0].clientX,f=Math.max(0,Math.min(100,(B-g.left)/g.width*100));e.currentTime=Y(f,e.duration),F()};let r=!1;v.addEventListener("mousedown",l=>{r=!0,i(l)}),window.addEventListener("mousemove",l=>{r&&i(l)}),window.addEventListener("mouseup",()=>{r=!1}),v.addEventListener("touchstart",l=>i(l),{passive:!0}),v.addEventListener("touchmove",l=>i(l),{passive:!0})}if(A&&A.addEventListener("input",()=>{e.volume=parseFloat(A.value),e.muted=e.volume===0}),W&&W.addEventListener("click",()=>{e.muted=!e.muted,A&&(A.value=e.muted?"0":String(e.volume||1))}),w&&c&&w.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():c.requestFullscreen?c.requestFullscreen():c.webkitRequestFullscreen?c.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),c){let i;const r=()=>{s.style.opacity="1",clearTimeout(i),i=window.setTimeout(()=>{e.paused||(s.style.opacity="0")},2500)};c.addEventListener("mousemove",r),c.addEventListener("mouseenter",r),c.addEventListener("mouseleave",()=>{e.paused||(s.style.opacity="0")}),e.addEventListener("play",()=>{i=window.setTimeout(()=>{s.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{s.style.opacity="1",clearTimeout(i)})}}let ue=!0;function Ve(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn"),a=document.getElementById("strat-modal-step-1"),o=document.getElementById("strat-modal-step-2"),s=document.getElementById("strat-modal-step-3"),n=document.getElementById("strat-modal-step-4"),p=document.getElementById("strat-modal-step-num"),h=document.getElementById("strat-modal-step-title"),v=document.getElementById("strat-modal-step-badge"),m=document.getElementById("strat-modal-progress-bar"),W=document.getElementById("strat-modal-step1-form"),A=document.getElementById("strat-modal-step2-form"),w=document.getElementById("strat-input-name"),c=document.getElementById("strat-input-phone"),k=document.getElementById("strat-input-business"),C=document.getElementById("strat-select-revenue"),x=document.getElementById("strat-modal-step1-error"),I=document.getElementById("strat-modal-step2-error"),q=document.getElementById("strat-modal-confirm-pricing-link");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);let y="",$="",U="",L="";const E={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},S=document.getElementById("strat-phone-flag-prefix"),R=()=>{if(!S||!c)return;const d=c.value.trim();let i="🇦🇪";for(const[r,l]of Object.entries(E))if(d.startsWith(r)){i=l;break}S.textContent=i},Y=()=>{if(!c)return;let d=c.value,i="";for(const f of Object.keys(E))if(d.startsWith(f)){i=f+" ";break}if(!i&&d.startsWith("+")){const f=d.indexOf(" ");if(f>0)i=d.substring(0,f+1);else{const z=d.match(/^\+\d+/);z&&(i=z[0]+" ")}}const l=d.substring(i.length).replace(/\D/g,"").substring(0,9);let g="";l.length>0&&(l.length<=2?g=l:l.length<=5?g=`${l.substring(0,2)} ${l.substring(2)}`:g=`${l.substring(0,2)} ${l.substring(2,5)} ${l.substring(5)}`);const B=i+g;c.value!==B&&(c.value=B)};c&&(c.addEventListener("input",d=>{const i=d;if(i.inputType&&i.inputType.startsWith("delete")){R();return}Y(),R()}),R());const F=()=>{w&&(w.value=""),c&&(c.value="+971 "),k&&(k.value=""),C&&(C.value=""),x&&(x.style.display="none"),I&&(I.style.display="none"),P(1),t.classList.add("active"),document.body.style.overflow="hidden"},D=()=>{t.classList.remove("active"),document.body.style.overflow=""},P=d=>{!a||!o||!s||!n||!p||!h||!v||!m||(d===1?(a.style.display="block",o.style.display="none",s.style.display="none",n.style.display="none",v.style.display="inline",p.textContent="1",h.textContent="Tell us about yourself",m.style.width="33%"):d===2?(a.style.display="none",o.style.display="block",s.style.display="none",n.style.display="none",v.style.display="inline",p.textContent="2",h.textContent="Your business details",m.style.width="66%"):d===3?(a.style.display="none",o.style.display="none",s.style.display="block",n.style.display="none",v.style.display="inline",p.textContent="3",h.textContent="Schedule your strategy call",m.style.width="100%",T()):d===4&&(a.style.display="none",o.style.display="none",s.style.display="none",n.style.display="block",v.style.display="none",h.textContent="Call Scheduled!",m.style.width="100%"))},T=()=>{const d=document.getElementById("strat-modal-calendly-container");if(!d)return;const i=L==="Under AED 5k/month"||L==="Under $5k"||L==="$0 - $5k";ue=!i;const r=i?"https://calendly.com/officialatlanticbear/intro-call?hide_gdpr_banner=1&primary_color=3b69ff":"https://calendly.com/officialatlanticbear/strategy-call?hide_gdpr_banner=1&primary_color=3b69ff",l=L.replace(/–/g,"-").trim(),g=`${r}&name=${encodeURIComponent(y)}&a1=${encodeURIComponent($)}&a2=${encodeURIComponent(U)}&a3=${encodeURIComponent(l)}&a4=${encodeURIComponent(l)}`;d.innerHTML="",de(d);const B={url:g,parentElement:d,prefill:{name:y,customAnswers:{a1:$,a2:U,a3:l,a4:l,a5:l}}},f=()=>window.Calendly.initInlineWidget(B);if(window.Calendly)f();else{const z=document.getElementById("calendly-sdk");z&&z.addEventListener("load",f,{once:!0})}};W&&W.addEventListener("submit",d=>{d.preventDefault();const i=(w==null?void 0:w.value.trim())||"",r=(c==null?void 0:c.value.trim())||"";if(!i||!r){x&&(x.style.display="block");return}x&&(x.style.display="none"),y=i,$=r.replace(/\s+/g,""),P(2)}),A&&A.addEventListener("submit",async d=>{d.preventDefault();const i=(k==null?void 0:k.value.trim())||"",r=(C==null?void 0:C.value)||"";if(!i||!r){I&&(I.style.display="block");return}if(I&&(I.style.display="none"),U=i,L=r,!(r==="Under AED 5k/month"||r==="Under $5k"||r==="$0 - $5k")){const g=document.getElementById("strat-modal-step2-submit-btn");g&&(g.disabled=!0,g.textContent="Verifying...");const B=await oe("booking_submit");fetch("https://script.google.com/macros/s/AKfycbxhmc6G4n4zpk0SGvjzP81_Cd9ipLxM3Wx5MZNWzF02tBqqUMD0JCAuDnH1OojQfv7vJQ/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({action:"form_submit",name:y,phone:$,business:U,revenue:L,source:"strategy_call",recaptchaToken:B||""})}).catch(f=>console.error("Google Sheet submission failed:",f)),g&&(g.disabled=!1,g.textContent="Continue to Calendar →")}P(3)}),e.addEventListener("click",D),window.addEventListener("keydown",d=>{d.key==="Escape"&&t.classList.contains("active")&&D()}),q&&q.addEventListener("click",d=>{d.preventDefault(),D(),N("pricing",!0)}),window.goToStratBookingStep=P,window.openStratBookingModal=F}const te=["home","pricing","testimonials","meta-ads","contact","booking","booked"];let G=null;function N(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const o=document.getElementById("strat-booking-modal");o&&o.remove(),document.body.style.overflow="",ie(),ne();const s=document.getElementById("main-nav"),n=document.querySelector(".site-footer");t==="booking"?(s&&(s.style.display="none"),n&&(n.style.display="none")):(s&&(s.style.display=""),n&&(n.style.display=""));const p=_("#main-content"),h=G?te.indexOf(G):-1,v=te.indexOf(t),m=h===-1||v>=h,W=m?"-8%":"8%",A=m?"8%":"-8%";G=t;const w=window.matchMedia("(prefers-reduced-motion: reduce)").matches;p.style.transition=w?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",p.style.opacity="0",w||(p.style.transform=`translateX(${W})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),p.style.transition="none",w||(p.style.transform=`translateX(${A})`),p.innerHTML=ce[t](),Ue(t),requestAnimationFrame(()=>{p.style.transition=w?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",p.style.opacity="1",p.style.transform="translateX(0)"}),Re(),Fe(),je(),t==="contact"&&Ne(),(t==="booking"||t==="booked")&&(b("pageload",2e3),me(),he(),He(),Ge(t==="booking"),t==="booking"&&(Ve(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(c=>{c.addEventListener("click",()=>{window.openStratBookingModal&&window.openStratBookingModal()})}))),$e(t),Ye(),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&window.fbq("track","PageView"),e){const c=t==="home"?"/":`/${t}`;window.location.pathname!==c&&history.pushState(null,"",c)}},260)}function _e(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const o=a.getAttribute("data-link");o&&ce[o]&&N(o)})}function Ke(){const t=_("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{new URLSearchParams(window.location.search).get("notrack")==="1"&&sessionStorage.setItem("notrack","1");const t=document.getElementById("app");t.innerHTML=`
    ${ge()}
