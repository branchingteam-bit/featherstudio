(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const v of n.addedNodes)v.tagName==="LINK"&&v.rel==="modulepreload"&&s(v)}).observe(document,{childList:!0,subtree:!0});function a(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=a(i);fetch(i.href,n)}})();const V=(t,e=document)=>e.querySelector(t),z=(t,e=document)=>[...e.querySelectorAll(t)],j="atlanticbear_analytics_8d24";function x(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${j}/${t}`).catch(()=>{});try{const s=te();fetch(`https://abacus.jasoncameron.dev/hit/${j}/${s}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}let q={};function Q(){K();const t=e=>{q[`t${e}`]=window.setTimeout(()=>{x(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function K(){Object.values(q).forEach(clearTimeout),q={}}let C={moved:!1,calendar:!1,testimonials:!1},R=null;function ee(){J(),C={moved:!1,video:!1,calendar:!1,testimonials:!1},R=()=>{window.scrollY>50&&!C.moved&&(C.moved=!0,x("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!C.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(C.calendar=!0,x("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!C.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(C.testimonials=!0,x("scroll_testimonials"))},window.addEventListener("scroll",R,{passive:!0})}function J(){R&&(window.removeEventListener("scroll",R),R=null)}function te(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),i=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${i}`}const g={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function ae(){return`
  ...
  `,t.appendChild(a);const s=new MutationObserver(()=>{const i=t.querySelector("iframe");i&&(i.style.position="relative",i.style.zIndex="2",i.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),s.disconnect())});s.observe(t,{childList:!0})}function fe(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),s=e.querySelector("video");a&&s&&a.addEventListener("click",i=>{i.stopPropagation(),s.muted=!1,s.currentTime=0,s.controls=!0,a.style.display="none",s.play().catch(n=>{console.error("Play failed:",n)})})})}function ge(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",Z(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const s=document.createElement("script");s.id="calendly-sdk",s.src="https://assets.calendly.com/assets/external/widget.js",s.async=!0,s.addEventListener("load",e,{once:!0}),document.head.appendChild(s)}}function he(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),s=document.getElementById("bv-play-btn"),i=document.getElementById("bv-controls"),n=document.getElementById("bv-playpause"),v=document.getElementById("bv-progress-fill"),f=document.getElementById("bv-progress-thumb"),h=document.getElementById("bv-progress-wrap"),m=document.getElementById("bv-time"),D=document.getElementById("bv-mute"),p=document.getElementById("bv-volume"),d=document.getElementById("bv-fullscreen"),b=document.getElementById("custom-video-wrap");if(!e||!a||!s||!i||!n)return;let T=null,k=null;const E=()=>{try{const o=window.AudioContext||window.webkitAudioContext;if(!o)return;if(!T){T=new o;const l=T.createMediaElementSource(e);k=T.createGain(),k.gain.value=2,l.connect(k),k.connect(T.destination)}T.state==="suspended"&&T.resume()}catch(o){console.warn("AudioContext boost failed:",o)}},O=e.getAttribute("data-src"),I=()=>{O&&!e.getAttribute("src")&&(e.setAttribute("src",O),e.load())};let A=!0;const W=5,Y=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{A&&e.currentTime>=W&&(e.currentTime=0)}),setTimeout(Y,800);const F=o=>{const l=Math.floor(o/60),u=Math.floor(o%60);return`${l}:${u.toString().padStart(2,"0")}`},y=90,B=60,$=(o,l)=>!t||l<=y?o/l*100:o<=y?o/y*B:B+(o-y)/(l-y)*(100-B),L=(o,l)=>!t||l<=y?o/100*l:o<=B?o/B*y:y+(o-B)/(100-B)*(l-y),_=()=>{if(!e.duration)return;const o=$(e.currentTime,e.duration);v&&(v.style.width=o+"%"),f&&(f.style.left=o+"%"),m&&(m.textContent=`${F(e.currentTime)} / ${F(e.duration)}`)},N=o=>{const l=n==null?void 0:n.querySelector(".icon-play"),u=n==null?void 0:n.querySelector(".icon-pause");l&&(l.style.display=o&&!A?"none":"block"),u&&(u.style.display=o&&!A?"block":"none"),a&&(a.style.display=o&&!A?"none":"flex"),b&&(o&&!A?b.classList.add("playing"):b.classList.remove("playing"))};a.addEventListener("click",()=>{A=!1,I(),e.muted=!1,e.currentTime=0,E(),e.play()}),e.addEventListener("click",()=>{if(A){A=!1,e.muted=!1,e.currentTime=0,E(),e.play();return}I(),E(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>N(!0)),e.addEventListener("pause",()=>N(!1)),e.addEventListener("ended",()=>N(!1)),e.addEventListener("timeupdate",_),e.addEventListener("loadedmetadata",_);let c=!1;const r={m25:!1,m50:!1,m75:!1,m100:!1},S={};if(e.addEventListener("timeupdate",()=>{const o=e.duration;if(!o)return;const l=e.currentTime,u=l/o*100;!c&&l>.5&&(c=!0,x("videoplay")),u>=25&&!r.m25&&(r.m25=!0,x("videowatch_25pct")),u>=50&&!r.m50&&(r.m50=!0,x("videowatch_50pct")),u>=75&&!r.m75&&(r.m75=!0,x("videowatch_75pct")),u>=98&&!r.m100&&(r.m100=!0,x("videowatch_complete"));const w=[10,30],P=Math.floor(l);w.forEach(M=>{P>=M&&!S[M]&&(S[M]=!0,x(`videowatch_${M}s`))})}),n.addEventListener("click",()=>{I(),E(),e.paused?e.play():e.pause()}),h){const o=u=>{const w=h.getBoundingClientRect(),P=u instanceof MouseEvent?u.clientX:u.touches[0].clientX,M=Math.max(0,Math.min(100,(P-w.left)/w.width*100));e.currentTime=L(M,e.duration),_()};let l=!1;h.addEventListener("mousedown",u=>{l=!0,o(u)}),window.addEventListener("mousemove",u=>{l&&o(u)}),window.addEventListener("mouseup",()=>{l=!1}),h.addEventListener("touchstart",u=>o(u),{passive:!0}),h.addEventListener("touchmove",u=>o(u),{passive:!0})}if(p&&p.addEventListener("input",()=>{e.volume=parseFloat(p.value),e.muted=e.volume===0}),D&&D.addEventListener("click",()=>{e.muted=!e.muted,p&&(p.value=e.muted?"0":String(e.volume||1))}),d&&b&&d.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():b.requestFullscreen?b.requestFullscreen():b.webkitRequestFullscreen?b.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),b){let o;const l=()=>{i.style.opacity="1",clearTimeout(o),o=window.setTimeout(()=>{e.paused||(i.style.opacity="0")},2500)};b.addEventListener("mousemove",l),b.addEventListener("mouseenter",l),b.addEventListener("mouseleave",()=>{e.paused||(i.style.opacity="0")}),e.addEventListener("play",()=>{o=window.setTimeout(()=>{i.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{i.style.opacity="1",clearTimeout(o)})}}function be(){const t=document.getElementById("booking-modal"),e=document.getElementById("book-demo-btn-v2"),a=document.getElementById("booking-modal-close-btn"),s=document.getElementById("modal-step-1"),i=document.getElementById("modal-step-2"),n=document.getElementById("modal-step-3"),v=document.getElementById("modal-step-num"),f=document.getElementById("modal-step-title"),h=document.getElementById("modal-step-badge"),m=document.getElementById("modal-progress-bar"),D=document.getElementById("modal-step1-form"),p=document.getElementById("modal-input-name"),d=document.getElementById("modal-input-phone"),b=document.getElementById("modal-step1-error"),T=document.getElementById("modal-confirm-pricing-link");if(!t||!a)return;t.parentElement!==document.body&&document.body.appendChild(t);let k="",E="",O="";p&&localStorage.getItem("feather_booking_name")&&(p.value=localStorage.getItem("feather_booking_name")||""),d&&localStorage.getItem("feather_booking_phone")&&(d.value=localStorage.getItem("feather_booking_phone")||"");const I=document.getElementById("phone-flag-prefix"),A={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},W=()=>{if(!I||!d)return;const c=d.value.trim();let r="🇦🇪";for(const[S,o]of Object.entries(A))if(c.startsWith(S)){r=o;break}I.textContent=r},Y=()=>{if(!d)return;let c=d.value,r="";for(const w of Object.keys(A))if(c.startsWith(w)){r=w+" ";break}if(!r&&c.startsWith("+")){const w=c.indexOf(" ");if(w>0)r=c.substring(0,w+1);else{const P=c.match(/^\+\d+/);P&&(r=P[0]+" ")}}const o=c.substring(r.length).replace(/\D/g,"").substring(0,9);let l="";o.length>0&&(o.length<=2?l=o:o.length<=5?l=`${o.substring(0,2)} ${o.substring(2)}`:l=`${o.substring(0,2)} ${o.substring(2,5)} ${o.substring(5)}`);const u=r+l;d.value!==u&&(d.value=u)};d&&((!d.value||d.value.trim()===""||d.value.trim()==="+971")&&(d.value="+971 "),d.addEventListener("input",c=>{const r=c;if(r.inputType&&r.inputType.startsWith("delete")){W();return}Y(),W()}),W());const F=()=>{if(!k||!E)return;const c=`${k}|${E}`;if(O===c)return;O=c;const r=document.getElementById("modal-calendly-container");if(!r)return;r.innerHTML="",Z(r);const l={url:`https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff&name=${encodeURIComponent(k)}&a1=${encodeURIComponent(E)}`,parentElement:r,prefill:{name:k,customAnswers:{a1:E}}},u=()=>window.Calendly.initInlineWidget(l);if(window.Calendly)u();else{const w=document.getElementById("calendly-sdk");w&&w.addEventListener("load",u,{once:!0})}},y=()=>{const c=(p==null?void 0:p.value.trim())||"",r=(d==null?void 0:d.value.trim())||"";c.length>=3&&r.length>=5&&(k=c,E=r,F())};p==null||p.addEventListener("input",y),d==null||d.addEventListener("input",y),y();const B=c=>{c===1?(s&&(s.style.display="block"),i&&(i.style.display="none"),n&&(n.style.display="none"),v&&(v.textContent="1"),f&&(f.textContent="Tell us about yourself"),h&&(h.style.display="inline"),m&&(m.style.width="50%")):c===2?(s&&(s.style.display="none"),i&&(i.style.display="block"),n&&(n.style.display="none"),v&&(v.textContent="2"),f&&(f.textContent="Schedule your demo call"),h&&(h.style.display="inline"),m&&(m.style.width="100%"),k=(p==null?void 0:p.value.trim())||"",E=(d==null?void 0:d.value.trim())||"",F()):c===3&&(s&&(s.style.display="none"),i&&(i.style.display="none"),n&&(n.style.display="block"),f&&(f.textContent="Call Confirmed!"),h&&(h.style.display="none"),m&&(m.style.width="100%"))},$=()=>{t.classList.add("active"),document.body.style.overflow="hidden",b&&(b.style.display="none"),p&&localStorage.getItem("feather_booking_name")&&(p.value=localStorage.getItem("feather_booking_name")||""),d&&localStorage.getItem("feather_booking_phone")&&(d.value=localStorage.getItem("feather_booking_phone")||""),B(1)},L=()=>{t.classList.remove("active"),document.body.style.overflow=""},_=c=>{c&&c.preventDefault();const r=(p==null?void 0:p.value.trim())||"",S=(d==null?void 0:d.value.trim())||"";if(!r||!S){b&&(b.style.display="block");return}const o=r.split(" ").map(l=>l.charAt(0).toUpperCase()+l.slice(1)).join(" ");b&&(b.style.display="none"),k=o,E=S,localStorage.setItem("feather_booking_name",o),localStorage.setItem("feather_booking_phone",S),fetch("https://script.google.com/macros/s/AKfycbyE6OQMsiNActyf_24Emjw3AepiNzWZwGc3VZWi2RCWxM1Jg04yWZSIKfxJ8ff5Cu2-/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({name:r,phone:S,source:"booking_funnel"})}).catch(l=>console.error("Google Sheet submission failed:",l)),B(2)};D&&D.addEventListener("submit",_),e&&e.addEventListener("click",$),a.addEventListener("click",L),t.addEventListener("click",c=>{c.target===t&&L()});const N=c=>{c.key==="Escape"&&t.classList.contains("active")&&L()};window.addEventListener("keydown",N),T&&T.addEventListener("click",c=>{c.preventDefault(),L(),U("pricing",!0)}),window.goToBookingStep=B,window.openBookingModal=$}function U(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove(),document.body.style.overflow="",K(),J();const s=document.getElementById("main-nav"),i=document.querySelector(".site-footer");t==="booking"?(s&&(s.style.display="none"),i&&(i.style.display="none")):(s&&(s.style.display=""),i&&(i.style.display=""));const n=V("#main-content");n.style.opacity="0",n.style.transform="translateY(8px)",setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),n.innerHTML=X[t](),pe(t),n.style.transition="opacity 0.3s ease, transform 0.3s ease",requestAnimationFrame(()=>{n.style.opacity="1",n.style.transform="translateY(0)"}),ve(),t==="contact"&&me(),t==="booking"||t==="booking-new"){x("pageload",2e3),Q(),ee(),ge(),he(t==="booking");const v=document.getElementById("skip-to-booking-btn");v&&v.addEventListener("click",f=>{f.preventDefault();const h=document.getElementById("booking-calendar");h&&h.scrollIntoView({behavior:"smooth",block:"start"})}),(t==="booking-new"||t==="booking")&&be(),t==="booking"&&document.querySelectorAll(".funnel-cta-btn").forEach(f=>{f.addEventListener("click",()=>{window.openBookingModal&&window.openBookingModal()})})}if(ue(t),fe(),typeof window.fbq=="function"&&window.fbq("track","PageView"),e){const v=t==="home"?"/":`/${t}`;window.location.pathname!==v&&history.pushState(null,"",v)}},150)}function ye(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const s=a.getAttribute("data-link");s&&X[s]&&U(s)})}function we(){const t=V("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{const t=document.getElementById("app");t.innerHTML=`
    ${ae()}
  ...
  `,ye(t),we(),window.addEventListener("message",a=>{let s=!1;if(a&&a.data&&(typeof a.data=="string"&&a.data.includes("calendly.event_scheduled")||typeof a.data=="object"&&(a.data.event==="calendly.event_scheduled"||a.data.event&&a.data.event.indexOf("event_scheduled")!==-1))&&(s=!0),s){x("bookedcall"),typeof window.fbq=="function"&&window.fbq("track","Schedule");const i=document.getElementById("booking-modal");i&&i.classList.contains("active")&&typeof window.goToBookingStep=="function"&&window.goToBookingStep(3)}});const e=H(window.location.pathname);U(e,!1),window.addEventListener("popstate",()=>{const a=H(window.location.pathname);U(a,!1)})});
