(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const ue={ogImage:"/og-image.png"},K={site:ue},G=(t,e=document)=>e.querySelector(t),V=(t,e=document)=>[...e.querySelectorAll(t)],Q="atlanticbear_analytics_8d24";function O(){if(sessionStorage.getItem("notrack"))return!0;try{if(new URLSearchParams(window.location.search).get("preview")==="true")return!0}catch{}return!1}function E(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${Q}/${t}`).catch(()=>{});try{const s=me();fetch(`https://abacus.jasoncameron.dev/hit/${Q}/${s}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}const ee=window.RECAPTCHA_SITE_KEY||"6Ldfp-gqAAAAABpP_placeholder_key";function te(){const t=window.RECAPTCHA_SITE_KEY||ee;if(document.getElementById("recaptcha-v3-script"))return;const e=document.createElement("script");e.id="recaptcha-v3-script",e.src=`https://www.google.com/recaptcha/api.js?render=${encodeURIComponent(t)}`,e.async=!0,e.defer=!0,document.head.appendChild(e)}async function ae(t){const e=window.RECAPTCHA_SITE_KEY||ee;return te(),new Promise(a=>{const s=setTimeout(()=>{console.warn(`reCAPTCHA [${t}] timed out. Continuing submission.`),a(null)},2500),o=window.grecaptcha;if(o&&typeof o.ready=="function")try{o.ready(()=>{o.execute(e,{action:t}).then(n=>{clearTimeout(s),a(n)}).catch(n=>{clearTimeout(s),console.warn(`reCAPTCHA [${t}] execution error:`,n),a(null)})})}catch(n){clearTimeout(s),console.warn(`reCAPTCHA [${t}] error:`,n),a(null)}else clearTimeout(s),a(null)})}let Y={};function pe(){se();const t=e=>{Y[`t${e}`]=window.setTimeout(()=>{E(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function se(){Object.values(Y).forEach(clearTimeout),Y={}}let q={moved:!1,calendar:!1,testimonials:!1},z=null;function he(){oe(),q={moved:!1,video:!1,calendar:!1,testimonials:!1},z=()=>{window.scrollY>50&&!q.moved&&(q.moved=!0,E("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!q.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(q.calendar=!0,E("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!q.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(q.testimonials=!0,E("scroll_testimonials"))},window.addEventListener("scroll",z,{passive:!0})}function oe(){z&&(window.removeEventListener("scroll",z),z=null)}function me(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}const m={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function ve(){return`
  <nav class="nav" id="main-nav">
    ...
    <div class="nav-actions">
      <a href="/booking" class="btn btn-primary btn-sm btn-pulse" data-link="booking" id="nav-book-cta">Book a Call ${m.arrow}</a>
    </div>
    ...
    <div class="container">
      <div class="cc-grid">
        ...
        <div class="cc-copy reveal">
          <span class="cc-badge">${m.code} How we build</span>
    ...
    <div class="container">
      ...
      <div class="reveal" style="text-align: center; margin-top: 48px;">
        <a href="/booking" class="btn btn-primary btn-large btn-pulse" data-link="booking">
          Get Started with Market Leader ${m.arrow}
        </a>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="feature-grid">
        ...
        <div class="feature-item reveal" style="display:flex; flex-direction:column; justify-content:center; background:var(--surface);">
          ...
          <a href="/booking" class="btn btn-primary btn-sm" data-link="booking" style="align-self:flex-start;">Book a Call ${m.arrow}</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="feature-grid" style="grid-template-columns: repeat(2, 1fr); max-width: 900px; margin: 0 auto;">
        <div class="feature-item reveal" style="border-right: 1px solid var(--border); border-bottom: 1px solid var(--border);">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${m.zap}</div>
        ...
        <div class="feature-item reveal" style="border-right: none; border-bottom: 1px solid var(--border);">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${m.star}</div>
        ...
        <div class="feature-item reveal" style="border-right: 1px solid var(--border); border-bottom: none;">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${m.phone}</div>
        ...
        <div class="feature-item reveal" style="border-right: none; border-bottom: none;">
          <div class="feature-icon-wrap" style="color: #EB5C5C; background: rgba(235,92,92,0.1);">${m.rocket}</div>
    ...
    <div class="container">
      ...
      <div class="case-study reveal" style="transition-delay:0.12s;">
        ...
        <aside class="case-study-side">
          ...
          <a href="https://sondertraininggroup.com/" target="_blank" rel="noopener" class="btn btn-secondary btn-sm case-study-link">Visit the live site ${m.arrow}</a>
        </aside>
      </div>
            ...
            <div class="contact-methods">
              <a href="tel:+971502446531" class="contact-method">
                <div class="contact-method-icon" style="background:rgba(59,105,255,0.08); color:var(--blue);">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${m.phone}</svg>
                </div>
                <div>
  ...
  </div>`}function ie(t,e,a){const s=a.map(o=>`
  ...
  <section class="faq-section">
    ...
    <div class="faq-list reveal">${ne.map(e=>`
  ...
  `,t.appendChild(a);const s=new MutationObserver(()=>{const o=t.querySelector("iframe");o&&(o.style.position="relative",o.style.zIndex="2",o.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),s.disconnect())});s.observe(t,{childList:!0})}function ze(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),s=e.querySelector("video");a&&s&&a.addEventListener("click",o=>{o.stopPropagation(),s.muted=!1,s.currentTime=0,s.controls=!0,a.style.display="none",s.play().catch(n=>{console.error("Play failed:",n)})})})}function _e(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",ce(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const s=document.createElement("script");s.id="calendly-sdk",s.src="https://assets.calendly.com/assets/external/widget.js",s.async=!0,s.addEventListener("load",e,{once:!0}),document.head.appendChild(s)}}function Ne(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),s=document.getElementById("bv-play-btn"),o=document.getElementById("bv-controls"),n=document.getElementById("bv-playpause"),c=document.getElementById("bv-progress-fill"),v=document.getElementById("bv-progress-thumb"),p=document.getElementById("bv-progress-wrap"),h=document.getElementById("bv-time"),T=document.getElementById("bv-mute"),C=document.getElementById("bv-volume"),y=document.getElementById("bv-fullscreen"),u=document.getElementById("custom-video-wrap");if(!e||!a||!s||!o||!n)return;e.volume=.9;let k=null,B=null;const S=()=>{try{const i=window.AudioContext||window.webkitAudioContext;if(!i)return;if(!k){k=new i;const r=k.createMediaElementSource(e);B=k.createGain(),B.gain.value=2,r.connect(B),B.connect(k.destination)}k.state==="suspended"&&k.resume()}catch(i){console.warn("AudioContext boost failed:",i)}},I=e.getAttribute("data-src"),M=()=>{I&&!e.getAttribute("src")&&(e.setAttribute("src",I),e.load())};let b=!0;const U=5,$=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{b&&e.currentTime>=U&&(e.currentTime=0)}),setTimeout($,800);const D=i=>{const r=Math.floor(i/60),d=Math.floor(i%60);return`${r}:${d.toString().padStart(2,"0")}`},x=90,L=60,R=(i,r)=>!t||r<=x?i/r*100:i<=x?i/x*L:L+(i-x)/(r-x)*(100-L),j=(i,r)=>!t||r<=x?i/100*r:i<=L?i/L*x:x+(i-L)/(100-L)*(r-x),F=()=>{if(!e.duration)return;const i=R(e.currentTime,e.duration);c&&(c.style.width=i+"%"),v&&(v.style.left=i+"%"),h&&(h.textContent=`${D(e.currentTime)} / ${D(e.duration)}`)},P=i=>{const r=n==null?void 0:n.querySelector(".icon-play"),d=n==null?void 0:n.querySelector(".icon-pause");r&&(r.style.display=i&&!b?"none":"block"),d&&(d.style.display=i&&!b?"block":"none"),a&&(a.style.display=i&&!b?"none":"flex"),u&&(i&&!b?u.classList.add("playing"):u.classList.remove("playing"))};a.addEventListener("click",()=>{if(b){b=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0}M(),S(),P(!0),e.play()}),e.addEventListener("click",()=>{if(b){b=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0,S(),P(!0),e.play();return}M(),S(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>P(!0)),e.addEventListener("pause",()=>P(!1)),e.addEventListener("ended",()=>P(!1)),e.addEventListener("timeupdate",F),e.addEventListener("loadedmetadata",F);let W=!1,N=!1;const l={m25:!1,m50:!1,m75:!1,m95:!1,m100:!1},g={};if(e.addEventListener("play",()=>{!N&&!b&&(N=!0,typeof window.fbq=="function"&&!O()&&window.fbq("trackCustom","VSL_Play"))}),e.addEventListener("timeupdate",()=>{const i=e.duration;if(!i)return;const r=e.currentTime,d=r/i*100;if(!W&&r>.5&&!b&&(W=!0,E("videoplay")),b)return;d>=25&&!l.m25&&(l.m25=!0,E("videowatch_25pct"),typeof window.fbq=="function"&&!O()&&window.fbq("trackCustom","VSL_25")),d>=50&&!l.m50&&(l.m50=!0,E("videowatch_50pct"),typeof window.fbq=="function"&&!O()&&window.fbq("trackCustom","VSL_50")),d>=75&&!l.m75&&(l.m75=!0,E("videowatch_75pct"),typeof window.fbq=="function"&&!O()&&window.fbq("trackCustom","VSL_75")),d>=95&&!l.m95&&(l.m95=!0,typeof window.fbq=="function"&&!O()&&window.fbq("trackCustom","VSL_95")),d>=98&&!l.m100&&(l.m100=!0,E("videowatch_complete"));const A=[10,30],w=Math.floor(r);A.forEach(f=>{w>=f&&!g[f]&&(g[f]=!0,E(`videowatch_${f}s`))})}),n.addEventListener("click",()=>{M(),S(),e.paused?e.play():e.pause()}),p){const i=d=>{const A=p.getBoundingClientRect(),w=d instanceof MouseEvent?d.clientX:d.touches[0].clientX,f=Math.max(0,Math.min(100,(w-A.left)/A.width*100));e.currentTime=j(f,e.duration),F()};let r=!1;p.addEventListener("mousedown",d=>{r=!0,i(d)}),window.addEventListener("mousemove",d=>{r&&i(d)}),window.addEventListener("mouseup",()=>{r=!1}),p.addEventListener("touchstart",d=>i(d),{passive:!0}),p.addEventListener("touchmove",d=>i(d),{passive:!0})}if(C&&C.addEventListener("input",()=>{e.volume=parseFloat(C.value),e.muted=e.volume===0}),T&&T.addEventListener("click",()=>{e.muted=!e.muted,C&&(C.value=e.muted?"0":String(e.volume||1))}),y&&u&&y.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():u.requestFullscreen?u.requestFullscreen():u.webkitRequestFullscreen?u.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),u){let i;const r=()=>{o.style.opacity="1",clearTimeout(i),i=window.setTimeout(()=>{e.paused||(o.style.opacity="0")},2500)};u.addEventListener("mousemove",r),u.addEventListener("mouseenter",r),u.addEventListener("mouseleave",()=>{e.paused||(o.style.opacity="0")}),e.addEventListener("play",()=>{i=window.setTimeout(()=>{o.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{o.style.opacity="1",clearTimeout(i)})}}let de=!0;function je(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn"),a=document.getElementById("strat-modal-step-1"),s=document.getElementById("strat-modal-step-2"),o=document.getElementById("strat-modal-step-3"),n=document.getElementById("strat-modal-step-4"),c=document.getElementById("strat-modal-step-num"),v=document.getElementById("strat-modal-step-title"),p=document.getElementById("strat-modal-step-badge"),h=document.getElementById("strat-modal-progress-bar"),T=document.getElementById("strat-modal-step1-form"),C=document.getElementById("strat-modal-step2-form"),y=document.getElementById("strat-input-name"),u=document.getElementById("strat-input-phone"),k=document.getElementById("strat-input-business"),B=document.getElementById("strat-select-revenue"),S=document.getElementById("strat-modal-step1-error"),I=document.getElementById("strat-modal-step2-error"),M=document.getElementById("strat-modal-confirm-pricing-link");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);let b="",U="",$="",D="";const x={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},L=document.getElementById("strat-phone-flag-prefix"),R=()=>{if(!L||!u)return;const l=u.value.trim();let g="🇦🇪";for(const[i,r]of Object.entries(x))if(l.startsWith(i)){g=r;break}L.textContent=g},j=()=>{if(!u)return;let l=u.value,g="";for(const w of Object.keys(x))if(l.startsWith(w)){g=w+" ";break}if(!g&&l.startsWith("+")){const w=l.indexOf(" ");if(w>0)g=l.substring(0,w+1);else{const f=l.match(/^\+\d+/);f&&(g=f[0]+" ")}}const r=l.substring(g.length).replace(/\D/g,"").substring(0,9);let d="";r.length>0&&(r.length<=2?d=r:r.length<=5?d=`${r.substring(0,2)} ${r.substring(2)}`:d=`${r.substring(0,2)} ${r.substring(2,5)} ${r.substring(5)}`);const A=g+d;u.value!==A&&(u.value=A)};u&&(u.addEventListener("input",l=>{const g=l;if(g.inputType&&g.inputType.startsWith("delete")){R();return}j(),R()}),R());const F=()=>{y&&(y.value=""),u&&(u.value="+971 "),k&&(k.value=""),B&&(B.value=""),S&&(S.style.display="none"),I&&(I.style.display="none"),W(1),t.classList.add("active"),document.body.style.overflow="hidden"},P=()=>{t.classList.remove("active"),document.body.style.overflow=""},W=l=>{!a||!s||!o||!n||!c||!v||!p||!h||(l===1?(a.style.display="block",s.style.display="none",o.style.display="none",n.style.display="none",p.style.display="inline",c.textContent="1",v.textContent="Tell us about yourself",h.style.width="33%"):l===2?(a.style.display="none",s.style.display="block",o.style.display="none",n.style.display="none",p.style.display="inline",c.textContent="2",v.textContent="Your business details",h.style.width="66%"):l===3?(a.style.display="none",s.style.display="none",o.style.display="block",n.style.display="none",p.style.display="inline",c.textContent="3",v.textContent="Schedule your strategy call",h.style.width="100%",N()):l===4&&(a.style.display="none",s.style.display="none",o.style.display="none",n.style.display="block",p.style.display="none",v.textContent="Call Scheduled!",h.style.width="100%"))},N=()=>{const l=document.getElementById("strat-modal-calendly-container");if(!l)return;const g=D==="Under AED 5k/month"||D==="Under $5k"||D==="$0 - $5k";de=!g;const i=g?"https://calendly.com/officialatlanticbear/intro-call?hide_gdpr_banner=1&primary_color=3b69ff":"https://calendly.com/officialatlanticbear/strategy-call?hide_gdpr_banner=1&primary_color=3b69ff",r=D.replace(/–/g,"-").trim(),d=`${i}&name=${encodeURIComponent(b)}&a1=${encodeURIComponent(U)}&a2=${encodeURIComponent($)}&a3=${encodeURIComponent(r)}&a4=${encodeURIComponent(r)}`;l.innerHTML="",ce(l);const A={url:d,parentElement:l,prefill:{name:b,customAnswers:{a1:U,a2:$,a3:r,a4:r,a5:r}}},w=()=>window.Calendly.initInlineWidget(A);if(window.Calendly)w();else{const f=document.getElementById("calendly-sdk");f&&f.addEventListener("load",w,{once:!0})}};T&&T.addEventListener("submit",l=>{l.preventDefault();const g=(y==null?void 0:y.value.trim())||"",i=(u==null?void 0:u.value.trim())||"";let r="";for(const f of Object.keys(x))if(i.startsWith(f)){r=f;break}if(!r&&i.startsWith("+")){const f=i.match(/^\+\d+/);f&&(r=f[0])}const d=i.substring(r.length).replace(/\D/g,""),A=i.replace(/\D/g,""),w=r?d.length>=6:A.length>=7;if(!g||!w){S&&(S.style.display="block");return}S&&(S.style.display="none"),b=g,U=i.replace(/\s+/g,""),W(2)}),C&&C.addEventListener("submit",async l=>{l.preventDefault();const g=(k==null?void 0:k.value.trim())||"",i=(B==null?void 0:B.value)||"";if(!g||!i){I&&(I.style.display="block");return}if(I&&(I.style.display="none"),$=g,D=i,!(i==="Under AED 5k/month"||i==="Under $5k"||i==="$0 - $5k")){const d=document.getElementById("strat-modal-step2-submit-btn");d&&(d.disabled=!0,d.textContent="Verifying...");const A=await ae("booking_submit");fetch("https://script.google.com/macros/s/AKfycbxhmc6G4n4zpk0SGvjzP81_Cd9ipLxM3Wx5MZNWzF02tBqqUMD0JCAuDnH1OojQfv7vJQ/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({action:"form_submit",name:b,phone:U,business:$,revenue:D,source:"strategy_call",recaptchaToken:A||""})}).catch(w=>console.error("Google Sheet submission failed:",w)),d&&(d.disabled=!1,d.textContent="Continue to Calendar →")}W(3)}),e.addEventListener("click",P),window.addEventListener("keydown",l=>{l.key==="Escape"&&t.classList.contains("active")&&P()}),M&&M.addEventListener("click",l=>{l.preventDefault(),P(),_("pricing",!0)}),window.goToStratBookingStep=W,window.openStratBookingModal=F}const Z=["home","pricing","testimonials","meta-ads","contact","booking","booked"];let H=null;function _(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const s=document.getElementById("strat-booking-modal");s&&s.remove(),document.body.style.overflow="",se(),oe();const o=document.getElementById("main-nav"),n=document.querySelector(".site-footer");t==="booking"?(o&&(o.style.display="none"),n&&(n.style.display="none")):(o&&(o.style.display=""),n&&(n.style.display=""));const c=G("#main-content"),v=H?Z.indexOf(H):-1,p=Z.indexOf(t),h=v===-1||p>=v,T=h?"-8%":"8%",C=h?"8%":"-8%";H=t;const y=window.matchMedia("(prefers-reduced-motion: reduce)").matches;c.style.transition=y?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",c.style.opacity="0",y||(c.style.transform=`translateX(${T})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),c.style.transition="none",y||(c.style.transform=`translateX(${C})`),c.innerHTML=le[t](),qe(t),requestAnimationFrame(()=>{c.style.transition=y?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",c.style.opacity="1",c.style.transform="translateX(0)"}),Ue(),$e(),Re(),t==="contact"&&Fe(),(t==="booking"||t==="booked")&&(E("pageload",2e3),pe(),he(),_e(),Ne(t==="booking"),t==="booking"&&(je(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(u=>{u.addEventListener("click",()=>{typeof window.fbq=="function"&&!O()&&window.fbq("trackCustom","BookButtonClick"),window.openStratBookingModal&&window.openStratBookingModal()})}))),We(t),ze(),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&window.fbq("track","PageView"),e){const u=t==="home"?"/":`/${t}`;window.location.pathname!==u&&history.pushState(null,"",u)}},260)}function He(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const s=a.getAttribute("data-link");s&&le[s]&&_(s)})}function Ye(){const t=G("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{const t=new URLSearchParams(window.location.search);(t.get("notrack")==="1"||t.get("preview")==="true")&&sessionStorage.setItem("notrack","1");const e=t.get("fbclid"),a=(t.get("utm_source")||"").toLowerCase();(!!e||["facebook","instagram","fb","meta"].some(c=>a.includes(c)))&&sessionStorage.setItem("came_from_meta","1");const o=document.getElementById("app");o.innerHTML=`
    ${ve()}
  ...
  `,He(o),Ye(),te(),window.addEventListener("message",c=>{if(!c.origin||!c.origin.includes("calendly.com"))return;let v=!1;if(c&&c.data){let p=c.data;if(typeof p=="string")try{p=JSON.parse(p)}catch{}typeof p=="object"&&p&&p.event==="calendly.event_scheduled"&&(v=!0)}if(v){const p=document.getElementById("strat-booking-modal"),h=document.getElementById("booking-modal");p&&p.classList.contains("active")?(de?(E("bookedcall_strategy"),typeof window.fbq=="function"&&sessionStorage.getItem("came_from_meta")&&!sessionStorage.getItem("fbq_schedule_fired")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1"))):E("bookedcall_intro"),p&&p.classList.remove("active")):(E("bookedcall"),h&&h.classList.remove("active")),document.body.style.overflow="",_("booked")}});const n=X(window.location.pathname);_(n,!1),window.addEventListener("popstate",()=>{const c=X(window.location.pathname);_(c,!1)})});
