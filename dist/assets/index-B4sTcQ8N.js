(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const p of n.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&s(p)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const j=(t,e=document)=>e.querySelector(t),G=(t,e=document)=>[...e.querySelectorAll(t)],X="atlanticbear_analytics_8d24";function T(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${X}/${t}`).catch(()=>{});try{const s=de();fetch(`https://abacus.jasoncameron.dev/hit/${X}/${s}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}const te=window.RECAPTCHA_SITE_KEY||"6Ldfp-gqAAAAABpP_placeholder_key";function ae(){const t=window.RECAPTCHA_SITE_KEY||te;if(document.getElementById("recaptcha-v3-script"))return;const e=document.createElement("script");e.id="recaptcha-v3-script",e.src=`https://www.google.com/recaptcha/api.js?render=${encodeURIComponent(t)}`,e.async=!0,e.defer=!0,document.head.appendChild(e)}async function se(t){const e=window.RECAPTCHA_SITE_KEY||te;return ae(),new Promise(a=>{const s=setTimeout(()=>{console.warn(`reCAPTCHA [${t}] timed out. Continuing submission.`),a(null)},2500),o=window.grecaptcha;if(o&&typeof o.ready=="function")try{o.ready(()=>{o.execute(e,{action:t}).then(n=>{clearTimeout(s),a(n)}).catch(n=>{clearTimeout(s),console.warn(`reCAPTCHA [${t}] execution error:`,n),a(null)})})}catch(n){clearTimeout(s),console.warn(`reCAPTCHA [${t}] error:`,n),a(null)}else clearTimeout(s),a(null)})}let Y={};function le(){oe();const t=e=>{Y[`t${e}`]=window.setTimeout(()=>{T(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function oe(){Object.values(Y).forEach(clearTimeout),Y={}}let W={moved:!1,calendar:!1,testimonials:!1},V=null;function ce(){ne(),W={moved:!1,video:!1,calendar:!1,testimonials:!1},V=()=>{window.scrollY>50&&!W.moved&&(W.moved=!0,T("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!W.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(W.calendar=!0,T("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!W.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(W.testimonials=!0,T("scroll_testimonials"))},window.addEventListener("scroll",V,{passive:!0})}function ne(){V&&(window.removeEventListener("scroll",V),V=null)}function de(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}const g={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function pe(){return`
  ...
  <section class="cc-section">
  ...
  </section>`}const z={quote:"We approached Alexi at Atlantic Bear, who was absolutely fantastic at putting together our ideas and bringing them across on the website in a way that really engaged our target market.",name:"Sonder Training Group",role:"Training Provider, UAE",avatar:0},q=[{quote:"Five days from the first call to a live site. I had budgeted two months, and half of that for arguing about revisions.",name:"Tom Whitfield",role:"Founder, Dental Clinic",avatar:1},{quote:"We now come up first for our category in Dubai. Enquiries through the site have roughly tripled since launch.",name:"Priya Nair",role:"Director, Facilities Services",avatar:2},{quote:"They asked good questions, then just built it. I approved two rounds of small tweaks and that was the whole process.",name:"Marcus Oyelaran",role:"Manager, Hospitality Group",avatar:3},{quote:"Most of our customers are on their phones and the old site was unusable there. The new one loads instantly.",name:"Yasmin Farouk",role:"Owner, Fitness Studio",avatar:4},{quote:"Handover was clean. Domain, hosting, files, all in our name from day one, exactly as they promised.",name:"Lena Vasquez",role:"Founder, E-commerce",avatar:5}],me=[[z,q[0],q[1]],[q[2],z,q[3]],[q[4],z,q[0]]],Q=[{bg:"#3b69ff",fg:"#dfe8ff"},{bg:"#1e46c7",fg:"#d5e0ff"},{bg:"#6391ff",fg:"#eef3ff"},{bg:"#2a50e0",fg:"#dbe5ff"},{bg:"#142d80",fg:"#ccd9ff"},{bg:"#4a80ff",fg:"#e7eeff"},{bg:"#27418f",fg:"#d2ddff"},{bg:"#5b7cff",fg:"#e9efff"},{bg:"#1a3fb5",fg:"#d8e2ff"}];function ge(t,e){const a=Q[e%Q.length],s=7.2+e%3*.5,o=14.5+e%4*.8,n=19.5-e%3*.3;return`
    ...
    </article>`}function he(){const t=me.map((e,a)=>{const s=e.map(fe).join("");return`
  ...
  `,t.appendChild(a);const s=new MutationObserver(()=>{const o=t.querySelector("iframe");o&&(o.style.position="relative",o.style.zIndex="2",o.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),s.disconnect())});s.observe(t,{childList:!0})}function Ue(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),s=e.querySelector("video");a&&s&&a.addEventListener("click",o=>{o.stopPropagation(),s.muted=!1,s.currentTime=0,s.controls=!0,a.style.display="none",s.play().catch(n=>{console.error("Play failed:",n)})})})}function Re(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",K(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const s=document.createElement("script");s.id="calendly-sdk",s.src="https://assets.calendly.com/assets/external/widget.js",s.async=!0,s.addEventListener("load",e,{once:!0}),document.head.appendChild(s)}}function We(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),s=document.getElementById("bv-play-btn"),o=document.getElementById("bv-controls"),n=document.getElementById("bv-playpause"),p=document.getElementById("bv-progress-fill"),f=document.getElementById("bv-progress-thumb"),b=document.getElementById("bv-progress-wrap"),v=document.getElementById("bv-time"),D=document.getElementById("bv-mute"),h=document.getElementById("bv-volume"),l=document.getElementById("bv-fullscreen"),u=document.getElementById("custom-video-wrap");if(!e||!a||!s||!o||!n)return;let A=null,k=null;const w=()=>{try{const i=window.AudioContext||window.webkitAudioContext;if(!i)return;if(!A){A=new i;const c=A.createMediaElementSource(e);k=A.createGain(),k.gain.value=2,c.connect(k),k.connect(A.destination)}A.state==="suspended"&&A.resume()}catch(i){console.warn("AudioContext boost failed:",i)}},L=e.getAttribute("data-src"),P=()=>{L&&!e.getAttribute("src")&&(e.setAttribute("src",L),e.load())};let x=!0;const $=5,U=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{x&&e.currentTime>=$&&(e.currentTime=0)}),setTimeout(U,800);const M=i=>{const c=Math.floor(i/60),m=Math.floor(i%60);return`${c}:${m.toString().padStart(2,"0")}`},S=90,C=60,O=(i,c)=>!t||c<=S?i/c*100:i<=S?i/S*C:C+(i-S)/(c-S)*(100-C),R=(i,c)=>!t||c<=S?i/100*c:i<=C?i/C*S:S+(i-C)/(100-C)*(c-S),y=()=>{if(!e.duration)return;const i=O(e.currentTime,e.duration);p&&(p.style.width=i+"%"),f&&(f.style.left=i+"%"),v&&(v.textContent=`${M(e.currentTime)} / ${M(e.duration)}`)},B=i=>{const c=n==null?void 0:n.querySelector(".icon-play"),m=n==null?void 0:n.querySelector(".icon-pause");c&&(c.style.display=i&&!x?"none":"block"),m&&(m.style.display=i&&!x?"block":"none"),a&&(a.style.display=i&&!x?"none":"flex"),u&&(i&&!x?u.classList.add("playing"):u.classList.remove("playing"))};a.addEventListener("click",()=>{if(x){x=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0}P(),w(),B(!0),e.play()}),e.addEventListener("click",()=>{if(x){x=!1,e.muted=!1;const i=e.src.split("#")[0];e.src!==i&&(e.src=i,e.load()),e.currentTime=0,w(),B(!0),e.play();return}P(),w(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>B(!0)),e.addEventListener("pause",()=>B(!1)),e.addEventListener("ended",()=>B(!1)),e.addEventListener("timeupdate",y),e.addEventListener("loadedmetadata",y);let r=!1;const d={m25:!1,m50:!1,m75:!1,m100:!1},E={};if(e.addEventListener("timeupdate",()=>{const i=e.duration;if(!i)return;const c=e.currentTime,m=c/i*100;!r&&c>.5&&(r=!0,T("videoplay")),m>=25&&!d.m25&&(d.m25=!0,T("videowatch_25pct")),m>=50&&!d.m50&&(d.m50=!0,T("videowatch_50pct")),m>=75&&!d.m75&&(d.m75=!0,T("videowatch_75pct")),m>=98&&!d.m100&&(d.m100=!0,T("videowatch_complete"));const I=[10,30],_=Math.floor(c);I.forEach(F=>{_>=F&&!E[F]&&(E[F]=!0,T(`videowatch_${F}s`))})}),n.addEventListener("click",()=>{P(),w(),e.paused?e.play():e.pause()}),b){const i=m=>{const I=b.getBoundingClientRect(),_=m instanceof MouseEvent?m.clientX:m.touches[0].clientX,F=Math.max(0,Math.min(100,(_-I.left)/I.width*100));e.currentTime=R(F,e.duration),y()};let c=!1;b.addEventListener("mousedown",m=>{c=!0,i(m)}),window.addEventListener("mousemove",m=>{c&&i(m)}),window.addEventListener("mouseup",()=>{c=!1}),b.addEventListener("touchstart",m=>i(m),{passive:!0}),b.addEventListener("touchmove",m=>i(m),{passive:!0})}if(h&&h.addEventListener("input",()=>{e.volume=parseFloat(h.value),e.muted=e.volume===0}),D&&D.addEventListener("click",()=>{e.muted=!e.muted,h&&(h.value=e.muted?"0":String(e.volume||1))}),l&&u&&l.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():u.requestFullscreen?u.requestFullscreen():u.webkitRequestFullscreen?u.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),u){let i;const c=()=>{o.style.opacity="1",clearTimeout(i),i=window.setTimeout(()=>{e.paused||(o.style.opacity="0")},2500)};u.addEventListener("mousemove",c),u.addEventListener("mouseenter",c),u.addEventListener("mouseleave",()=>{e.paused||(o.style.opacity="0")}),e.addEventListener("play",()=>{i=window.setTimeout(()=>{o.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{o.style.opacity="1",clearTimeout(i)})}}function _e(){const t=document.getElementById("booking-modal"),e=document.getElementById("book-demo-btn-v2"),a=document.getElementById("booking-modal-close-btn"),s=document.getElementById("modal-step-1"),o=document.getElementById("modal-step-2"),n=document.getElementById("modal-step-3"),p=document.getElementById("modal-step-num"),f=document.getElementById("modal-step-title"),b=document.getElementById("modal-step-badge"),v=document.getElementById("modal-progress-bar"),D=document.getElementById("modal-step1-form"),h=document.getElementById("modal-input-name"),l=document.getElementById("modal-input-phone"),u=document.getElementById("modal-step1-error"),A=document.getElementById("modal-confirm-pricing-link");if(!t||!a)return;t.parentElement!==document.body&&document.body.appendChild(t);let k="",w="",L="";h&&localStorage.getItem("feather_booking_name")&&(h.value=localStorage.getItem("feather_booking_name")||""),l&&localStorage.getItem("feather_booking_phone")&&(l.value=localStorage.getItem("feather_booking_phone")||"");const P=document.getElementById("phone-flag-prefix"),x={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},$=()=>{if(!P||!l)return;const r=l.value.trim();let d="🇦🇪";for(const[E,i]of Object.entries(x))if(r.startsWith(E)){d=i;break}P.textContent=d},U=()=>{if(!l)return;let r=l.value,d="";for(const I of Object.keys(x))if(r.startsWith(I)){d=I+" ";break}if(!d&&r.startsWith("+")){const I=r.indexOf(" ");if(I>0)d=r.substring(0,I+1);else{const _=r.match(/^\+\d+/);_&&(d=_[0]+" ")}}const i=r.substring(d.length).replace(/\D/g,"").substring(0,9);let c="";i.length>0&&(i.length<=2?c=i:i.length<=5?c=`${i.substring(0,2)} ${i.substring(2)}`:c=`${i.substring(0,2)} ${i.substring(2,5)} ${i.substring(5)}`);const m=d+c;l.value!==m&&(l.value=m)};l&&((!l.value||l.value.trim()===""||l.value.trim()==="+971")&&(l.value="+971 "),l.addEventListener("input",r=>{const d=r;if(d.inputType&&d.inputType.startsWith("delete")){$();return}U(),$()}),$());const M=()=>{if(!k||!w)return;const r=`${k}|${w}`;if(L===r)return;L=r;const d=document.getElementById("modal-calendly-container");if(!d)return;d.innerHTML="",K(d);const c={url:`https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff&name=${encodeURIComponent(k)}&a1=${encodeURIComponent(w)}`,parentElement:d,prefill:{name:k,customAnswers:{a1:w}}},m=()=>window.Calendly.initInlineWidget(c);if(window.Calendly)m();else{const I=document.getElementById("calendly-sdk");I&&I.addEventListener("load",m,{once:!0})}},S=()=>{const r=(h==null?void 0:h.value.trim())||"",d=(l==null?void 0:l.value.trim())||"";r.length>=3&&d.length>=5&&(k=r,w=d,M())};h==null||h.addEventListener("input",S),l==null||l.addEventListener("input",S),S();const C=r=>{r===1?(s&&(s.style.display="block"),o&&(o.style.display="none"),n&&(n.style.display="none"),p&&(p.textContent="1"),f&&(f.textContent="Tell us about yourself"),b&&(b.style.display="inline"),v&&(v.style.width="50%")):r===2?(s&&(s.style.display="none"),o&&(o.style.display="block"),n&&(n.style.display="none"),p&&(p.textContent="2"),f&&(f.textContent="Schedule your demo call"),b&&(b.style.display="inline"),v&&(v.style.width="100%"),k=(h==null?void 0:h.value.trim())||"",w=(l==null?void 0:l.value.trim())||"",M()):r===3&&(s&&(s.style.display="none"),o&&(o.style.display="none"),n&&(n.style.display="block"),f&&(f.textContent="Call Confirmed!"),b&&(b.style.display="none"),v&&(v.style.width="100%"))},O=()=>{t.classList.add("active"),document.body.style.overflow="hidden",u&&(u.style.display="none"),L="",h&&localStorage.getItem("feather_booking_name")&&(h.value=localStorage.getItem("feather_booking_name")||""),l&&localStorage.getItem("feather_booking_phone")&&(l.value=localStorage.getItem("feather_booking_phone")||""),C(1)},R=()=>{t.classList.remove("active"),document.body.style.overflow=""},y=r=>{r&&r.preventDefault();const d=(h==null?void 0:h.value.trim())||"",E=(l==null?void 0:l.value.trim())||"";if(!d||!E){u&&(u.style.display="block");return}const i=d.split(" ").map(c=>c.charAt(0).toUpperCase()+c.slice(1)).join(" ");u&&(u.style.display="none"),k=i,w=E,C(2)};D&&D.addEventListener("submit",y),e&&e.addEventListener("click",O),a.addEventListener("click",R),t.addEventListener("click",r=>{r.target===t&&R()});const B=r=>{r.key==="Escape"&&t.classList.contains("active")&&R()};window.addEventListener("keydown",B),A&&A.addEventListener("click",r=>{r.preventDefault(),R(),N("pricing",!0)}),window.goToBookingStep=C,window.openBookingModal=O}let re=!0;function Fe(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn"),a=document.getElementById("strat-modal-step-1"),s=document.getElementById("strat-modal-step-2"),o=document.getElementById("strat-modal-step-3"),n=document.getElementById("strat-modal-step-4"),p=document.getElementById("strat-modal-step-num"),f=document.getElementById("strat-modal-step-title"),b=document.getElementById("strat-modal-step-badge"),v=document.getElementById("strat-modal-progress-bar"),D=document.getElementById("strat-modal-step1-form"),h=document.getElementById("strat-modal-step2-form"),l=document.getElementById("strat-input-name"),u=document.getElementById("strat-input-phone"),A=document.getElementById("strat-input-business"),k=document.getElementById("strat-select-revenue"),w=document.getElementById("strat-modal-step1-error"),L=document.getElementById("strat-modal-step2-error"),P=document.getElementById("strat-modal-confirm-pricing-link");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);let x="",$="",U="",M="";const S=()=>{l&&(l.value=""),u&&(u.value="+971 "),A&&(A.value=""),k&&(k.value=""),w&&(w.style.display="none"),L&&(L.style.display="none"),O(1),t.classList.add("active"),document.body.style.overflow="hidden"},C=()=>{t.classList.remove("active"),document.body.style.overflow=""},O=y=>{!a||!s||!o||!n||!p||!f||!b||!v||(y===1?(a.style.display="block",s.style.display="none",o.style.display="none",n.style.display="none",b.style.display="inline",p.textContent="1",f.textContent="Tell us about yourself",v.style.width="33%"):y===2?(a.style.display="none",s.style.display="block",o.style.display="none",n.style.display="none",b.style.display="inline",p.textContent="2",f.textContent="Your business details",v.style.width="66%"):y===3?(a.style.display="none",s.style.display="none",o.style.display="block",n.style.display="none",b.style.display="inline",p.textContent="3",f.textContent="Schedule your strategy call",v.style.width="100%",R()):y===4&&(a.style.display="none",s.style.display="none",o.style.display="none",n.style.display="block",b.style.display="none",f.textContent="Call Scheduled!",v.style.width="100%"))},R=()=>{const y=document.getElementById("strat-modal-calendly-container");if(!y)return;const B=M==="Under AED 5k/month"||M==="Under $5k"||M==="$0 - $5k";re=!B;const r=B?"https://calendly.com/officialatlanticbear/intro-call?primary_color=3b69ff":"https://calendly.com/officialatlanticbear/strategy-call?primary_color=3b69ff",d=M.replace(/–/g,"-").trim(),E=`${r}&name=${encodeURIComponent(x)}&a1=${encodeURIComponent($)}&a2=${encodeURIComponent(U)}&a3=${encodeURIComponent(d)}&a4=${encodeURIComponent(d)}`;y.innerHTML="",K(y);const i={url:E,parentElement:y,prefill:{name:x,customAnswers:{a1:$,a2:U,a3:d,a4:d,a5:d}}},c=()=>window.Calendly.initInlineWidget(i);if(window.Calendly)c();else{const m=document.getElementById("calendly-sdk");m&&m.addEventListener("load",c,{once:!0})}};D&&D.addEventListener("submit",y=>{y.preventDefault();const B=(l==null?void 0:l.value.trim())||"",r=(u==null?void 0:u.value.trim())||"";if(!B||!r){w&&(w.style.display="block");return}w&&(w.style.display="none"),x=B,$=r,O(2)}),h&&h.addEventListener("submit",async y=>{y.preventDefault();const B=(A==null?void 0:A.value.trim())||"",r=(k==null?void 0:k.value)||"";if(!B||!r){L&&(L.style.display="block");return}if(L&&(L.style.display="none"),U=B,M=r,!(r==="Under AED 5k/month"||r==="Under $5k"||r==="$0 - $5k")){const E=document.getElementById("strat-modal-step2-submit-btn");E&&(E.disabled=!0,E.textContent="Verifying...");const i=await se("booking_submit");fetch("https://script.google.com/macros/s/AKfycbxhmc6G4n4zpk0SGvjzP81_Cd9ipLxM3Wx5MZNWzF02tBqqUMD0JCAuDnH1OojQfv7vJQ/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({action:"form_submit",name:x,phone:$,business:U,revenue:M,source:"strategy_call",recaptchaToken:i||""})}).catch(c=>console.error("Google Sheet submission failed:",c)),E&&(E.disabled=!1,E.textContent="Continue to Calendar →")}O(3)}),e.addEventListener("click",C),t.addEventListener("click",y=>{y.target===t&&C()}),window.addEventListener("keydown",y=>{y.key==="Escape"&&t.classList.contains("active")&&C()}),P&&P.addEventListener("click",y=>{y.preventDefault(),C(),N("pricing",!0)}),window.goToStratBookingStep=O,window.openStratBookingModal=S}const ee=["home","pricing","work","testimonials","meta-ads","contact","booking","booking-new","booked"];let H=null;function N(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const s=document.getElementById("strat-booking-modal");s&&s.remove(),document.body.style.overflow="",oe(),ne();const o=document.getElementById("main-nav"),n=document.querySelector(".site-footer");t==="booking"||t==="booked"?(o&&(o.style.display="none"),n&&(n.style.display="none")):(o&&(o.style.display=""),n&&(n.style.display=""));const p=j("#main-content"),f=H?ee.indexOf(H):-1,b=ee.indexOf(t),v=f===-1||b>=f,D=v?"-8%":"8%",h=v?"8%":"-8%";H=t;const l=window.matchMedia("(prefers-reduced-motion: reduce)").matches;p.style.transition=l?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",p.style.opacity="0",l||(p.style.transform=`translateX(${D})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),p.style.transition="none",l||(p.style.transform=`translateX(${h})`),p.innerHTML=ie[t](),Le(t),requestAnimationFrame(()=>{p.style.transition=l?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",p.style.opacity="1",p.style.transform="translateX(0)"}),Me(),De(),Pe(),t==="contact"&&Oe(),(t==="booking"||t==="booked"||t==="booking-new")&&(T("pageload",2e3),le(),ce(),Re(),We(t==="booking"||t==="booked"),t==="booking-new"?(_e(),document.querySelectorAll(".funnel-cta-btn").forEach(u=>{u.addEventListener("click",()=>{window.openBookingModal&&window.openBookingModal()})})):t==="booking"&&(Fe(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(u=>{u.addEventListener("click",()=>{window.openStratBookingModal&&window.openStratBookingModal()})}))),Te(t),Ue(),typeof window.fbq=="function"&&window.fbq("track","PageView"),e){const u=t==="home"?"/":`/${t}`;window.location.pathname!==u&&history.pushState(null,"",u)}},260)}function qe(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const s=a.getAttribute("data-link");s&&ie[s]&&N(s)})}function Ne(){const t=j("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{const t=document.getElementById("app");t.innerHTML=`
    ${pe()}
  ...
  `,qe(t),Ne(),ae(),window.addEventListener("message",a=>{if(!a.origin||!a.origin.includes("calendly.com"))return;let s=!1;if(a&&a.data&&typeof a.data=="object"&&a.data.event==="calendly.event_scheduled"&&(s=!0),s){const o=document.getElementById("strat-booking-modal"),n=document.getElementById("booking-modal");o&&o.classList.contains("active")?(re?(T("bookedcall_strategy"),typeof window.fbq=="function"&&!sessionStorage.getItem("fbq_schedule_fired")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1"))):T("bookedcall_intro"),o&&o.classList.remove("active")):(T("bookedcall"),n&&n.classList.remove("active")),document.body.style.overflow="",N("booked")}});const e=Z(window.location.pathname);N(e,!1),window.addEventListener("popstate",()=>{const a=Z(window.location.pathname);N(a,!1)})});
