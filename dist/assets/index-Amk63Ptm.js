(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const u of i.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&o(u)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const z=(t,e=document)=>e.querySelector(t),G=(t,e=document)=>[...e.querySelectorAll(t)],Q="atlanticbear_analytics_8d24";function S(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${Q}/${t}`).catch(()=>{});try{const o=ue();fetch(`https://abacus.jasoncameron.dev/hit/${Q}/${o}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}const te=window.RECAPTCHA_SITE_KEY||"6Ldfp-gqAAAAABpP_placeholder_key";function ae(){const t=window.RECAPTCHA_SITE_KEY||te;if(document.getElementById("recaptcha-v3-script"))return;const e=document.createElement("script");e.id="recaptcha-v3-script",e.src=`https://www.google.com/recaptcha/api.js?render=${encodeURIComponent(t)}`,e.async=!0,e.defer=!0,document.head.appendChild(e)}async function se(t){const e=window.RECAPTCHA_SITE_KEY||te;return ae(),new Promise(a=>{const o=setTimeout(()=>{console.warn(`reCAPTCHA [${t}] timed out. Continuing submission.`),a(null)},2500),s=window.grecaptcha;if(s&&typeof s.ready=="function")try{s.ready(()=>{s.execute(e,{action:t}).then(i=>{clearTimeout(o),a(i)}).catch(i=>{clearTimeout(o),console.warn(`reCAPTCHA [${t}] execution error:`,i),a(null)})})}catch(i){clearTimeout(o),console.warn(`reCAPTCHA [${t}] error:`,i),a(null)}else clearTimeout(o),a(null)})}let V={};function ce(){oe();const t=e=>{V[`t${e}`]=window.setTimeout(()=>{S(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function oe(){Object.values(V).forEach(clearTimeout),V={}}let O={moved:!1,calendar:!1,testimonials:!1},N=null;function de(){ie(),O={moved:!1,video:!1,calendar:!1,testimonials:!1},N=()=>{window.scrollY>50&&!O.moved&&(O.moved=!0,S("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!O.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(O.calendar=!0,S("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!O.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(O.testimonials=!0,S("scroll_testimonials"))},window.addEventListener("scroll",N,{passive:!0})}function ie(){N&&(window.removeEventListener("scroll",N),N=null)}function ue(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${a}-${o}-${s}`}const v={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',palette:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r="2.5"/><circle cx="17.5" cy="10.5" r="2.5"/><circle cx="8.5" cy="7.5" r="2.5"/><circle cx="6.5" cy="12.5" r="2.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16,18 22,12 16,6"/><polyline points="8,6 2,12 8,18"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function pe(){return`
  ...
  <section class="cc-section">
  ...
  </section>`}const H={quote:"We approached Alexi at Atlantic Bear, who was absolutely fantastic at putting together our ideas and bringing them across on the website in a way that really engaged our target market.",name:"Sonder Training Group",role:"Training Provider, UAE",avatar:0},_=[{quote:"Five days from the first call to a live site. I had budgeted two months, and half of that for arguing about revisions.",name:"Tom Whitfield",role:"Founder, Dental Clinic",avatar:1},{quote:"We now come up first for our category in Dubai. Enquiries through the site have roughly tripled since launch.",name:"Priya Nair",role:"Director, Facilities Services",avatar:2},{quote:"They asked good questions, then just built it. I approved two rounds of small tweaks and that was the whole process.",name:"Marcus Oyelaran",role:"Manager, Hospitality Group",avatar:3},{quote:"Most of our customers are on their phones and the old site was unusable there. The new one loads instantly.",name:"Yasmin Farouk",role:"Owner, Fitness Studio",avatar:4},{quote:"Handover was clean. Domain, hosting, files, all in our name from day one, exactly as they promised.",name:"Lena Vasquez",role:"Founder, E-commerce",avatar:5}],ve=[[H,_[0],_[1]],[_[2],H,_[3]],[_[4],H,_[0]]],X=[{bg:"#3b69ff",fg:"#dfe8ff"},{bg:"#1e46c7",fg:"#d5e0ff"},{bg:"#6391ff",fg:"#eef3ff"},{bg:"#2a50e0",fg:"#dbe5ff"},{bg:"#142d80",fg:"#ccd9ff"},{bg:"#4a80ff",fg:"#e7eeff"},{bg:"#27418f",fg:"#d2ddff"},{bg:"#5b7cff",fg:"#e9efff"},{bg:"#1a3fb5",fg:"#d8e2ff"}];function ge(t,e){const a=X[e%X.length],o=7.2+e%3*.5,s=14.5+e%4*.8,i=19.5-e%3*.3;return`
    <span class="review-avatar-wrap">
      <svg class="review-avatar" viewBox="0 0 48 48" role="img" aria-label="Avatar for ${t}">
        ...
        <circle cx="24" cy="${i}" r="${o}" fill="${a.fg}" />
    ...
    </article>`}function ye(){const t=ve.map((e,a)=>{const o=e.map(fe).join("");return`
  ...
  </div>`}function ne(t,e,a){const o=a.map(s=>`
    <section class="legal-block reveal">
      <h2>${s.h}</h2>
      ${s.p.map(i=>`<p>${i}</p>`).join("")}
    </section>`).join("");return`
  <div class="page-header" style="border-bottom:1px solid var(--border);">
    <div class="container">
  ...
  `,t.appendChild(a);const o=new MutationObserver(()=>{const s=t.querySelector("iframe");s&&(s.style.position="relative",s.style.zIndex="2",s.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),o.disconnect())});o.observe(t,{childList:!0})}function _e(){document.querySelectorAll(".custom-testimonial-video-wrap").forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),o=e.querySelector("video");a&&o&&a.addEventListener("click",s=>{s.stopPropagation(),o.muted=!1,o.currentTime=0,o.controls=!0,a.style.display="none",o.play().catch(i=>{console.error("Play failed:",i)})})})}function je(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",K(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const o=document.createElement("script");o.id="calendly-sdk",o.src="https://assets.calendly.com/assets/external/widget.js",o.async=!0,o.addEventListener("load",e,{once:!0}),document.head.appendChild(o)}}function Ne(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),o=document.getElementById("bv-play-btn"),s=document.getElementById("bv-controls"),i=document.getElementById("bv-playpause"),u=document.getElementById("bv-progress-fill"),g=document.getElementById("bv-progress-thumb"),y=document.getElementById("bv-progress-wrap"),m=document.getElementById("bv-time"),D=document.getElementById("bv-mute"),f=document.getElementById("bv-volume"),l=document.getElementById("bv-fullscreen"),p=document.getElementById("custom-video-wrap");if(!e||!a||!o||!s||!i)return;let A=null,k=null;const w=()=>{try{const n=window.AudioContext||window.webkitAudioContext;if(!n)return;if(!A){A=new n;const d=A.createMediaElementSource(e);k=A.createGain(),k.gain.value=2,d.connect(k),k.connect(A.destination)}A.state==="suspended"&&A.resume()}catch(n){console.warn("AudioContext boost failed:",n)}},B=e.getAttribute("data-src"),P=()=>{B&&!e.getAttribute("src")&&(e.setAttribute("src",B),e.load())};let E=!0;const W=5,$=()=>{e.muted=!0,e.currentTime=0,e.play().catch(()=>{})};e.addEventListener("timeupdate",()=>{E&&e.currentTime>=W&&(e.currentTime=0)}),setTimeout($,800);const M=n=>{const d=Math.floor(n/60),h=Math.floor(n%60);return`${d}:${h.toString().padStart(2,"0")}`},T=90,x=60,q=(n,d)=>!t||d<=T?n/d*100:n<=T?n/T*x:x+(n-T)/(d-T)*(100-x),U=(n,d)=>!t||d<=T?n/100*d:n<=x?n/x*T:T+(n-x)/(100-x)*(d-T),b=()=>{if(!e.duration)return;const n=q(e.currentTime,e.duration);u&&(u.style.width=n+"%"),g&&(g.style.left=n+"%"),m&&(m.textContent=`${M(e.currentTime)} / ${M(e.duration)}`)},C=n=>{const d=i==null?void 0:i.querySelector(".icon-play"),h=i==null?void 0:i.querySelector(".icon-pause");d&&(d.style.display=n&&!E?"none":"block"),h&&(h.style.display=n&&!E?"block":"none"),a&&(a.style.display=n&&!E?"none":"flex"),p&&(n&&!E?p.classList.add("playing"):p.classList.remove("playing"))};a.addEventListener("click",()=>{if(E){E=!1,e.muted=!1;const n=e.src.split("#")[0];e.src!==n&&(e.src=n,e.load()),e.currentTime=0}P(),w(),C(!0),e.play()}),e.addEventListener("click",()=>{if(E){E=!1,e.muted=!1;const n=e.src.split("#")[0];e.src!==n&&(e.src=n,e.load()),e.currentTime=0,w(),C(!0),e.play();return}P(),w(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>C(!0)),e.addEventListener("pause",()=>C(!1)),e.addEventListener("ended",()=>C(!1)),e.addEventListener("timeupdate",b),e.addEventListener("loadedmetadata",b);let c=!1;const r={m25:!1,m50:!1,m75:!1,m100:!1},I={};if(e.addEventListener("timeupdate",()=>{const n=e.duration;if(!n)return;const d=e.currentTime,h=d/n*100;!c&&d>.5&&(c=!0,S("videoplay")),h>=25&&!r.m25&&(r.m25=!0,S("videowatch_25pct")),h>=50&&!r.m50&&(r.m50=!0,S("videowatch_50pct")),h>=75&&!r.m75&&(r.m75=!0,S("videowatch_75pct")),h>=98&&!r.m100&&(r.m100=!0,S("videowatch_complete"));const L=[10,30],R=Math.floor(d);L.forEach(F=>{R>=F&&!I[F]&&(I[F]=!0,S(`videowatch_${F}s`))})}),i.addEventListener("click",()=>{P(),w(),e.paused?e.play():e.pause()}),y){const n=h=>{const L=y.getBoundingClientRect(),R=h instanceof MouseEvent?h.clientX:h.touches[0].clientX,F=Math.max(0,Math.min(100,(R-L.left)/L.width*100));e.currentTime=U(F,e.duration),b()};let d=!1;y.addEventListener("mousedown",h=>{d=!0,n(h)}),window.addEventListener("mousemove",h=>{d&&n(h)}),window.addEventListener("mouseup",()=>{d=!1}),y.addEventListener("touchstart",h=>n(h),{passive:!0}),y.addEventListener("touchmove",h=>n(h),{passive:!0})}if(f&&f.addEventListener("input",()=>{e.volume=parseFloat(f.value),e.muted=e.volume===0}),D&&D.addEventListener("click",()=>{e.muted=!e.muted,f&&(f.value=e.muted?"0":String(e.volume||1))}),l&&p&&l.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():p.requestFullscreen?p.requestFullscreen():p.webkitRequestFullscreen?p.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),p){let n;const d=()=>{s.style.opacity="1",clearTimeout(n),n=window.setTimeout(()=>{e.paused||(s.style.opacity="0")},2500)};p.addEventListener("mousemove",d),p.addEventListener("mouseenter",d),p.addEventListener("mouseleave",()=>{e.paused||(s.style.opacity="0")}),e.addEventListener("play",()=>{n=window.setTimeout(()=>{s.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{s.style.opacity="1",clearTimeout(n)})}}function He(){const t=document.getElementById("booking-modal"),e=document.getElementById("book-demo-btn-v2"),a=document.getElementById("booking-modal-close-btn"),o=document.getElementById("modal-step-1"),s=document.getElementById("modal-step-2"),i=document.getElementById("modal-step-3"),u=document.getElementById("modal-step-num"),g=document.getElementById("modal-step-title"),y=document.getElementById("modal-step-badge"),m=document.getElementById("modal-progress-bar"),D=document.getElementById("modal-step1-form"),f=document.getElementById("modal-input-name"),l=document.getElementById("modal-input-phone"),p=document.getElementById("modal-step1-error"),A=document.getElementById("modal-confirm-pricing-link");if(!t||!a)return;t.parentElement!==document.body&&document.body.appendChild(t);let k="",w="",B="";f&&localStorage.getItem("feather_booking_name")&&(f.value=localStorage.getItem("feather_booking_name")||""),l&&localStorage.getItem("feather_booking_phone")&&(l.value=localStorage.getItem("feather_booking_phone")||"");const P=document.getElementById("phone-flag-prefix"),E={"+971":"🇦🇪","+966":"🇸🇦","+968":"🇴🇲","+974":"🇶🇦","+973":"🇧🇭","+965":"🇰🇼","+44":"🇬🇧","+1":"🇺🇸","+91":"🇮🇳","+92":"🇵🇰","+63":"🇵🇭","+20":"🇪🇬","+27":"🇿🇦","+33":"🇫🇷","+49":"🇩🇪","+61":"🇦🇺","+62":"🇮🇩","+90":"🇹🇷","+234":"🇳🇬","+254":"🇰🇪"},W=()=>{if(!P||!l)return;const c=l.value.trim();let r="🇦🇪";for(const[I,n]of Object.entries(E))if(c.startsWith(I)){r=n;break}P.textContent=r},$=()=>{if(!l)return;let c=l.value,r="";for(const L of Object.keys(E))if(c.startsWith(L)){r=L+" ";break}if(!r&&c.startsWith("+")){const L=c.indexOf(" ");if(L>0)r=c.substring(0,L+1);else{const R=c.match(/^\+\d+/);R&&(r=R[0]+" ")}}const n=c.substring(r.length).replace(/\D/g,"").substring(0,9);let d="";n.length>0&&(n.length<=2?d=n:n.length<=5?d=`${n.substring(0,2)} ${n.substring(2)}`:d=`${n.substring(0,2)} ${n.substring(2,5)} ${n.substring(5)}`);const h=r+d;l.value!==h&&(l.value=h)};l&&((!l.value||l.value.trim()===""||l.value.trim()==="+971")&&(l.value="+971 "),l.addEventListener("input",c=>{const r=c;if(r.inputType&&r.inputType.startsWith("delete")){W();return}$(),W()}),W());const M=()=>{if(!k||!w)return;const c=`${k}|${w}`;if(B===c)return;B=c;const r=document.getElementById("modal-calendly-container");if(!r)return;r.innerHTML="",K(r);const d={url:`https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff&name=${encodeURIComponent(k)}&a1=${encodeURIComponent(w)}`,parentElement:r,prefill:{name:k,customAnswers:{a1:w}}},h=()=>window.Calendly.initInlineWidget(d);if(window.Calendly)h();else{const L=document.getElementById("calendly-sdk");L&&L.addEventListener("load",h,{once:!0})}},T=()=>{const c=(f==null?void 0:f.value.trim())||"",r=(l==null?void 0:l.value.trim())||"";c.length>=3&&r.length>=5&&(k=c,w=r,M())};f==null||f.addEventListener("input",T),l==null||l.addEventListener("input",T),T();const x=c=>{c===1?(o&&(o.style.display="block"),s&&(s.style.display="none"),i&&(i.style.display="none"),u&&(u.textContent="1"),g&&(g.textContent="Tell us about yourself"),y&&(y.style.display="inline"),m&&(m.style.width="50%")):c===2?(o&&(o.style.display="none"),s&&(s.style.display="block"),i&&(i.style.display="none"),u&&(u.textContent="2"),g&&(g.textContent="Schedule your demo call"),y&&(y.style.display="inline"),m&&(m.style.width="100%"),k=(f==null?void 0:f.value.trim())||"",w=(l==null?void 0:l.value.trim())||"",M()):c===3&&(o&&(o.style.display="none"),s&&(s.style.display="none"),i&&(i.style.display="block"),g&&(g.textContent="Call Confirmed!"),y&&(y.style.display="none"),m&&(m.style.width="100%"))},q=()=>{t.classList.add("active"),document.body.style.overflow="hidden",p&&(p.style.display="none"),B="",f&&localStorage.getItem("feather_booking_name")&&(f.value=localStorage.getItem("feather_booking_name")||""),l&&localStorage.getItem("feather_booking_phone")&&(l.value=localStorage.getItem("feather_booking_phone")||""),x(1)},U=()=>{t.classList.remove("active"),document.body.style.overflow=""},b=c=>{c&&c.preventDefault();const r=(f==null?void 0:f.value.trim())||"",I=(l==null?void 0:l.value.trim())||"";if(!r||!I){p&&(p.style.display="block");return}const n=r.split(" ").map(d=>d.charAt(0).toUpperCase()+d.slice(1)).join(" ");p&&(p.style.display="none"),k=n,w=I,x(2)};D&&D.addEventListener("submit",b),e&&e.addEventListener("click",q),a.addEventListener("click",U),t.addEventListener("click",c=>{c.target===t&&U()});const C=c=>{c.key==="Escape"&&t.classList.contains("active")&&U()};window.addEventListener("keydown",C),A&&A.addEventListener("click",c=>{c.preventDefault(),U(),j("pricing",!0)}),window.goToBookingStep=x,window.openBookingModal=q}let le=!0;function Ye(){const t=document.getElementById("strat-booking-modal"),e=document.getElementById("strat-modal-close-btn"),a=document.getElementById("strat-modal-step-1"),o=document.getElementById("strat-modal-step-2"),s=document.getElementById("strat-modal-step-3"),i=document.getElementById("strat-modal-step-4"),u=document.getElementById("strat-modal-step-num"),g=document.getElementById("strat-modal-step-title"),y=document.getElementById("strat-modal-step-badge"),m=document.getElementById("strat-modal-progress-bar"),D=document.getElementById("strat-modal-step1-form"),f=document.getElementById("strat-modal-step2-form"),l=document.getElementById("strat-input-name"),p=document.getElementById("strat-input-phone"),A=document.getElementById("strat-input-business"),k=document.getElementById("strat-select-revenue"),w=document.getElementById("strat-modal-step1-error"),B=document.getElementById("strat-modal-step2-error"),P=document.getElementById("strat-modal-confirm-pricing-link");if(!t||!e)return;t.parentElement!==document.body&&document.body.appendChild(t);let E="",W="",$="",M="";const T=()=>{l&&(l.value=""),p&&(p.value="+971 "),A&&(A.value=""),k&&(k.value=""),w&&(w.style.display="none"),B&&(B.style.display="none"),q(1),t.classList.add("active"),document.body.style.overflow="hidden"},x=()=>{t.classList.remove("active"),document.body.style.overflow=""},q=b=>{!a||!o||!s||!i||!u||!g||!y||!m||(b===1?(a.style.display="block",o.style.display="none",s.style.display="none",i.style.display="none",y.style.display="inline",u.textContent="1",g.textContent="Tell us about yourself",m.style.width="33%"):b===2?(a.style.display="none",o.style.display="block",s.style.display="none",i.style.display="none",y.style.display="inline",u.textContent="2",g.textContent="Your business details",m.style.width="66%"):b===3?(a.style.display="none",o.style.display="none",s.style.display="block",i.style.display="none",y.style.display="inline",u.textContent="3",g.textContent="Schedule your strategy call",m.style.width="100%",U()):b===4&&(a.style.display="none",o.style.display="none",s.style.display="none",i.style.display="block",y.style.display="none",g.textContent="Call Scheduled!",m.style.width="100%"))},U=()=>{const b=document.getElementById("strat-modal-calendly-container");if(!b)return;const C=M==="Under AED 5k/month"||M==="Under $5k"||M==="$0 - $5k";le=!C;const c=C?"https://calendly.com/officialatlanticbear/intro-call?primary_color=3b69ff":"https://calendly.com/officialatlanticbear/strategy-call?primary_color=3b69ff",r=M.replace(/–/g,"-").trim(),I=`${c}&name=${encodeURIComponent(E)}&a1=${encodeURIComponent(W)}&a2=${encodeURIComponent($)}&a3=${encodeURIComponent(r)}&a4=${encodeURIComponent(r)}`;b.innerHTML="",K(b);const n={url:I,parentElement:b,prefill:{name:E,customAnswers:{a1:W,a2:$,a3:r,a4:r,a5:r}}},d=()=>window.Calendly.initInlineWidget(n);if(window.Calendly)d();else{const h=document.getElementById("calendly-sdk");h&&h.addEventListener("load",d,{once:!0})}};D&&D.addEventListener("submit",b=>{b.preventDefault();const C=(l==null?void 0:l.value.trim())||"",c=(p==null?void 0:p.value.trim())||"";if(!C||!c){w&&(w.style.display="block");return}w&&(w.style.display="none"),E=C,W=c,q(2)}),f&&f.addEventListener("submit",async b=>{b.preventDefault();const C=(A==null?void 0:A.value.trim())||"",c=(k==null?void 0:k.value)||"";if(!C||!c){B&&(B.style.display="block");return}B&&(B.style.display="none"),$=C,M=c;const r=document.getElementById("strat-modal-step2-submit-btn");r&&(r.disabled=!0,r.textContent="Verifying...");const I=await se("booking_submit");fetch("https://script.google.com/macros/s/AKfycbxhmc6G4n4zpk0SGvjzP81_Cd9ipLxM3Wx5MZNWzF02tBqqUMD0JCAuDnH1OojQfv7vJQ/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({action:"form_submit",name:E,phone:W,business:$,revenue:M,source:"strategy_call",recaptchaToken:I||""})}).catch(n=>console.error("Google Sheet submission failed:",n)),r&&(r.disabled=!1,r.textContent="Continue to Calendar →"),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&window.fbq("track","Lead"),q(3)}),e.addEventListener("click",x),t.addEventListener("click",b=>{b.target===t&&x()}),window.addEventListener("keydown",b=>{b.key==="Escape"&&t.classList.contains("active")&&x()}),P&&P.addEventListener("click",b=>{b.preventDefault(),x(),j("pricing",!0)}),window.goToStratBookingStep=q,window.openStratBookingModal=T}const ee=["home","pricing","work","testimonials","meta-ads","contact","booking","booking-new","booked"];let Y=null;function j(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove();const o=document.getElementById("strat-booking-modal");o&&o.remove(),document.body.style.overflow="",oe(),ie();const s=document.getElementById("main-nav"),i=document.querySelector(".site-footer");t==="booking"||t==="booked"?(s&&(s.style.display="none"),i&&(i.style.display="none")):(s&&(s.style.display=""),i&&(i.style.display=""));const u=z("#main-content"),g=Y?ee.indexOf(Y):-1,y=ee.indexOf(t),m=g===-1||y>=g,D=m?"-8%":"8%",f=m?"8%":"-8%";Y=t;const l=window.matchMedia("(prefers-reduced-motion: reduce)").matches;u.style.transition=l?"opacity 0.2s ease":"opacity 0.26s ease, transform 0.26s cubic-bezier(0.5, 0, 0.75, 0)",u.style.opacity="0",l||(u.style.transform=`translateX(${D})`),setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),u.style.transition="none",l||(u.style.transform=`translateX(${f})`),u.innerHTML=re[t](),Pe(t),requestAnimationFrame(()=>{u.style.transition=l?"opacity 0.25s ease":"opacity 0.34s ease, transform 0.42s cubic-bezier(0.16, 1, 0.3, 1)",u.style.opacity="1",u.style.transform="translateX(0)"}),$e(),Ue(),Re(),t==="contact"&&Fe(),(t==="booking"||t==="booked"||t==="booking-new")&&(S("pageload",2e3),ce(),de(),je(),Ne(t==="booking"||t==="booked"),t==="booking-new"?(He(),document.querySelectorAll(".funnel-cta-btn").forEach(p=>{p.addEventListener("click",()=>{window.openBookingModal&&window.openBookingModal()})})):t==="booking"&&(Ye(),document.querySelectorAll(".strat-modal-trigger, .funnel-cta-wrap .funnel-cta-btn").forEach(p=>{p.addEventListener("click",()=>{window.openStratBookingModal&&window.openStratBookingModal()})}))),We(t),_e(),typeof window.fbq=="function"&&!sessionStorage.getItem("notrack")&&(window.fbq("track","PageView"),t==="booked"&&!sessionStorage.getItem("fbq_schedule_fired")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1"))),e){const p=t==="home"?"/":`/${t}`;window.location.pathname!==p&&history.pushState(null,"",p)}},260)}function Ve(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const o=a.getAttribute("data-link");o&&re[o]&&j(o)})}function ze(){const t=z("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{new URLSearchParams(window.location.search).get("notrack")==="1"&&sessionStorage.setItem("notrack","1");const t=document.getElementById("app");t.innerHTML=`
    ${pe()}
  ...
  `,Ve(t),ze(),ae(),window.addEventListener("message",a=>{if(!a.origin||!a.origin.includes("calendly.com"))return;let o=!1;if(a&&a.data){let s=a.data;if(typeof s=="string")try{s=JSON.parse(s)}catch{}typeof s=="object"&&s&&s.event==="calendly.event_scheduled"&&(o=!0)}if(o){const s=document.getElementById("strat-booking-modal"),i=document.getElementById("booking-modal");s&&s.classList.contains("active")?(S(le?"bookedcall_strategy":"bookedcall_intro"),s&&s.classList.remove("active")):(S("bookedcall"),i&&i.classList.remove("active")),typeof window.fbq=="function"&&!sessionStorage.getItem("fbq_schedule_fired")&&!sessionStorage.getItem("notrack")&&(window.fbq("track","Schedule"),sessionStorage.setItem("fbq_schedule_fired","1")),document.body.style.overflow="",j("booked")}});const e=Z(window.location.pathname);j(e,!1),window.addEventListener("popstate",()=>{const a=Z(window.location.pathname);j(a,!1)})});
