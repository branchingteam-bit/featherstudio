(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const p of i.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&s(p)}).observe(document,{childList:!0,subtree:!0});function a(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(o){if(o.ep)return;o.ep=!0;const i=a(o);fetch(o.href,i)}})();const R=(t,e=document)=>e.querySelector(t),j=(t,e=document)=>[...e.querySelectorAll(t)],$="atlanticbear_analytics_8d24";function E(t,e=0){const a=()=>{fetch(`https://abacus.jasoncameron.dev/hit/${$}/${t}`).catch(()=>{});try{const s=Z();fetch(`https://abacus.jasoncameron.dev/hit/${$}/${s}_${t}`).catch(()=>{})}catch{}};e>0?setTimeout(a,e):a()}let U={};function J(){G();const t=e=>{U[`t${e}`]=window.setTimeout(()=>{E(`time_${e}s`)},e*1e3)};t(5),t(15),t(30),t(60)}function G(){Object.values(U).forEach(clearTimeout),U={}}let S={moved:!1,calendar:!1,testimonials:!1},W=null;function X(){H(),S={moved:!1,video:!1,calendar:!1,testimonials:!1},W=()=>{window.scrollY>50&&!S.moved&&(S.moved=!0,E("scroll_moved"));const t=document.getElementById("booking-calendar");if(t&&!S.calendar){const a=t.getBoundingClientRect();a.top+a.height/2<window.innerHeight&&(S.calendar=!0,E("scroll_calendar"))}const e=document.querySelector(".booking-step-card:last-child");e&&!S.testimonials&&e.getBoundingClientRect().top<window.innerHeight-300&&(S.testimonials=!0,E("scroll_testimonials"))},window.addEventListener("scroll",W,{passive:!0})}function H(){W&&(window.removeEventListener("scroll",W),W=null)}function Z(){const t=new Date,e=new Date(t.toLocaleString("en-US",{timeZone:"Asia/Dubai"})),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}const m={arrow:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" y1="8" x2="13" y2="8"/><polyline points="9,4 13,8 9,12"/></svg>',globe:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.79a19.79 19.79 0 01-3.07-8.7A2 2 0 012 0h3a2 2 0 012 1.72c.12.96.36 1.9.69 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.33 1.85.57 2.81.69A2 2 0 0122 16.92z"/></svg>',mail:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',map:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>',star:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',zap:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10 13,2"/></svg>',shield:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2 .27-2.98-.31-3.5c-.56-.52-1.43-.8-2.69.5z"/><path d="M12 15l-3-3a22 22 0 012-3.95A12.88 12.88 0 0122 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 01-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',instagram:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'};function Q(){return`
  ...
  `,t.appendChild(a);const s=new MutationObserver(()=>{const o=t.querySelector("iframe");o&&(o.style.position="relative",o.style.zIndex="2",o.onload=()=>{a.remove()},setTimeout(()=>{a.remove()},2500),s.disconnect())});s.observe(t,{childList:!0})}function ue(){const t=document.querySelectorAll(".custom-testimonial-video-wrap");setTimeout(()=>{t.forEach(e=>{const a=e.querySelector("video");a&&a.play().catch(s=>{console.warn("Autoplay muted failed:",s)})})},4e3),t.forEach(e=>{const a=e.querySelector(".testimonial-video-overlay"),s=e.querySelector("video");a&&s&&a.addEventListener("click",o=>{o.stopPropagation(),s.muted=!1,s.currentTime=0,s.controls=!0,a.style.display="none",s.play().catch(i=>{console.error("Play failed:",i)})})})}function ve(){const t=document.querySelector(".calendly-inline-widget");if(!t)return;const e=()=>{t.innerHTML="",K(t),window.Calendly.initInlineWidget({url:"https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff",parentElement:t})};if(window.Calendly){e();return}const a=document.getElementById("calendly-sdk");if(a)a.addEventListener("load",e,{once:!0});else{const s=document.createElement("script");s.id="calendly-sdk",s.src="https://assets.calendly.com/assets/external/widget.js",s.async=!0,s.addEventListener("load",e,{once:!0}),document.head.appendChild(s)}}function me(t=!1){const e=document.getElementById("booking-video"),a=document.getElementById("bv-overlay"),s=document.getElementById("bv-play-btn"),o=document.getElementById("bv-controls"),i=document.getElementById("bv-playpause"),p=document.getElementById("bv-progress-fill"),v=document.getElementById("bv-progress-thumb"),g=document.getElementById("bv-progress-wrap"),u=document.getElementById("bv-time"),M=document.getElementById("bv-mute"),c=document.getElementById("bv-volume"),f=document.getElementById("bv-fullscreen"),h=document.getElementById("custom-video-wrap");if(!e||!a||!s||!o||!i)return;let x=null,k=null;const A=()=>{try{const n=window.AudioContext||window.webkitAudioContext;if(!n)return;if(!x){x=new n;const l=x.createMediaElementSource(e);k=x.createGain(),k.gain.value=2,l.connect(k),k.connect(x.destination)}x.state==="suspended"&&x.resume()}catch(n){console.warn("AudioContext boost failed:",n)}},P=e.getAttribute("data-src"),C=()=>{P&&!e.getAttribute("src")&&(e.setAttribute("src",P),e.load())},T=n=>{const l=Math.floor(n/60),r=Math.floor(n%60);return`${l}:${r.toString().padStart(2,"0")}`},w=90,B=60,I=(n,l)=>!t||l<=w?n/l*100:n<=w?n/w*B:B+(n-w)/(l-w)*(100-B),Y=(n,l)=>!t||l<=w?n/100*l:n<=B?n/B*w:w+(n-B)/(100-B)*(l-w),D=()=>{if(!e.duration)return;const n=I(e.currentTime,e.duration);p&&(p.style.width=n+"%"),v&&(v.style.left=n+"%"),u&&(u.textContent=`${T(e.currentTime)} / ${T(e.duration)}`)},d=n=>{const l=i==null?void 0:i.querySelector(".icon-play"),r=i==null?void 0:i.querySelector(".icon-pause");l&&(l.style.display=n?"none":"block"),r&&(r.style.display=n?"block":"none"),a&&(a.style.display=n?"none":"flex"),h&&(n?h.classList.add("playing"):h.classList.remove("playing"))};a.addEventListener("click",()=>{C(),A(),e.play()}),e.addEventListener("click",()=>{C(),A(),e.paused?e.play():e.pause()}),e.addEventListener("play",()=>d(!0)),e.addEventListener("pause",()=>d(!1)),e.addEventListener("ended",()=>d(!1)),e.addEventListener("timeupdate",D),e.addEventListener("loadedmetadata",D);let b=!1;const y={m25:!1,m50:!1,m75:!1,m100:!1},O={};if(e.addEventListener("timeupdate",()=>{const n=e.duration;if(!n)return;const l=e.currentTime,r=l/n*100;!b&&l>.5&&(b=!0,E("videoplay")),r>=25&&!y.m25&&(y.m25=!0,E("videowatch_25pct")),r>=50&&!y.m50&&(y.m50=!0,E("videowatch_50pct")),r>=75&&!y.m75&&(y.m75=!0,E("videowatch_75pct")),r>=98&&!y.m100&&(y.m100=!0,E("videowatch_complete"));const F=[10,30],N=Math.floor(l);F.forEach(L=>{N>=L&&!O[L]&&(O[L]=!0,E(`videowatch_${L}s`))})}),i.addEventListener("click",()=>{C(),A(),e.paused?e.play():e.pause()}),g){const n=r=>{const F=g.getBoundingClientRect(),N=r instanceof MouseEvent?r.clientX:r.touches[0].clientX,L=Math.max(0,Math.min(100,(N-F.left)/F.width*100));e.currentTime=Y(L,e.duration),D()};let l=!1;g.addEventListener("mousedown",r=>{l=!0,n(r)}),window.addEventListener("mousemove",r=>{l&&n(r)}),window.addEventListener("mouseup",()=>{l=!1}),g.addEventListener("touchstart",r=>n(r),{passive:!0}),g.addEventListener("touchmove",r=>n(r),{passive:!0})}if(c&&c.addEventListener("input",()=>{e.volume=parseFloat(c.value),e.muted=e.volume===0}),M&&M.addEventListener("click",()=>{e.muted=!e.muted,c&&(c.value=e.muted?"0":String(e.volume||1))}),f&&h&&f.addEventListener("click",()=>{if(/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&e.webkitEnterFullscreen){e.webkitEnterFullscreen();return}!!(document.fullscreenElement||document.webkitFullscreenElement)?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():h.requestFullscreen?h.requestFullscreen():h.webkitRequestFullscreen?h.webkitRequestFullscreen():e.webkitEnterFullscreen&&e.webkitEnterFullscreen()}),h){let n;const l=()=>{o.style.opacity="1",clearTimeout(n),n=window.setTimeout(()=>{e.paused||(o.style.opacity="0")},2500)};h.addEventListener("mousemove",l),h.addEventListener("mouseenter",l),h.addEventListener("mouseleave",()=>{e.paused||(o.style.opacity="0")}),e.addEventListener("play",()=>{n=window.setTimeout(()=>{o.style.opacity="0"},2500)}),e.addEventListener("pause",()=>{o.style.opacity="1",clearTimeout(n)})}}function ge(){const t=document.getElementById("booking-modal"),e=document.getElementById("book-demo-btn-v2"),a=document.getElementById("booking-modal-close-btn"),s=document.getElementById("modal-step-1"),o=document.getElementById("modal-step-2"),i=document.getElementById("modal-step-3"),p=document.getElementById("modal-step-num"),v=document.getElementById("modal-step-title"),g=document.getElementById("modal-step-badge"),u=document.getElementById("modal-progress-bar"),M=document.getElementById("modal-step1-form"),c=document.getElementById("modal-input-name"),f=document.getElementById("modal-input-phone"),h=document.getElementById("modal-step1-error"),x=document.getElementById("modal-confirm-pricing-link");if(!t||!a)return;t.parentElement!==document.body&&document.body.appendChild(t);let k="",A="",P="";c&&localStorage.getItem("feather_booking_name")&&(c.value=localStorage.getItem("feather_booking_name")||""),f&&localStorage.getItem("feather_booking_phone")&&(f.value=localStorage.getItem("feather_booking_phone")||"");const C=()=>{if(!k||!A)return;const d=`${k}|${A}`;if(P===d)return;P=d;const b=document.getElementById("modal-calendly-container");if(!b)return;b.innerHTML="",K(b);const n={url:`https://calendly.com/officialatlanticbear/demo-call?hide_gdpr_banner=1&primary_color=3366ff&name=${encodeURIComponent(k)}&a1=${encodeURIComponent(A)}`,parentElement:b,prefill:{name:k,customAnswers:{a1:A}}},l=()=>window.Calendly.initInlineWidget(n);if(window.Calendly)l();else{const r=document.getElementById("calendly-sdk");r&&r.addEventListener("load",l,{once:!0})}},T=()=>{const d=(c==null?void 0:c.value.trim())||"",b=(f==null?void 0:f.value.trim())||"";d.length>=3&&b.length>=5&&(k=d,A=b,C())};c==null||c.addEventListener("input",T),f==null||f.addEventListener("input",T),T();const w=d=>{d===1?(s&&(s.style.display="block"),o&&(o.style.display="none"),i&&(i.style.display="none"),p&&(p.textContent="1"),v&&(v.textContent="Tell us about yourself"),g&&(g.style.display="inline"),u&&(u.style.width="50%")):d===2?(s&&(s.style.display="none"),o&&(o.style.display="block"),i&&(i.style.display="none"),p&&(p.textContent="2"),v&&(v.textContent="Schedule your demo call"),g&&(g.style.display="inline"),u&&(u.style.width="100%"),k=(c==null?void 0:c.value.trim())||"",A=(f==null?void 0:f.value.trim())||"",C()):d===3&&(s&&(s.style.display="none"),o&&(o.style.display="none"),i&&(i.style.display="block"),v&&(v.textContent="Call Confirmed!"),g&&(g.style.display="none"),u&&(u.style.width="100%"))},B=()=>{t.classList.add("active"),document.body.style.overflow="hidden",h&&(h.style.display="none"),c&&localStorage.getItem("feather_booking_name")&&(c.value=localStorage.getItem("feather_booking_name")||""),f&&localStorage.getItem("feather_booking_phone")&&(f.value=localStorage.getItem("feather_booking_phone")||""),w(1)},I=()=>{t.classList.remove("active"),document.body.style.overflow=""},Y=d=>{d&&d.preventDefault();const b=(c==null?void 0:c.value.trim())||"",y=(f==null?void 0:f.value.trim())||"";if(!b||!y){h&&(h.style.display="block");return}h&&(h.style.display="none"),k=b,A=y,localStorage.setItem("feather_booking_name",b),localStorage.setItem("feather_booking_phone",y),fetch("https://script.google.com/macros/s/AKfycbyE6OQMsiNActyf_24Emjw3AepiNzWZwGc3VZWi2RCWxM1Jg04yWZSIKfxJ8ff5Cu2-/exec",{method:"POST",mode:"no-cors",body:JSON.stringify({name:b,phone:y,source:"booking_funnel"})}).catch(O=>console.error("Google Sheet submission failed:",O)),w(2)};M&&M.addEventListener("submit",Y),e&&e.addEventListener("click",B),a.addEventListener("click",I),t.addEventListener("click",d=>{d.target===t&&I()});const D=d=>{d.key==="Escape"&&t.classList.contains("active")&&I()};window.addEventListener("keydown",D),x&&x.addEventListener("click",d=>{d.preventDefault(),I(),_("pricing",!0)}),window.goToBookingStep=w,window.openBookingModal=B}function _(t,e=!0){const a=document.getElementById("booking-modal");a&&a.remove(),document.body.style.overflow="",G(),H();const s=document.getElementById("main-nav"),o=document.querySelector(".site-footer");t==="booking"?(s&&(s.style.display="none"),o&&(o.style.display="none")):(s&&(s.style.display=""),o&&(o.style.display=""));const i=R("#main-content");i.style.opacity="0",i.style.transform="translateY(8px)",setTimeout(()=>{if(window.scrollTo({top:0,behavior:"instant"}),i.innerHTML=z[t](),ce(t),i.style.transition="opacity 0.3s ease, transform 0.3s ease",requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),de(),t==="contact"&&pe(),t==="booking"||t==="booking-new"){E("pageload",2e3),J(),X(),ve(),me(t==="booking");const p=document.getElementById("skip-to-booking-btn");p&&p.addEventListener("click",v=>{v.preventDefault();const g=document.getElementById("booking-calendar");g&&g.scrollIntoView({behavior:"smooth",block:"start"})}),(t==="booking-new"||t==="booking")&&ge(),t==="booking"&&document.querySelectorAll(".funnel-cta-btn").forEach(v=>{v.addEventListener("click",()=>{window.openBookingModal&&window.openBookingModal()})})}if(re(t),ue(),typeof window.fbq=="function"&&window.fbq("track","PageView"),e){const p=t==="home"?"/":`/${t}`;window.location.pathname!==p&&history.pushState(null,"",p)}},150)}function fe(t){t.addEventListener("click",e=>{const a=e.target.closest("[data-link]");if(!a||e.metaKey||e.ctrlKey||e.shiftKey||e.button!==0)return;e.preventDefault();const s=a.getAttribute("data-link");s&&z[s]&&_(s)})}function he(){const t=R("#main-nav");if(!t)return;const e=()=>{window.scrollY>20?t.classList.add("scrolled"):t.classList.remove("scrolled")};window.addEventListener("scroll",e,{passive:!0})}window.formspree=window.formspree||function(){(window.formspree.q=window.formspree.q||[]).push(arguments)};document.addEventListener("DOMContentLoaded",()=>{const t=document.getElementById("app");t.innerHTML=`
    ${Q()}
  ...
  `,fe(t),he(),window.addEventListener("message",a=>{let s=!1;if(a&&a.data&&(typeof a.data=="string"&&a.data.includes("calendly.event_scheduled")||typeof a.data=="object"&&(a.data.event==="calendly.event_scheduled"||a.data.event&&a.data.event.indexOf("event_scheduled")!==-1))&&(s=!0),s){E("bookedcall"),typeof window.fbq=="function"&&window.fbq("track","Schedule");const o=document.getElementById("booking-modal");o&&o.classList.contains("active")&&typeof window.goToBookingStep=="function"&&window.goToBookingStep(3)}});const e=V(window.location.pathname);_(e,!1),window.addEventListener("popstate",()=>{const a=V(window.location.pathname);_(a,!1)})});
